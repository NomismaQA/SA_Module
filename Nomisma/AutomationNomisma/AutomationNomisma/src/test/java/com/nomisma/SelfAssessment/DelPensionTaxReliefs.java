...
public class DelPensionTaxReliefs extends BaseLib {
	...
	public void funcDelPensionTax() throws Exception
	{
		...
		s1.delPensionTaxRelief(driver);
		test.log(LogStatus.PASS, "Pension Tax Reliefs Income deleted successfully");
