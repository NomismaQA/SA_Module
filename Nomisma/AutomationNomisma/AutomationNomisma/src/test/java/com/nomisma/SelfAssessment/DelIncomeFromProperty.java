...
public class DelIncomeFromProperty extends BaseLib {
	...
	public void delIncomeProp() throws Exception
	{
		...
		Thread.sleep(2000);
		s1.delProfit(driver);
		test.log(LogStatus.PASS, "Income From Property deleted successfully");
