...
public class PaymentCertificate extends BaseLib {

	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void PaymentCert() throws InterruptedException, EmptyFileException, IOException{
				
		test = report.startTest("Test execution started to verify Payment Certificates");
		/*
		 * Local Variables
		 */
		
		String testCaseId = "PaymentCert";
