...
public class DeleteEmployeeTest extends BaseLib {
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void deleteEmployeeTest() throws InterruptedException, NoSuchElementException
	{
		
		test = report.startTest("deleteEmployeeTest execution starts");
		String testCaseId="DeleteEmployee_PayrollCompany";
		...
		//Delete Employee on Payroll Dashboard
		Reporter.log("Delete Employee will be clicked", true);
		pp.deleteEmployee(driver, sData5);
		
		test.log(LogStatus.PASS, "Delete Employee checked Successfully");
		Reporter.log("Delete Employee feature checked successfully", true);
