...
public class PdfVerifyFinishingTax extends BaseLib {
	...
	public void funcVerifyPdf() throws Exception
	{
		...
		pdf.checkPdfEntryFinishingTax(driver,sData6,Filename);
		test.log(LogStatus.PASS, "Test case for Pdf Verification for 'Self Assessment Forms' of Finishing tax Income added successfully");
