...
public class VerifyBusinessIncomeTradingIncomeAutoAndManualPTRFull extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "SA800_AutoPartnershipFull";
	...
	@Test (priority=1)
	public void funcVerifyBusinessIncomeTradingIncomeAutoAndManualPTRFull() throws Exception
	{
	...
	abp.checkAutoImpactonPTRFull(driver,sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27);
	abp.funcDelAutoPartnershipFull(driver);
	test.log(LogStatus.PASS, "Trading and professional income and business and investment income for PTR Full with auto and manual scenario is verified Successfully");
