...
public class MTRTestScenario245 extends BaseLib{
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase245";
	...
	HashMap<String, String> testDataMap = commUtils.getKeyValueFromJson(testDataFile, sTestCaseID);
	  ...
	  @Test (priority=2) public void funcAddTestCase245() throws Exception { 
	  ...
	  sa.selectClientTest245(driver); 
	  s1.addTestCase245(driver, sData4, sData5, sData6, sData7, sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22,sData23); 
	  ...
	  /*@Test (priority=1)
		public void funcDelTestCase245() throws Exception
		{		
			test = report.startTest("Login to self Assessment");
			sData1 = testDataMap.get("sData1").replaceAll("\"", "");
			sData2 = testDataMap.get("sData2").replaceAll("\"", "");
			...
			s1.clickClientLst(driver);
			sa.selectClientTest245(driver);
			s1.funcDelMTRTest245(driver);
			test.log(LogStatus.PASS, "Mtr test case 245 -> deleted successfully");
			Reporter.log("Test execution completed successfully", true);
			report.endTest(test);
			report.flush();	
			}*/
