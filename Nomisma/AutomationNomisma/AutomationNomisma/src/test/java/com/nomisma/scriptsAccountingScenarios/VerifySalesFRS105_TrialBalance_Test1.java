...
public class VerifySalesFRS105_TrialBalance_Test1 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VerifySalesFRS105_TrialBalance() throws InterruptedException {

		test = report.startTest("Test execution started to Verify Sales in FRS105 and TrialBalance Test");
		...
		As.VerifySalesFRS105_TrialBalance(driver, sData[5], sData[7], sData[8], sData[9]);
