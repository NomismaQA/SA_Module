...
public class PdfVerifyPaymentonAccount extends BaseLib {
	...
	public void funcVerifyPdf() throws Exception
	{
		...
		pdf.checkPdfEntryPaymentOnAccount(driver,sData6,Filename);
		test.log(LogStatus.PASS, "Test case for Pdf Verification for 'Self Assessment Forms' of Payment on Account added successfully");
