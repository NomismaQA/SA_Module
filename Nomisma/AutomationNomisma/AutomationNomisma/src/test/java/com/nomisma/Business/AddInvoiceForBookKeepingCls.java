...
public class AddInvoiceForBookKeepingCls  extends BaseLib {
...
@Test (priority=1)
public void funcAddInvoiceForBookKeeping() throws Exception
{
...
bp1.createInvoive(driver,sData5, sData6, sData7, sData8, sData9);
test.log(LogStatus.PASS, "Invoice Added successfully");
