...
public class CheckingBoxesVATRelated extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "DataForVATVerification";
	...
	abp.funcCheckVatCheckBoxesAutoFeature(driver,sData6,sData7);
	abp.funcSA800TradingProfessionalIncomeDel(driver);
	test.log(LogStatus.PASS, "Check Box related to VAT verified Successfully");
