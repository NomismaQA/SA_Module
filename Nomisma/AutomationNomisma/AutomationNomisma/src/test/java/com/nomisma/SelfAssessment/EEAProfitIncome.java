...
public class EEAProfitIncome extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="IncomFromPropertyFHLEssProfit";
	...
	public void checkProfitEAA() throws Exception
	{
		...
		Thread.sleep(2000);
		s1.incomProfitFHLinEEA(driver,sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14);
		test.log(LogStatus.PASS, "EEA Profit Income added successfully");
