...
public class DelForeignIncomeOverSeas extends BaseLib {
	...
	public void funcDelForeignOverseasIncome() throws Exception
	{
		...
		s1.delForeignIncomeOverseasSaving(driver);
		test.log(LogStatus.PASS, "forgign Income OverSeas deleted successfully");
