...
public class MTRTestScenario31 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase31";
	...
	@Test (priority=2)
 	public void funcTestCase31() throws Exception
	{	
		...
		sa.selectClientTest31(driver);
		s1.addTestCase31(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12, sData13, sData14, sData15, sData16);
		test.log(LogStatus.PASS, "Mtr test case31 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	/*@Test (priority=3)//,retryAnalyzer = RetryAnalyzer.class)
	public void funcSubmitToHmrcCase31() throws Exception
	{
	...
	test.log(LogStatus.PASS, "Mtr test case31 -> Tax Submission successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();		
	}*/
	@Test (priority=1)//,retryAnalyzer = RetryAnalyzer.class)
	public void funcDelTestCase31() throws Exception
	{
	...
	s1.clickClientLst(driver);
	sa.selectClientTest31(driver);
	s1.funcDelMTRTest31(driver);
	test.log(LogStatus.PASS, "Mtr test case31 -> deleted successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();	
	}
