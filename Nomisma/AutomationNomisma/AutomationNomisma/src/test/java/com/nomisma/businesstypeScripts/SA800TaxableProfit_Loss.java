...
public class SA800TaxableProfit_Loss extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "CheckTaxableProfitLoss";
	...
	abp.funcSA800TaxableProfit_Loss(driver,sData6, sData7, sData8);
	abp.funcSA800BusinessAndInvestmentIncomeDel(driver);
	test.log(LogStatus.PASS, "Taxable Profit or Loss section of business and investment income of SA800 verified Successfully");
