...
public class TaxReliefsMarriageAllowance extends BaseLib{
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="addEmpIncome4";
	...
	public void funcAddMarriageAllowance() throws Exception
	{
		...
		sp1.addMarriageAllowance(driver, sData11, sData12,sData13,sData14,sData15);
		test.log(LogStatus.PASS, "Test case for Tax Reliefs for Marriage Allowance added successfully");
