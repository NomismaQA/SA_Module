...
import org.testng.Reporter;
	public class MTRTestScenario54 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase54";
	...
	public void funcTestCase54() throws Exception
	{		
		...
		sa.selectClientTest54(driver);
		s1.addTestCase54(driver, sData4, sData5, sData6, sData7, sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25);
		test.log(LogStatus.PASS, "Mtr test case54 -> added successfully");
	...
	public void funcSubmitToHmrcCase54() throws Exception
	{
	...
	test.log(LogStatus.PASS, "Mtr test case54 -> Tax Submission successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();		
	}*/
	@Test (priority=1)//,retryAnalyzer = RetryAnalyzer.class)
	public void funcDelTestCase54() throws Exception
	{
	...
	s1.clickClientLst(driver);
	sa.selectClientTest54(driver);
	s1.funcDelMTRTest54(driver);
	test.log(LogStatus.PASS, "Mtr test case54 -> deleted successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();	
	}
