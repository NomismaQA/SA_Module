...
public class DeRegistrationCompanyTest extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void deRegisterationTest() throws InterruptedException, NoSuchElementException
	{
		test = report.startTest("deRegisterationTest execution starts");
		/*
		 * Local Variables
		 */
		String testCaseId = "DeRegistration_PayrollCompany";
		...
		//DeRegister Payroll Company
		Reporter.log("Deregister Payroll Company", true);
		pp.deRegisterCompany(driver);

	    Reporter.log("DeRegistration of Company will happen when all the errors are resolved", true);
	 
	    test.log(LogStatus.PASS, "Error Messages Validated, before Company can DeRegister");
		Reporter.log("Error Messages Validated, before Company can DeRegister", true);
	}
