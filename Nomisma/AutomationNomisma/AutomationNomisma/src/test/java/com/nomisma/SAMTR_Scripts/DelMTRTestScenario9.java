...
public class DelMTRTestScenario9 extends BaseLib {
	...
	public void funcDelTestCase9() throws Exception
	{
		
		test = report.startTest("Login to self Assessment");
		sTestCaseID="TestCase9";
		...
		test.log(LogStatus.PASS, "Mtr test case for 2017 -2018 -> 9 -> deleted successfully");
