...
public class DelUnderpaidTaxCls extends BaseLib {
	...
	public void funcDelUnderpaidTax() throws Exception
	{
		...
		s1.delUnderpaidTax(driver);
		test.log(LogStatus.PASS, "Underpaid Tax data deleted successfully");
