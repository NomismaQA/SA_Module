...
public class CTComputationTest2 extends BaseLib {
	...
	public void VerifyCTComputation() throws InterruptedException {
		...
		test = report.startTest("Test execution started to check CT Computation part 2");
		sTestCaseID="CTComputationTest2";
		...
		ct.CTComputationPart2(driver,sData[5],sData[6],sData[7],sData[8],sData[9],sData[10],sData[11],sData[12],sData[13],sData[14],sData[15],sData[16],sData[17],sData[18],sData[19],sData[20],sData[21],sData[22]);
