...
public class CreatePartnershipBusiness extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="addPartnershipBusiness";
	String testDataFile = ".\\testData\\Json\\AddBusinessModule.json";
	String sData1, sData2, sData3, sData4, sData5, sData6, sData7;
	@Test (priority=1)
	public void funcCreatePartnershipBusiness() throws Exception
	{
	...
	abp.addPartnershipBusiness(driver,sData4,sData5, sData6, sData7);
	test.log(LogStatus.PASS, "New partnership Business Created Successfully");
