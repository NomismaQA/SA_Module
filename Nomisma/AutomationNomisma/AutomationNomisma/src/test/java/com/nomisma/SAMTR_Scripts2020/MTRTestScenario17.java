...
public class MTRTestScenario17 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase17";
	...
	@Test(priority=2)
	public void funcAddTestCase17() throws Exception
	{		
		...
		sa.selectClientTest17(driver);
		s1.addTestCase17(driver, sData4,sData5, sData6,sData7, sData8,sData9,sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19);
		test.log(LogStatus.PASS, "Mtr test case17 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	/*@Test(priority=2)
	public void funcSubmissionTestCase17() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case17 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();			
	}*/
	@Test(priority=1)
	public void funcDelTestCase17() throws Exception
	{
		...
		s1.clickClientLst(driver);
		sa.selectClientTest17(driver);
		s1.funcDelMTRTest17(driver);
		test.log(LogStatus.PASS, "Mtr test case17 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();
		}
