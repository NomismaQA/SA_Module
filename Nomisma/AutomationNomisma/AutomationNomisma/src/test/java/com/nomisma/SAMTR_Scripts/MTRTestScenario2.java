...
public class MTRTestScenario2 extends BaseLib {
	...
	public void funcTestCase2() throws Exception
	{
		...
		s1.addTestCase2(driver, sData4,sData5, sData6,sData7, sData8,sData9,sData10,sData11,sData12,sData13);
		test.log(LogStatus.PASS, "Mtr test case for 2017 -2018 -> 2 -> added successfully");
