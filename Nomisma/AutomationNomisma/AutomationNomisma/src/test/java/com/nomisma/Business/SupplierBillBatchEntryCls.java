...
public class SupplierBillBatchEntryCls extends BaseLib {
	...
	@Test (priority=1)
	public void funcSupplierBillBatchEntry() throws Exception
	{
	...
	bp1.funcAddSupplierBillBatchEntry(driver,sData5, sData6, sData7, sData8, sData9);
	test.log(LogStatus.PASS, "Supplier Bill Batch Entry added Successfully");
