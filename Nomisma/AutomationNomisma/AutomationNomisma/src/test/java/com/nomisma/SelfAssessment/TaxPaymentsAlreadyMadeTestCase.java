...
public class TaxPaymentsAlreadyMadeTestCase extends BaseLib{
	
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="addTaxPaymentAdvanced";
	...
	public void funcVerifytaxPaymentAdvanced() throws Exception
	{
		...
		sp1.funcAddTaxPayment(driver,sData8, sData9, sData10);
		test.log(LogStatus.PASS, "Test case for Amount of Tax Payments Already Made added successfully");
