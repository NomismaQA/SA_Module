...
public class RepeatInvoiceCls  extends BaseLib {
	...
	@Test (priority=1)
	public void funcRepeatInvoice() throws Exception
	{
	...
	bp1.addCutomer(driver,sData5);
	bp1.repeatInvoive(driver, sData6, sData7, sData8, sData9);
	test.log(LogStatus.PASS, "Repeat Invoive added successfully");
