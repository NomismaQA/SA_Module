...
public class readpdfreportUnTaxedDivident extends BaseLib {
	...
	public void unTaxedPdfRead() throws Exception
	{
		...
		Reporter.log("File" + Filename, true);
		pdf.readDivident1PDF4InURL(driver,sData6,Filename,sData10,sData11,sData12,sData13,sData14,sData15,sData16,sData17);
		test.log(LogStatus.PASS, "Test case for Pdf Verification for Un Taxed Dividend Income added successfully");
