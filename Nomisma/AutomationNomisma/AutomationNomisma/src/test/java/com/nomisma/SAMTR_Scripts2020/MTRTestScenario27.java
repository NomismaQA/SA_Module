...
public class MTRTestScenario27 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase27";
	...
	@Test(priority=2)
	public void funcAddTestCase27() throws Exception
	{		
		...
		sa.selectClientTest27(driver);
		s1.addTestCase27(driver, sData4,sData5, sData6,sData7, sData8,sData9,sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19);
		test.log(LogStatus.PASS, "Mtr test case27 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	/*@Test(priority=2)
	public void funcSubmissionTestCase27() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case27 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();			
	}*/
	@Test(priority=1)
	public void funcDelTestCase27() throws Exception
	{
		...
		s1.clickClientLst(driver);
		sa.selectClientTest27(driver);
		s1.funcDelMTRTest27(driver);
		test.log(LogStatus.PASS, "Mtr test case27 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();
		}
