...
public class AddDividentIncome extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="BankName";
	...
	public void funcAddDividentIncome() throws Exception
	{
		...
		s1.addUKInterest(driver, sData7, sData4, sData8, sData9);
		s1.stateBenefit(driver, sData17, sData18, sData19, sData20,sData21);
		
		s1.verifyTaxDivident(driver, sData14, sData15, sData16, sData17, sData19, sData20, sData21, sData9,sData18);
		test.log(LogStatus.PASS, "Test case for Dividend Income added successfully");
