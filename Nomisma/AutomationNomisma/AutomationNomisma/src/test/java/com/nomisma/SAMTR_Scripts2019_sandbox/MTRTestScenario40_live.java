...
public class MTRTestScenario40_live extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase40_live";
	...
	public void funcTestCase40() throws Exception
	{	
		...
		sa.selectClientTest40(driver);
		s1.addTestCase40(driver,sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14,sData15,sData16,sData17,sData18,sData19,sData20,sData21,sData22,sData23,sData24,sData25);
		test.log(LogStatus.PASS, "Mtr test case40 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
/*@Test (priority=2)//,retryAnalyzer = RetryAnalyzer.class)
public void funcSubmitToHmrcCase40() throws Exception
{
	...
	test.log(LogStatus.PASS, "Mtr test case40 -> Tax Submission successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();		
	}
@Test (priority=3)
public void funcDelTestCase40() throws Exception
{
	...
	s1.clickClientLst(driver);
	sa.selectClientTest40(driver);
	s1.funcDelMTRTest40(driver);
	test.log(LogStatus.PASS, "Mtr test case40 -> deleted successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();	
	}*/
