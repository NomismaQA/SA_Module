...
public class SA800BusinessInvestmentBusinessQues1 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "BusinessQuesSA800";
	String testDataFile = ".\\testData\\Json\\AddBusinessModule.json";
	String sData1, sData2, sData3, sData4, sData5, sData6;
	@Test (priority=1)
	public void funcVerifyBusinessQues1SA800BusinsInvest() throws Exception
	{
	...
	abp.funcSA800_PartnershipBusinessAndInvestmentIncome_BusinessQuestionsQ1(driver);
	abp.funcSA800_PartnershipBusinessAndInvestmentIncome_BusinessQuestionsQ1(driver,sData6); 
	abp.funcSA801Del(driver);
	test.log(LogStatus.PASS, "Quetion 1 of Partnership business and investment income of SA800 verified Successfully");
