...
public class AddEmploymentIncome extends BaseLib{
	
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="addEmpIncome1";
	...
	public void funcVerifytax() throws Exception
	{
		...
		sp1.taxCalculationSummary(sData8, sData9, sData10,driver);
		test.log(LogStatus.PASS, "Test case for Employment income tax verification added successfully");
