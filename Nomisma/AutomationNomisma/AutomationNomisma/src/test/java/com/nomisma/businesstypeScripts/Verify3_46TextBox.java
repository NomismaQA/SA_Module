...
public class Verify3_46TextBox extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "Data3.46Auto";
	...
	@Test (priority=1)
	public void funcVerify3_46BoxPTRFull() throws Exception
	{
	...
	abp.Verify3_46PTRFull(driver,sData6, sData7,sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19);
	abp.funcDelAutoPartnership(driver);
	test.log(LogStatus.PASS, "Box 3.46 of PTR Full verified Successfully");
