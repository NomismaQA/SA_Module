...
public class UpdateCTAdjustmentsSettingsRDClaimTest2 extends BaseLib{
	...
	public void UpdateCTAdjustmentsSettings() throws InterruptedException {
		...
		test = report.startTest("Test execution started to Update CT Adjustments Settings Page2");
		sTestCaseID="UpdateCTAdjustmentsSettingsRDClaimTest2";
