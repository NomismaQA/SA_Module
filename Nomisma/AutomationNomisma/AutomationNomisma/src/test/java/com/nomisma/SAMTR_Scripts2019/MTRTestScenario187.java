...
public class MTRTestScenario187 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase187";
	...
	public void funcAddTestCase187() throws Exception
	{		
		...
		sa.selectClientTest187(driver);
		s1.addTestCase187(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14,sData15);
		test.log(LogStatus.PASS, "Mtr test case187 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();			
	}
	/*@Test (priority=2)
	public void funcSubmitToHmrcTestCase187() throws Exception
	{		
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		test.log(LogStatus.PASS, "Mtr test case187 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
		}*/
	@Test (priority=3)
	public void funcDelTestCase187() throws Exception
	{
		...
		s1.clickClientLst(driver);
		sa.selectClientTest187(driver);
		s1.funcDelTest187(driver);
		test.log(LogStatus.PASS, "Mtr test case187 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}
