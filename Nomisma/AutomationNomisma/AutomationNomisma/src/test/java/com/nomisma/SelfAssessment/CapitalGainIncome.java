...
public class CapitalGainIncome extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="CapitalGain";
...
@Test (priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void addCapitalGainIncome() throws Exception
	{
		...
		s1.capitalGainFormValidate(driver,sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14,sData15,sData16,sData17,sData18,sData19,sData20,sData21,sData22,sData23,sData24,sData25,sData26,sData27,sData28,sData29);
		test.log(LogStatus.PASS, "Test case for Capital Gain Income for 2017-2018 added successfully");
