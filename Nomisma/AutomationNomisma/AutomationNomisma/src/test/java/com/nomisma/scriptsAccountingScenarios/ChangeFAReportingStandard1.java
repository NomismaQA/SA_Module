...
public class ChangeFAReportingStandard1 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void ChangeReportingStandard() throws InterruptedException {

		test = report.startTest("Test execution started to Change FA Reporting Standard Test");
		sTestCaseID="ChangeFAReportingStandard";
		...
		As.ChangeReportingStandard(driver, sData[5], sData[7], sData[8], sData[9], sData[10]);
