...
public class VerifyTrialBalanceReportTest10 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VerifyTrialBalanceReport() throws InterruptedException, EmptyFileException, IOException {

		test = report.startTest("Test execution started to Verify Trial Balance on Nomisma Live");
		sTestCaseID="VerifyTrialBalanceReportTest10";
		...
		ST.VerifyTrialBalanceReport2(driver, sData[5], sData[6], sData[7], sData[8], sData[12], sData[8], sData[9], sData[10], sData[11]);
