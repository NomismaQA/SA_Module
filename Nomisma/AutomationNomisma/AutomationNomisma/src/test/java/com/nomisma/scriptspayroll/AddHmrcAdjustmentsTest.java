...
public class AddHmrcAdjustmentsTest extends BaseLib {
	
	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void hmrcAdjustmentsTest() throws InterruptedException, NoSuchElementException
	{
		
		test = report.startTest("hmrcAdjustmentsTest execution starts");
		/*
		 * Local Variables
		 */
		
		String testCaseId = "HMRC_Adjustments";
		...
		//Run Payroll
		Reporter.log("Add HMRC Adjustments for Previous Months", true);
		pp.hmrcAdjustments(driver, sData5);
		
		
			 
	    test.log(LogStatus.PASS, "HMRC Adjustment for Previous Month added Successfully");
		Reporter.log("HMRC Adjustment for Previous Month added Successfully", true);
	}
