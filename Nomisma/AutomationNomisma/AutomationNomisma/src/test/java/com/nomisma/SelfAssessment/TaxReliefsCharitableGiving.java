...
public class TaxReliefsCharitableGiving extends BaseLib{
	
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="addEmpIncome6";
	...
	public void funcCharitableGiving() throws Exception
	{
		...
		sp1.addCharitableGiving(driver, sData11, sData12,sData13, sData14);
		test.log(LogStatus.PASS, "Test case for Tax Reliefs for Charitable Giving added successfully");
