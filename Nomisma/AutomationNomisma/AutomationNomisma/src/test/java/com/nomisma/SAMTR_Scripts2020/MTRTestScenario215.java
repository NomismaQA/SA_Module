...
public class MTRTestScenario215 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase215";
	...
	@Test (priority=2)
	public void funcTestCase215() throws Exception
	{	
		...
		sa.selectClientTest215(driver);
		s1.addTestCase215(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14,sData15,sData16,sData17,sData18,sData19,sData20,sData21,sData22,sData23,sData24,sData25,sData26,sData27,sData28,sData29);
		test.log(LogStatus.PASS, "Mtr test case215 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	/*@Test(priority=2)
	public void funcSubmissionTestCase215() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case215 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
		}*/
	@Test (priority=1)
	public void funcDelTestCase215() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		s1.clickClientLst(driver);
		sa.selectClientTest215(driver);
		s1.funcDelMTRTest215(driver);
		test.log(LogStatus.PASS, "Mtr test case215 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();
		}
