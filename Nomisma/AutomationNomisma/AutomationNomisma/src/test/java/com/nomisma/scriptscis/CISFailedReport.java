...
public class CISFailedReport extends BaseLib {

	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void FailedReport() throws InterruptedException, EmptyFileException, IOException{
		...
		String testCaseId = "CISFailedReport";
