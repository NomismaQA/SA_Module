...
public class StudentLoanRepayCls2 extends BaseLib{
	...
	public void funcStudentLoanRepay() throws Exception
	{
		...
		sp1.addStudentLoanRepaymentPlan2(driver, sData8,sData9);
		test.log(LogStatus.PASS, "Test case for Student Loan for class2 added successfully");
