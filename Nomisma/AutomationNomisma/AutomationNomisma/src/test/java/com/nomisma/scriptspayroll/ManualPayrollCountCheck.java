...
public class ManualPayrollCountCheck extends BaseLib {
	...
	{
		test = report.startTest("Manual Payroll Count Test execution starts");
		...
		pp2.CountCheckManualPayroll(driver,curUrl);
		Reporter.log("Manual Payroll Count verified successfully", true);
