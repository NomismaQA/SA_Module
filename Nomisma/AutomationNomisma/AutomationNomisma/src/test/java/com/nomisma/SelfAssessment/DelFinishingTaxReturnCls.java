...
public class DelFinishingTaxReturnCls extends BaseLib {
	...
	public void funDelFinishingTax() throws Exception
	{
		...
		s1.delFinishingTaxReturn(driver);
		test.log(LogStatus.PASS, "Finishing Tax Return deleted successfully");
