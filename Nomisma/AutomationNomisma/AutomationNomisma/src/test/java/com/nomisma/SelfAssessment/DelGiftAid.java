...
public class DelGiftAid extends BaseLib {
	...
	public void funDelGiftAid() throws Exception
	{
		...
		s1.delInfoGiftAid(driver);
		test.log(LogStatus.PASS, "Gift Aid Income deleted successfully");
