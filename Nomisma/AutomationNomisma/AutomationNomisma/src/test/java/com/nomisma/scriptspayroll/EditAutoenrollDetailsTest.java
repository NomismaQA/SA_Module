...
public class EditAutoenrollDetailsTest extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test (priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void autoenrollTest() throws InterruptedException, NoSuchElementException
	{
		test = report.startTest("autoenrollTest execution starts");
		sTestCaseID="Run_Payroll";
		...
		pp.EditAutoEnrollDetails(sData[5], sData[6], sData[7], sData[8], sData[9], sData[10], sData[11], driver);
}
