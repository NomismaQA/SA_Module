...
public class VerifyPayrollDashboardTest extends BaseLib {
	
	String sTestCaseID=null;
	String[] sData=null;

	@Test //(retryAnalyzer = RetryAnalyzer.class)
	public void VerifyPayrollDashboard() throws InterruptedException, NoSuchElementException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		pp3.PayrollDashboard(driver, sData[4], sData[5], sData[6], sData[7]); 
	}
