...
public class CTComputationCapitalAllowanceTest2 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void CTComputationCapitalAllowance2() throws InterruptedException {

		test = report.startTest("Test execution started to check CT Computation Capital Allowance 2");
		sTestCaseID="CTComputationCapitalAllowanceTest2";
