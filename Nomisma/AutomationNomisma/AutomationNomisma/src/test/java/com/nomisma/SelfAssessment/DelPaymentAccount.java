...
public class DelPaymentAccount extends BaseLib {
	...
	public void funDelPaymentAccount() throws Exception
	{
		...
		s1.delPaymentOnAccount(driver);
		test.log(LogStatus.PASS, "Payment on Account deleted successfully");
