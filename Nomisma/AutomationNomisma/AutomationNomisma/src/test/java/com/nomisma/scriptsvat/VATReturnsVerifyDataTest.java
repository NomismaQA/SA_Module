...
public class VATReturnsVerifyDataTest extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test (priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VATReturnsVerifyData() throws InterruptedException {

		test = report.startTest("Test execution started to verify VAT Returns Data");
		...
		vat.VATReturnsVerifyData(driver, sData[5], sData[6]);
