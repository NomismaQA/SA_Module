...
public class CheckingBoxesPTRFullAuto extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "DataPTRFullAuto";
	...
	abp.addTurnoverIncomeForPTRFull(driver,sData6, sData7,sData8, sData9, sData10, sData11, sData12, sData13);
