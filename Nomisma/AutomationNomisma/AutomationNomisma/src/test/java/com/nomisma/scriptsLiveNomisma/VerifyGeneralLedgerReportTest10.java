...
public class VerifyGeneralLedgerReportTest10 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VerifyGeneralLedgerReport() throws InterruptedException, EmptyFileException, IOException {

		test = report.startTest("Test execution started to Verify General Ledger on Nomisma Live");
		sTestCaseID="VerifyGeneralLedgerReportTest10";
		...
		ST.VerifyGeneralLedgerReport2(driver, sData[5], sData[6], sData[7], sData[8], sData[12], sData[8], sData[9], sData[10], sData[11]);
