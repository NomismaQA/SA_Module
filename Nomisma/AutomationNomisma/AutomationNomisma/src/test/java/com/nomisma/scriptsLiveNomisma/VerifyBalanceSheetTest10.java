...
public class VerifyBalanceSheetTest10 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VerifyBalanceSheet() throws InterruptedException, EmptyFileException, IOException {

		test = report.startTest("Test execution started to Verify Balance Sheet on Nomisma Live");
		sTestCaseID="VerifyBalanceSheetTest10";
		...
		ST.VerifyBalanceSheet(driver, sData[5], sData[6], sData[7], sData[8], sData[12], sData[8], sData[9], sData[10], sData[11]);
