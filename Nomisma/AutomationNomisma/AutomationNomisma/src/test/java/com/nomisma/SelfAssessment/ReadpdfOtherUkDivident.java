...
public class ReadpdfOtherUkDivident extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="pdfVrfyOtherUKIncome";
	...
	public void otherUKTaxedPdfRead() throws Exception
	{
		...
		pdf.readOtherUkIncomePDF4InURL(driver,sData6,Filename,sData10,sData11,sData15,sData16,sData18,sData19,sData20,sData21,sData22,sData26);
		test.log(LogStatus.PASS, "Test case for Pdf Verification for Other Uk Dividend Income added successfully");
