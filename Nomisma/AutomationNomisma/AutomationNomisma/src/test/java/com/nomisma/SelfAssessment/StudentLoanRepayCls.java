...
public class StudentLoanRepayCls extends BaseLib{
	...
	public void funcStudentLoanRepay() throws Exception
	{
		...
		sp1.addStudentLoanRepaymentPlan1(driver, sData8,sData9);
		test.log(LogStatus.PASS, "Test case for Student Loan for class1 Repay added successfully");
