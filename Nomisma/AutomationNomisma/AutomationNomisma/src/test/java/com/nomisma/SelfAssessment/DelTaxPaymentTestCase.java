...
public class DelTaxPaymentTestCase extends BaseLib {
	...
	public void funDelTaxPayment() throws Exception
	{
		...
		s1.delTaxPayment(driver);
		test.log(LogStatus.PASS, "Tax Payment already made data deleted successfully");
