...
public class AddUKbanksForeignInterest extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="ForeignInterestCheck";
	...
	public void addForeignIncomeFunc() throws Exception
	{
		...
		s1.addIncomeBasic(sData17, sData18, sData19,driver);
		
		s1.clickIncome(driver);
		
		s1.addBank(driver,sData4 , sData5, sData6);
		
		s1.foreignInterestAddIncome(driver, sData7, sData4, sData8, sData9);
		
		s1.dividentUKCompanies(driver,sData14,sData15 ,sData16 );
		
		s1.stateBenefit(driver, sData20, sData21, sData22,sData23, sData24);
		
		s1.addOtherDivident(driver, sData25,sData26, sData27);
		
		s1.verifyForeighDivident(driver,sData9, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27);
		test.log(LogStatus.PASS, "Test case for UK banks Foreign Interest for 2017-2018 added successfully");
