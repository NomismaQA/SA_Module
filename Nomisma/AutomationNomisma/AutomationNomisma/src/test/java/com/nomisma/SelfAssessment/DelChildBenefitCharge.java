...
public class DelChildBenefitCharge extends BaseLib {
	...
	public void funcDelChildBenefit() throws Exception
	{
		...
		s1.delChildBenefitCharge(driver);
		test.log(LogStatus.PASS, "Child Benefit Charge Income deleted successfully");
