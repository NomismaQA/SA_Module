...
public class MTRTestScenario87_live extends BaseLib {
	...
	public void funcAddTestCase87() throws Exception
	{
		...
		sa.selectClientTest87(driver);
		s1.addTestCase87(driver, sData4,sData5, sData6,sData7, sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27, sData28, sData29,sData30,sData31, sData32, sData33, sData34, sData35, sData36, sData37, sData38, sData39, sData40, sData41, sData42,sData43,sData44, sData45, sData46, sData47, sData48, sData49, sData50, sData51, sData52, sData53,sData54,sData55, sData56, sData57, sData58, sData59, sData60);
		test.log(LogStatus.PASS, "Mtr test case 87 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	/*@Test (priority=2)
	public void funcSubmissionTestCase87() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		test.log(LogStatus.PASS, "Mtr test case 87 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
	}*/
	@Test (priority=3)
	public void funcDelTestCase87() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		s1.clickClientLst(driver);
		sa.selectClientTest87(driver);
		s1.delTestCase87(driver);
		test.log(LogStatus.PASS, "Mtr test case 87 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}
