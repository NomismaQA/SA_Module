...
public class MTRTestScenario76 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase76";
	...
	@Test(priority=1)
	public void funcAddTestCase76() throws Exception
	{
		...
		sa.selectClientTest76(driver);
		s1.addTestCase76(driver, sData4,sData5, sData6,sData7, sData8,sData9,sData10,sData11);
		test.log(LogStatus.PASS, "Mtr test case 76 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}
	/*@Test(priority=2)
	public void funcSubmissionTestCase76() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case 76 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}*/
	@Test (priority=3)
	public void funcDelTestCase76() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		s1.clickClientLst(driver);
		sa.selectClientTest76(driver);
		s1.funcDelMTRTest76(driver);
		test.log(LogStatus.PASS, "Mtr test case 76 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}
