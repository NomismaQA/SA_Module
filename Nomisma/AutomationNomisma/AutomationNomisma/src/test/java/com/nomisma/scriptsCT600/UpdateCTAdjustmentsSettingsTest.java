...
public class UpdateCTAdjustmentsSettingsTest extends BaseLib{
	...
	public void UpdateCTAdjustmentsSettings() throws InterruptedException {
		...
		sTestCaseID="UpdateCTAdjustmentsSettingsPageTest";
		...
		ct.ClearCTAdjustmentsSettings(driver,sData[5],sData[6],sData[7],sData[8],sData[9]);
		ct.UpdateCTAdjustmentsSettings(driver,sData[5],sData[6],sData[7],sData[8],sData[9],sData[10],sData[11],sData[12],sData[13],sData[14],sData[15],sData[16],sData[17],sData[18],sData[19],sData[20],sData[21]);
