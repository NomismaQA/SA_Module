...
public class MTRTestScenario3 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase3";
	...
	@Test(priority=2)
	public void funcAddTestCase3() throws Exception
	{		
		...
		sa.selectClientTest3(driver);
		s1.addTestCase3(driver, sData4, sData5, sData6, sData7, sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27, sData28, sData29, sData30,sData31,sData32,sData33,sData34,sData35,sData36);
		test.log(LogStatus.PASS, "Mtr test case3 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();			
	}
	/*@Test(priority=3)
	public void funcSubmissionTestCase3() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case3 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}*/
	@Test(priority=1)
	public void funcDelTestCase3() throws Exception
	{
		...
		s1.clickClientLst(driver);
		sa.selectClientTest3(driver);
		s1.funcDelMTRTest3(driver);
		test.log(LogStatus.PASS, "Mtr test case3 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();
		}
