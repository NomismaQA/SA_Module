...
public class PdfVerifyUnderPaidTax extends BaseLib {
	...
	public void funcVerifyPdf() throws Exception
	{
		...
		pdf.checkPdfEntryUnderpaidTax(driver,sData6,Filename);
		test.log(LogStatus.PASS, "Test case for Pdf Verification for Under Paid Tax Income added successfully");
