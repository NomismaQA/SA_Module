...
public class VATReturnsEmailTest extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test (priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VATReturnsEmail() throws InterruptedException {
		...
		vat.VATReturnsEmail(driver, sData[5], sData[8], sData[9]);
