...
public class MTRTestScenario201 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase201";
	String testDataFile = ".\\testData\\Json\\TestDataNomismaSAMTR2019.json";
	String sData1,sData2, sData3, sData4, sData5, sData6, sData7, sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27, sData28, sData29,sData30,sData31, sData32, sData33, sData34, sData35, sData36, sData37, sData38, sData39, sData40, sData41, sData42,sData43,sData44, sData45, sData46, sData47, sData48, sData49, sData50, sData51, sData52, sData53,sData54,sData55, sData56, sData57, sData58, sData59, sData60, sData61,sData62,sData63, sData64, sData65, sData66, sData67, sData68, sData69, sData70, sData71, sData72, sData73, sData74, sData75, sData76, sData77, sData78, sData79, sData80, sData81;
	HashMap<String, String> testDataMap = commUtils.getKeyValueFromJson(testDataFile, sTestCaseID);
@Test (priority=2)
	public void funcAddTestCase201() throws Exception
	{
		...
		sData58 = testDataMap.get("sData58").replaceAll("\"", "");
		sData59 = testDataMap.get("sData59").replaceAll("\"", "");
		sData60 = testDataMap.get("sData60").replaceAll("\"", "");
		sData61 = testDataMap.get("sData61").replaceAll("\"", "");
		sData62 = testDataMap.get("sData62").replaceAll("\"", "");
		sData63 = testDataMap.get("sData63").replaceAll("\"", "");
		sData64 = testDataMap.get("sData64").replaceAll("\"", "");
		sData65 = testDataMap.get("sData65").replaceAll("\"", "");
		sData66= testDataMap.get("sData66").replaceAll("\"", "");
		sData67 = testDataMap.get("sData67").replaceAll("\"", "");
		sData68 = testDataMap.get("sData68").replaceAll("\"", "");
		sData69 = testDataMap.get("sData69").replaceAll("\"", "");
		sData70 = testDataMap.get("sData70").replaceAll("\"", "");
		sData71 = testDataMap.get("sData71").replaceAll("\"", "");
		sData72 = testDataMap.get("sData72").replaceAll("\"", "");
		sData73 = testDataMap.get("sData73").replaceAll("\"", "");
		sData74 = testDataMap.get("sData74").replaceAll("\"", "");
		sData75 = testDataMap.get("sData75").replaceAll("\"", "");
		sData76 = testDataMap.get("sData76").replaceAll("\"", "");
		sData77 = testDataMap.get("sData77").replaceAll("\"", "");
		sData78 = testDataMap.get("sData78").replaceAll("\"", "");
		sData79 = testDataMap.get("sData79").replaceAll("\"", "");
		sData80 = testDataMap.get("sData80").replaceAll("\"", "");
		sData81 = testDataMap.get("sData81").replaceAll("\"", "");
		...
		sa.selectClientTest201(driver);
		s1.addTestCase201(driver, sData4, sData5, sData6, sData7, sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27, sData28, sData29,sData30,sData31, sData32, sData33, sData34, sData35, sData36, sData37, sData38, sData39, sData40, sData41, sData42,sData43,sData44, sData45, sData46, sData47, sData48, sData49, sData50, sData51, sData52, sData53,sData54,sData55, sData56, sData57, sData58, sData59, sData60, sData61,sData62,sData63, sData64, sData65, sData66, sData67, sData68, sData69, sData70, sData71, sData72, sData73, sData74, sData75, sData76, sData77, sData78, sData79, sData80, sData81);
		test.log(LogStatus.PASS, "Mtr test case 201 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	/*@Test (priority=3)
	public void funcSubmissionTestCase201() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		test.log(LogStatus.PASS, "Mtr test case 201 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
	}*/
	@Test (priority=1)
	public void funcDelTestCase201() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		s1.clickClientLst(driver);
		sa.selectClientTest201(driver);
		s1.delTestCase201(driver);
		test.log(LogStatus.PASS, "Mtr test case 201 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}
