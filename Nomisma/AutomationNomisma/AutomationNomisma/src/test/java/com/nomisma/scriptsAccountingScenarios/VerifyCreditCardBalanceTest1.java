...
public class VerifyCreditCardBalanceTest1 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VerifyBankBalance() throws InterruptedException {

		test = report.startTest("Test execution started to Verify VerifyCreditCardBalanceTest1 Report Test");
		sTestCaseID="VerifyCreditCardBalanceTest1";
		...
		ct.VerifyAccountBalance(driver, sData[5], sData[6], sData[11], sData[7], sData[8], sData[9], sData[10]);
