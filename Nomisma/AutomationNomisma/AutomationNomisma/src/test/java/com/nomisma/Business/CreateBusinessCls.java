...
public class CreateBusinessCls  extends BaseLib {
	...
	bp1.createBusiness(driver,sData4,sData5, sData6, sData7);
	test.log(LogStatus.PASS, "New Business Created Successfully");
