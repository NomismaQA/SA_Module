...
public class SA800Trading_professionalIncome1 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "TradingprofessionalIncome1";
	...
	abp.funcTradingAndProfessionalIncome1(driver,sData6, sData7,sData8, sData9, sData10);
