...
public class EnableDisableAutoEnrolment extends BaseLib{

	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void EnableDisableAutoEnrol() throws InterruptedException
	{
		test = report.startTest("Test execution started to enable Auto Enrolment");

		/*
		 * Local Variables
		 */
		
		String testCaseId = "EnableAutoEnrolment";
		...
		ae.verifyAgentSetupPage(driver,sData4);
		ae.EnableDisableAE(driver,sData4,sData5);
