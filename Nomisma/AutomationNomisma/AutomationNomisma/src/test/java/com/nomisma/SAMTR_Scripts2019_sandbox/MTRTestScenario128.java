...
public class MTRTestScenario128 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase128";
	...
	@Test(priority=2)
	public void funcAddTestCase128() throws Exception
	{		
		...
		sa.selectClientTest128(driver);
		s1.addTestCase128(driver, sData4, sData5, sData6, sData7, sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27, sData28, sData29, sData30,sData31,sData32,sData33,sData34,sData35);
		test.log(LogStatus.PASS, "Mtr test case 128 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();			
	}
	/*@Test(priority=3)
	public void funcSubmissionTestCase128() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case 128 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}*/
	@Test(priority=1)
	public void funcDelTestCase128() throws Exception
	{
		...
		s1.clickClientLst(driver);
		sa.selectClientTest128(driver);
		s1.delTestCase128(driver);
		test.log(LogStatus.PASS, "Mtr test case 128 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();
		}
