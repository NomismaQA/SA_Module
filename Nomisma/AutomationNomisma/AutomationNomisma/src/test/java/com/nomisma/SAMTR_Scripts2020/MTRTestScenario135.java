...
public class MTRTestScenario135 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase135";
	...
	public void funcTestCase135() throws Exception
	{
		...
		sa.selectClientTest135(driver);
		s1.addTestCase135(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14,sData15,sData16,sData17,sData18,sData19,sData20,sData21,sData22,sData23,sData24,sData25,sData26,sData27,sData28,sData29,sData30, sData31, sData32, sData33, sData34, sData35, sData36, sData37, sData38, sData39,sData40,sData41);
		test.log(LogStatus.PASS, "Mtr test case135 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	/*@Test (priority=2,retryAnalyzer = RetryAnalyzer.class)
	public void funcSubmitToHmrcCase135() throws Exception
	{
	...
	test.log(LogStatus.PASS, "Mtr test case135 -> Tax Submission successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();		
	}*/
	@Test (priority=1)//,retryAnalyzer = RetryAnalyzer.class)
	public void funcDelTestCase135() throws Exception
	{
	...
	s1.clickClientLst(driver);
	sa.selectClientTest135(driver);
	s1.funcDelMTRTest135(driver);
	test.log(LogStatus.PASS, "Mtr test case135 -> deleted successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();	
	}
