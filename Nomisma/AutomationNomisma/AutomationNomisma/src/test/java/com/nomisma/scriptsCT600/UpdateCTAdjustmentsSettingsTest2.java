...
public class UpdateCTAdjustmentsSettingsTest2 extends BaseLib{
	...
	public void UpdateCTAdjustmentsSettings() throws InterruptedException {
		...
		sTestCaseID="UpdateCTAdjustmentsSettingsPageTest2";
		...
		ct.ClearCTAdjustmentsSettings2(driver,sData[5],sData[6],sData[7],sData[12]);
		ct.UpdateCTAdjustmentsSettings2(driver,sData[5],sData[6],sData[7],sData[8],sData[9],sData[10],sData[11],sData[12]);
