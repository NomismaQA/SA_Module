...
public class CreatePLCBusiness extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="addPLCBusiness";
	String testDataFile = ".\\testData\\Json\\AddBusinessModule.json";
	String sData1, sData2, sData3, sData4, sData5, sData6, sData7;
	@Test (priority=1)
	public void funcCreatePLCBusiness() throws Exception
	{
	...
	abp.addPLCBusiness(driver,sData4,sData5, sData6, sData7);
	test.log(LogStatus.PASS, "New PLC Business Created Successfully");
