...
public class MTRTestScenario212 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase212";
	String testDataFile = ".\\testData\\Json\\TestDataNomismaSAMTR2020Live.json";
	String sData1,sData2, sData3, sData4, sData5, sData6, sData7, sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27, sData28, sData29,sData30,sData31;
	@Test (priority=2)
	public void funcTestCase212() throws Exception
	{
	...
	sa.selectClientTest212(driver);
	s1.addTestCase212(driver, sData4, sData5, sData6, sData7, sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27, sData28, sData29,sData30,sData31);
	test.log(LogStatus.PASS, "Test case 212 data added Successfully");
	Reporter.log("Test execution of tax verification done successfully", true);
	report.endTest(test);
	report.flush();
	}
	/*@Test(priority=2)
	public void funcSubmissionTestCase212() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Test case 212 Submission to HMRC completed Successfully");
		Reporter.log("Test execution of Submission to HMRC and XML file verification done successfully", true);
		report.endTest(test);
		report.flush();
		}
	@Test (priority=1)
	public void funcDelTestCase212() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		HashMap<String, String> testDataMap = commUtils.getKeyValueFromJson(testDataFile, sTestCaseID);
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		...
		s1.clickClientLst(driver);
		sa.selectClientTest212(driver);
		s1.funcDelMTRTest212(driver);
		test.log(LogStatus.PASS, "Test case 212 Data deletion completed Successfully");
