...
public class AddVATOnlySupplierBillCLS extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="AddVatOnlySupplierBill";
	...
	@Test (priority=1)
	public void funcAddVATOnlySupplierBill() throws Exception
	{
	...
	bp1.addVATOnlySupplierBill(driver,sData5, sData6, sData7, sData8);
	test.log(LogStatus.PASS, "VAT only Supplier Bill added Successfully");
