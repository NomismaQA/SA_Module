...
public class VerifyCTAdjustmentsSettingsPageTest extends BaseLib{
	...
	public void VerifyCTAdjustmentsSettings() throws InterruptedException {
		...
		test = report.startTest("Test execution started to Verify CT Adjustments Settings Page");
		sTestCaseID="VerifyCTAdjustmentsSettingsPageTest";
		...
		ct.VerifyCTAdjustmentsSettings(driver,sData[5],sData[6],sData[7],sData[8],sData[9]);
