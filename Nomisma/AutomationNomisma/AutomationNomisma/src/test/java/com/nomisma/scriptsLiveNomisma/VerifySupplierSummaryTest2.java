...
public class VerifySupplierSummaryTest2 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VerifySupplierSummary() throws InterruptedException, EmptyFileException, IOException {

		test = report.startTest("Test execution started to Verify Supplier Summary on Nomisma Live");
		sTestCaseID="VerifySupplierSummaryTest2";
		...
		ST.VerifySupplierSummary(driver, sData[5], sData[6], sData[7], sData[8]);
