...
public class CreateLimitedBusiness extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="addNewLtdBusiness";
	String testDataFile = ".\\testData\\Json\\AddBusinessModule.json";
	String sData1, sData2, sData3, sData4, sData5, sData6, sData7;
	@Test (priority=1)
	public void funcCreateLtdBusiness() throws Exception
	{
	...
	abp.addLimitedBusiness(driver,sData4,sData5, sData6, sData7);
	test.log(LogStatus.PASS, "New Limited Business Created Successfully");
