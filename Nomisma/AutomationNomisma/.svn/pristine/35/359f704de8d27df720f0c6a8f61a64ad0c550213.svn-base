...
public class MTRTestScenario133 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase133";
	...
	public void funcAddTestCase133() throws Exception
	{
		...
		sa.selectClientTest133(driver);
		s1.addTestCase133(driver, sData4, sData5, sData6, sData7, sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27, sData28, sData29,sData30,sData31, sData32, sData33, sData34);
		test.log(LogStatus.PASS, "Mtr test case 133 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	/*@Test (priority=2)
	public void funcSubmitToHmrcCase133() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case 133 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();			
	}*/
	@Test (priority=1)
	public void funcDelTestCase133() throws Exception
	{		
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		s1.clickClientLst(driver);
		sa.selectClientTest133(driver);
		s1.delTestCase133(driver);
		test.log(LogStatus.PASS, "Mtr test case133 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}
