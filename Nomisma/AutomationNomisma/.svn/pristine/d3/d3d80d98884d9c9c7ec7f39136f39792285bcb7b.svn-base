...
public class MTRTestScenario226_live extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase226_live";
	...
	{		
		...
		s1.addTestCase226(driver, sData4,sData5, sData6, sData7, sData8, sData9,sData10);
