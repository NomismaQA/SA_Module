...
public class VerifyPdfForMarriageAllowance extends BaseLib {
	...
	public void funcVerifyPdfMarriageAllowance() throws Exception
	{
		...
		Thread.sleep(2000);
		pdf.checkPdfEntryMarriageAllowance(driver,sData6,Filename);
		test.log(LogStatus.PASS, "Test case for Pdf Verification for Marriage Allowance added successfully");
