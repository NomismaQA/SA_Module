...
public class MTRTestScenario62 extends BaseLib {
	...
	@Test (priority=2)
	public void funcAddTestCase62() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case 62 -> added successfully");
	...
	public void funcSubmissionTestCase62() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case 62 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}*/
	...
	public void funcDelTestCase62() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case 62 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}
