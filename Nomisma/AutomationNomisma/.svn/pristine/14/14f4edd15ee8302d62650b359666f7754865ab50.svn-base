...
public class PdfVerifyChildBenefit extends BaseLib {
	...
	public void funcVerifyPdf() throws Exception
	{
		...
		pdf.checkPdfEntryChildBenefit(driver,sData6,Filename);
		test.log(LogStatus.PASS, "Test case for Pdf Verification for 'Self Assessment Forms' of Child benefit allowance added successfully");
