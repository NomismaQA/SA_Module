...
public class BatchInvoiceTestCase  extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="BatchInvoice";
	...
	@Test (priority=1)
	public void funcBatchInvoice() throws Exception
	{
	...
	bp1.addbatchInvoive(driver, sData5, sData6, sData7, sData8, sData9);
	test.log(LogStatus.PASS, "Batch Invoice added Successfully");
