...
public class VerifyBankBalanceTest2 extends BaseLib {
	...
	public void VerifyBankBalance() throws InterruptedException {
		...
		test = report.startTest("Test execution started to Verify VerifyBankBalance2 Report Test");
		sTestCaseID="VerifyBankBalanceTest2";
