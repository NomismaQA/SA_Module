...
public class VerifyCostOfSalesFRS105_TrialBalance_Test1 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VerifyCostOfSalesFRS105_TrialBalance() throws InterruptedException {

		test = report.startTest("Test execution started to Verify Cost of Sales in FRS105 and TrialBalance Test");
		sTestCaseID="VerifySalesFRS105_TrialBalance_Test1";
		...
		As.VerifyCostOfSalesFRS105_TrialBalance(driver, sData[5], sData[7], sData[8], sData[9]);
