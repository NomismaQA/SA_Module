...
public class DelStudentLoanCls extends BaseLib {
	...
	public void funcDelStudentLoan() throws Exception
	{
		...
		s1.delStudentLoanRepayment(driver);
		test.log(LogStatus.PASS, "Student Loan Reliefs data deleted successfully");
