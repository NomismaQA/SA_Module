...
public class VerifyCustomerBalanceTest2 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void erifyCustomerBalance() throws InterruptedException {

		test = report.startTest("Test execution started to Verify CustomerBalanceTest2 Report Test");
		sTestCaseID="VerifyCustomerBalanceTest2";
