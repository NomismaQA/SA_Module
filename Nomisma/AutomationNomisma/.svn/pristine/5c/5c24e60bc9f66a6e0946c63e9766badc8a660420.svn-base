...
public class SA800BusinessInvestmentBusinessQues3 extends BaseLib {
	...
	@Test (priority=1)
	public void funcVerifyBusinessQues3SA800BusinsInvest() throws Exception
	{
	...
	abp.funcSA800_PartnershipBusinessAndInvestmentIncome_BusinessQuestionsQ3(driver);
	abp.funcSA800_PartnershipBusinessAndInvestmentIncome_BusinessQuestionsQ3(driver,sData6); 
	abp.funcSA800TradingProfessionalIncomeDel(driver);
	test.log(LogStatus.PASS, "Quetion 3 of Partnership business and investment income of SA800 verified Successfully");
