...
public class SearchandDeletePensionSchemeTest extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void SearchandDeletePension() throws InterruptedException{
				
		test = report.startTest("Test execution started to Search and Delete Pension Scheme");
		...
		ae.DeletePensionScheme(driver,sData[22]);
