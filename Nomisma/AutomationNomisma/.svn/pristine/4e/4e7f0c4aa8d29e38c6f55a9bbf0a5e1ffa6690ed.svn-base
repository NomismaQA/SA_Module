...
public class MTRTestScenario137 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase137";
	...
	@Test(priority=2)
	public void funcAddTestCase137() throws Exception
	{
		...
		sa.selectClientTest137(driver);
		s1.addTestCase137(driver, sData4,sData5, sData6,sData7, sData8,sData9,sData10,sData11,sData12);
		test.log(LogStatus.PASS, "Mtr test case 137 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}
	/*@Test(priority=2)
	public void funcSubmissionTestCase137() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case 137 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}*/
	@Test (priority=1)
	public void funcDelTestCase137() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		s1.clickClientLst(driver);
		sa.selectClientTest137(driver);
		s1.funcDelMTRTest137(driver);
		test.log(LogStatus.PASS, "Mtr test case 137 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}
