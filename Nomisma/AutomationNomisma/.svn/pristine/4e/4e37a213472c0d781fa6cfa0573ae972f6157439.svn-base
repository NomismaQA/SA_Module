...
public class VerifyInformationPageValueswithCTComputationTest2 extends BaseLib {
	...
	public void VerifyInformationPage() throws InterruptedException {
		...
		test = report.startTest("Test execution started to VerifyInformation Page2");
		sTestCaseID="VerifyInformationPageValueswithCTComputationTest2";
		...
		ct.VerifyInformationPageValues1(driver,sData[5], sData[6], sData[7], sData[8], sData[9]);
