...
public class DelCharitableGiving extends BaseLib {
	...
	public void funcDelcharitableTax() throws Exception
	{
		...
		s1.delCharitableGiving(driver);
		test.log(LogStatus.PASS, "Charitable Giving Income deleted successfully");
