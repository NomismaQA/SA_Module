...
public class DelBankInterest extends BaseLib {
	...
	public void delFunc() throws Exception
	{
		...
		s1.clickDivident(driver);
		
		s1.delBankInterest(driver);
		
		s1.deleteDivident(driver);
		test.log(LogStatus.PASS, "Bank Interest for forgign Income deleted successfully");
