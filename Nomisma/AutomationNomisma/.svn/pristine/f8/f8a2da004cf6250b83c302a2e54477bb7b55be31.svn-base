...
public class MTRTestScenario50 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase50";
	...
	public void funcTestCase50() throws Exception
	{
		...
		sa.selectClientTest50(driver);
		s1.addTestCase50(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14);
		test.log(LogStatus.PASS, "Mtr test case50 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	/*@Test (priority=2,retryAnalyzer = RetryAnalyzer.class)
	public void funcSubmitToHmrcCase50() throws Exception
	{
	...
	test.log(LogStatus.PASS, "Mtr test case50 -> Tax Submission successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();		
	}*/
	@Test (priority=3)//,retryAnalyzer = RetryAnalyzer.class)
	public void funcDelTestCase50() throws Exception
	{
	...
	s1.clickClientLst(driver);
	sa.selectClientTest50(driver);
	s1.delTestCase50(driver);
	test.log(LogStatus.PASS, "Mtr test case50 -> deleted successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();	
	}
