...
public class EmailTemplateCls extends BaseLib {
	...
	public void verifyFunctionEmailTemplate() throws Exception
	{
		...
		s1.emailTemplateFunc(driver);
		test.log(LogStatus.PASS, "Email Tempalate added successfully");
