...
public class MTRTestScenario17 extends BaseLib {
	...
	public void funcTestCase17() throws Exception
	{		
		...
		s1.addTestCase17(driver, sData4,sData5, sData6,sData7, sData8,sData9,sData10,sData11,sData12,sData13, sData14,sData15,sData16);
		test.log(LogStatus.PASS, "Mtr test case for 2017 -2018 -> 17 -> added successfully");
