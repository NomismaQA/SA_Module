...
public class SubmitRTITest extends BaseLib{

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(retryAnalyzer = RetryAnalyzer.class)
	public void runPayrollTest() throws InterruptedException, NoSuchElementException
	{
		
		test = report.startTest("Submit RTI execution starts");

		/*
		 * Local Variables
		 */
		
		String testCaseId = "SubmitRTI";
		...
		PayrollPage3 pp1= new PayrollPage3(driver);
		pp1.submitRTI(driver, sData4);
		report.endTest(test);
		report.flush();
