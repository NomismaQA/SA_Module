...
public class IncomeFromPropertyProfit extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="IncomFromPropertyFHLprofit";
	...
	public void func1() throws Exception
	{
		...
		s1.profitIncomeFrmProprtyFHL(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14);
		test.log(LogStatus.PASS, "Test case for Income From Property Profit added successfully");
