...
public class SubmitCT600Test extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void SubmitCT600() throws InterruptedException {

		test = report.startTest("Test execution started to Submit CT600");
		sTestCaseID="SubmitCT600Test";
		...
		ct.SubmitCT600(driver,sData[5],sData[6]);
