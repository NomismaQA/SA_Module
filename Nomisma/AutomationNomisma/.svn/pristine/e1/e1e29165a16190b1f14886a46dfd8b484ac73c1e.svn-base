...
public class DelMarriageAllowance extends BaseLib {
	...
	public void functionDelMarriageAllowance() throws Exception
	{
		...
		s1.delMarriageAllowance(driver);
		test.log(LogStatus.PASS, "Marriage Allowance data deleted successfully");
