...
public class AddSupplierBillInExpenses extends BaseLib {

CommonUtilities commUtils=new CommonUtilities();
String sTestCaseID="ExpensesDetails";
...
@Test (priority=1)
public void funcAddSupplierBill() throws Exception
{
...
bp1.openExpensesLink(driver);
bp1.addSupplier(driver,sData5, sData6, sData7, sData8);
test.log(LogStatus.PASS, "Supplier Bill Added successfully");
