...
public class MTRTestScenario173 extends BaseLib {
	...
	public void funcAddTestCase173() throws Exception
	{
		...
		s1.addTestCase173(driver, sData4,sData5, sData6,sData7, sData8,sData9,sData10,sData11);
		test.log(LogStatus.PASS, "Mtr test case 173 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}
	/*@Test(priority=2)
	public void funcSubmissionTestCase173() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case 173 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}*/
	...
	public void funcDelTestCase173() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case 173 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}
