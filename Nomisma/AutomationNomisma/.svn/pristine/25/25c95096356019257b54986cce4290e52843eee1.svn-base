...
public class ExpenseDebitNoteCls extends BaseLib {
	...
	@Test (priority=1)
	public void funcExpenseDebitNote() throws Exception
	{
	...
	bp1.addDebitNote(driver,sData5, sData6, sData7, sData8);
	test.log(LogStatus.PASS, "Debit Note added Successfully");
