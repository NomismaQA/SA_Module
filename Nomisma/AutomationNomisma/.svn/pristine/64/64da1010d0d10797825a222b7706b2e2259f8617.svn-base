...
public class AddQuotationCls extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="AddNewQuote";
	...
	@Test (priority=1)
	public void funcAddQuotation() throws Exception
	{
	...
	bp1.funcAddQuote(driver, sData5, sData6, sData7, sData8, sData9);
	test.log(LogStatus.PASS, "Quotation added successfully");
