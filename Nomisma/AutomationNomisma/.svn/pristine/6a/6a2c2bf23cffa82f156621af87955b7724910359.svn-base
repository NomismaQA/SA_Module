...
public class DelCapitalGain extends BaseLib {
	...
	public void funDelCapitalGain() throws Exception
	{
		...
		s1.delCGI(driver);
		test.log(LogStatus.PASS, "Capital Gain Income deleted successfully");
