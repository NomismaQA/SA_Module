...
public class DelForeignukIncomeScenario extends BaseLib {
	...
	public void funcDel() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Foreign UK Income deleted successfully");
