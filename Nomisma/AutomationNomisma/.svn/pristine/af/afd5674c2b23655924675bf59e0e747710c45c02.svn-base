...
public class PdfVeriFyCharitableGiving extends BaseLib {
	...
	public void funcVerifyPdf() throws Exception
	{
		...
		pdf.checkPdfEntryCharitableGiving(driver,sData6,Filename);
		test.log(LogStatus.PASS, "Test case for Pdf Verification for 'Self Assessment Forms' of Charitable giving payment added successfully");
