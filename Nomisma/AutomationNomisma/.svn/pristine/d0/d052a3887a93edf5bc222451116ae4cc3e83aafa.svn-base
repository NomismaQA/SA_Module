...
public class VerifySubmissionReportPageTest extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VerifySubmissionReportPage() throws InterruptedException {

		test = report.startTest("Test execution started to verify submitted XML Page");
		sTestCaseID="VerifySubmittedXMLPageTest";
		...
		ct.SubmissionReport(driver,sData[6]);
