...
public class SubContractorPayDetailsReport extends BaseLib {

	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void SubContractorPayDetails() throws InterruptedException, EmptyFileException, IOException{
				
		test = report.startTest("Test execution started to verify SubContractor Pay Details Report");

		/*
		 * Local Variables
		 */
		
		String testCaseId = "SubContractorPayDetails";
		...
		cis.SubContractorPayDetails(driver);
