...
public class MTRTest24SubmissionToHMRC extends BaseLib {
	...
	public void funcSubmitToHmrcCase24() throws Exception
	{		
		test = report.startTest("Login to self Assessment");
		sTestCaseID="TestCase24";
		...
		test.log(LogStatus.PASS, "Mtr test case for 2017 -2018 -> 24 -> Tax Submission successfully");
