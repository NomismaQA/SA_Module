...
import org.testng.Reporter;
	public class MTRTestScenario47 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase47";
	...
	@Test (priority=2)
 	public void funcTestCase47() throws Exception
	{	
		...
		sa.selectClientTest47(driver);
		s1.addTestCase47(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20);
		test.log(LogStatus.PASS, "Mtr test case47 -> added successfully");
	...
	public void funcSubmitToHmrcCase47() throws Exception
	{
	...
	test.log(LogStatus.PASS, "Mtr test case47 -> Tax Submission successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();		
	}*/
	@Test (priority=1)//,retryAnalyzer = RetryAnalyzer.class)
	public void funcDelTestCase47() throws Exception
	{
	...
	s1.clickClientLst(driver);
	sa.selectClientTest47(driver);
	s1.funcDelMTRTest47(driver);
	test.log(LogStatus.PASS, "Mtr test case47 -> deleted successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();	
	}
