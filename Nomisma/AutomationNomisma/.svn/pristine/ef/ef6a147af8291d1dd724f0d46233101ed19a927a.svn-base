...
//Test case to Send Email
public class ScheduledEmailTestCase extends BaseLib {
	...
	public void funcScheduledEmailCheck() throws Exception
	{
		...
		s1.scheduledEmail(driver);
		s1.delundoManualSubmitBtn(driver);
		s1.clickIncome(driver);
		s1.clickEmployment(driver);
		s1.delEmpInfo(driver);
		test.log(LogStatus.PASS, "Test Case for Scheduled Email Checked Successfully");
