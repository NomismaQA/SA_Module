...
public class AutoEnrolmentEditEmployeeTest extends BaseLib{
	...
	public void VerifyAutoEnrolmentTab() throws InterruptedException
	{
		...
		ae.VerifyAutoEnrolmentTab(driver,sData[5],sData[6],sData[7],sData[8],sData[9],sData[10],sData[11],sData[12]);
