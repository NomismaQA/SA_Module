...
public class AddPaymentOnAccount extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="PaymentsAccount";
	...
	public void funcAddPayment() throws Exception
	{
		...
		s1.addPaymentOnAccount(driver,sData8,sData9,sData10);
		test.log(LogStatus.PASS, "Test case for Payment on Account for 2017-2018 added successfully");
