...
public class DelOtherUKIncome extends BaseLib {
	...
	public void delOtherUKIncomefunc() throws Exception
	{
		...
		s1.delOtherUKIncome(driver);
		
		s1.delBank(driver);
		
		s1.deleteDivident(driver);
		
		s1.delOtherDivident(driver);
		
		s1.clickEmployment(driver);
		
		s1.delEmpInfo(driver);
		test.log(LogStatus.PASS, "Other UK Income deleted successfully");
