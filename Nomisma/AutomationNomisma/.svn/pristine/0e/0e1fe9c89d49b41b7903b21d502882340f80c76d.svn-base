...
public class VerifySA802PTRFull extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "SA802_PartnershipFull";
	...
	@Test (priority=1)
	public void funcVerifySA802PTRFull() throws Exception
	{
	...
	abp.funcSA802_PartnershipForeignPage(driver, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27, sData28);
	abp.ptrSubmitToHMRC(driver);
	abp.checkXMLPTRSa802(driver);
