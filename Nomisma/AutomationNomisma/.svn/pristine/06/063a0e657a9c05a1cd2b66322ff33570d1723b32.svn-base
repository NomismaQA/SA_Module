...
public class readpdfreportforeignIncome extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="pdfVrfyForgnIncm";
	...
	public void readDoc1() throws Exception
	{
		...
		pdf.readDivident2PDF4InURL(driver,sData6,Filename,sData10,sData11,sData12,sData13,sData14,sData15,sData16,sData17);
		test.log(LogStatus.PASS, "Test case for Pdf Verification for Foreign Income added successfully");
