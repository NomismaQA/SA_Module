...
public class SA800BusinessInvestmentBusinessQues2 extends BaseLib {
	...
	@Test (priority=1)
	public void funcVerifyBusinessQues2SA800BusinsInvest() throws Exception
	{
	...
	abp.funcSA800_PartnershipBusinessAndInvestmentIncome_BusinessQuestionsQ2(driver);
	abp.funcSA800_PartnershipBusinessAndInvestmentIncome_BusinessQuestionsQ2(driver,sData6); 
	abp.funcSA802Del(driver);
