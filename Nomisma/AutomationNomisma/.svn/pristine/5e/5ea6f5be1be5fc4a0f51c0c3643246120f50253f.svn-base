...
public class MTRTestScenario44 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase44";
	...
	public void funcTestCase44() throws Exception
	{	
		...
		sa.selectClientTest44(driver);
		s1.addTestCase44(driver,sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14,sData15,sData16,sData17,sData18,sData19,sData20,sData21,sData22,sData23,sData24);
		test.log(LogStatus.PASS, "Mtr test case44 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	/*@Test (priority=3)//,retryAnalyzer = RetryAnalyzer.class)
	public void funcSubmitToHmrcCase44() throws Exception
	{
	...
	test.log(LogStatus.PASS, "Mtr test case44 -> Tax Submission successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();		
	}*/
	@Test (priority=1)
	public void funcDelTestCase44() throws Exception
	{
	...
	s1.clickClientLst(driver);
	sa.selectClientTest44(driver);
	s1.funcDelMTRTest44(driver);
	test.log(LogStatus.PASS, "Mtr test case44 -> deleted successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();	
	}
