...
public class AddAdditionalInfoCls extends BaseLib {
	...
	@Test (priority=1)
	public void funcAddAdditionalInfo() throws Exception
	{
	...
	adp.searchAgent(sData3, driver);
		...
		s1.funcAddEmployerForMTR(driver,sData4, sData5);
		
		s1.funcAddAdditionalInfo(driver,sData8,sData9,sData10,sData11,sData12,sData13,sData14,sData15,sData16,sData17,sData18,sData19,sData20,sData21,sData22,sData23,sData24,sData25,sData26,sData27,sData28,sData29,sData30,sData31,sData32,sData33,sData34);
		test.log(LogStatus.PASS, "Additional Information Income added successfully");
