...
public class ForeignIncomeOverseasWithoutTaxCls extends BaseLib {
	...
	public void funcForeignIncomeOverseas1() throws Exception
	{
		...
		s1.checkForeignIncomeOverseasSavingWithoutTaxRelief(driver,sData4,sData5,sData6,sData7);
		test.log(LogStatus.PASS, "Test case for Foreign Income Overseas Without Tax added successfully");
