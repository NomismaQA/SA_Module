...
public class P32ReportTest extends BaseLib {
		...
		public void p32Report() throws InterruptedException, NoSuchElementException
		{
			test = report.startTest("p32 Report Test execution starts");
			sTestCaseID="P32";
