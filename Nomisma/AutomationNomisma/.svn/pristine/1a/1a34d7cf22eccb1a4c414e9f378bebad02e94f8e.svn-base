...
public class ChildBenefitChargeCls extends BaseLib{
	
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="ChildBenefit2";
	...
	public void funcChildBenefitBelowMinAmt() throws Exception
	{
		...
		sp1.addChildBenefitCharge(driver, sData8,sData9,sData10,sData11);
		test.log(LogStatus.PASS, "Test case for Child Benefit Below Minimum Amount for 2017-2018 added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}			
	@Test// (priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void funcChildBenefitAboveMaxAmt() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		...
		sp1.addChildBenefitCharge(driver, sData8,sData9,sData10,sData11);
		test.log(LogStatus.PASS, "Test case for Child Benefit Above Maximum Amount for 2017-2018 added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}
	...
	@Test// (priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void funcChildBenefitAboveMinAmt() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		...
		sp1.addChildBenefitCharge(driver, sData8,sData9,sData10,sData11);
		test.log(LogStatus.PASS, "Test case for Child Benefit Above Minimum Amount for 2017-2018 added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}			
