...
public class SA800SummaryOfBalanceSheet extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "SA800_SummaryOfBalanceSheet";
	...
	@Test (priority=1)
	public void funcSA800SummaryOfBalanceSheet() throws Exception
	{
	...
	abp.funcSA800SummaryOfBalanceSheet(driver,sData6, sData7,sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19);
	abp.funcSA800BusinessAndInvestmentIncomeDel(driver);
	test.log(LogStatus.PASS, "Boxes of SA800 -> Summary of balance sheet verified Successfully");
