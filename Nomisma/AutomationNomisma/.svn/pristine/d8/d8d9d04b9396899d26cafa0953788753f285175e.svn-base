...
public class MTRTestScenario60 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase60";
	...
	@Test (priority=1)
	public void funcTestCase60() throws Exception
	{
	...
	sa.selectClientTest60(driver);
	s1.addTestCase60(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11);
	test.log(LogStatus.PASS, "Test case 60 data added Successfully");
	Reporter.log("Test execution of tax verification done successfully", true);
	report.endTest(test);
	report.flush();
	}
	/*@Test(priority=2)
	public void funcSubmissionTestCase60() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Test case 60 Submission to HMRC completed Successfully");
		Reporter.log("Test execution of Submission to HMRC and XML file verification done successfully", true);
		report.endTest(test);
		report.flush();
		}*/
	@Test (priority=3)
	public void funcDelTestCase60() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		HashMap<String, String> testDataMap = commUtils.getKeyValueFromJson(testDataFile, sTestCaseID);
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		...
		s1.clickClientLst(driver);
		sa.selectClientTest60(driver);
		s1.delTestCase60(driver);
		test.log(LogStatus.PASS, "Test case 60 Data deletion completed Successfully");
