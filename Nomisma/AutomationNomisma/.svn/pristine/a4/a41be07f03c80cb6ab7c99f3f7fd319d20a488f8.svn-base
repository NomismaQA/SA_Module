...
public class CISVerificationCertificate extends BaseLib {

	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void CISVerificationCert() throws InterruptedException, EmptyFileException, IOException{
				
		test = report.startTest("Test execution started for CIS Verification Certificate");

		/*
		 * Local Variables
		 */
		
		String testCaseId = "CISVerificationCert";
		...
		cis.CISVerificationCert(driver);
