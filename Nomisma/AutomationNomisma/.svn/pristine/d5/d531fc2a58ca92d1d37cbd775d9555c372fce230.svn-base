...
public class VerifySalesFRS1021A_TrialBalance_Test1 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VerifySalesFRS102_TrialBalance() throws InterruptedException {

		test = report.startTest("Test execution started to Verify Sales in FRS102 1A and TrialBalance Test");
		...
		As.VerifySalesFRS102_TrialBalance(driver, sData[5], sData[7], sData[8], sData[9]);
