...
public class VerifySummaryOfBalanceSheetAuto extends BaseLib {
	...
	@Test (priority=1)
	public void funcVerifySummaryOfBalanceSheetAuto() throws Exception
	{
	...
	test.log(LogStatus.PASS, "Summary of Balance Sheet is verified Successfully");
