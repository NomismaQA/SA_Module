...
public class SA800TaxableProfitLossBoxes extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "TaxableProfitLossSA800";
	...
	abp.funcSA800_Boxes_profit(driver,sData6, sData7);
	abp.funcSA800BusinessAndInvestmentIncomeDel(driver);
	abp.funcSA800TradingProfessionalIncomeDel(driver);
	abp.funcSA800_Boxes_loss(driver,sData6);
	abp.funcSA800TradingProfessionalIncomeDel(driver);
	abp.funcCheckBox24(driver,sData6);
	abp.funcSA800BusinessAndInvestmentIncomeDel(driver);
	test.log(LogStatus.PASS, "Boxes of business and investment income of SA800 verified Successfully");
