...
public class Verify3_51TextBox extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "Data3.51Auto";
	...
	@Test (priority=1)
	public void funcVerify3_51BoxPTRFull() throws Exception
	{
	...
	abp.Verify3_51PTRFull(driver,sData6, sData7, sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23, sData24, sData25, sData26, sData27, sData28, sData29, sData30, sData31, sData32, sData33);
	abp.funcDelAutoPartnership(driver);
	test.log(LogStatus.PASS, "Box 3.51 of PTR Full verified Successfully");
