...
public class TaxReliefsPensionSchemes extends BaseLib{
	
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="addEmpIncome7";
	...
	public void funcAddPension() throws Exception
	{
	...
	sp1.clickIncome(driver);
		...
		sp1.addPensionTaxRelief(driver, sData11, sData12,sData13, sData14);
		test.log(LogStatus.PASS, "Test case for Tax Reliefs for Pension Schemes added successfully");
