...
public class MTRTestScenario1 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase1";
	...
	/*@Test(priority=2)
	public void funcAddTestCase1() throws Exception
	{
		...
		sa.selectClientTest1(driver);
		s1.addTestCase1(driver, sData4,sData5, sData6,sData7, sData8,sData9,sData10,sData11);
	...
	@Test(priority=3)
	public void funcSubmissionTestCase1() throws Exception
	{
		...
		s1.clickClientLst(driver);
		sa.selectClientTest1(driver);
		//s1.manualSubmissionToHMRC(driver);
		s1.CheckXMLGenericTags(driver);
		test.log(LogStatus.PASS, "Mtr test case1 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}
	/*@Test (priority=1)
	public void funcDelTestCase1() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		s1.clickClientLst(driver);
		sa.selectClientTest1(driver);
		s1.funcDelTest1(driver);
		test.log(LogStatus.PASS, "Mtr test case1 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
	}*/
