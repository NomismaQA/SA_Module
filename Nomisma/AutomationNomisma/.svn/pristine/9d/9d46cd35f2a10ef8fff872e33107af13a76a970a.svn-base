...
public class EEALossIncome extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="PropertyIncomeExpensesESLS";
	...
	public void funEAALoss() throws Exception
	{
		...
		Thread.sleep(2000);
		s1.incomLossFHLinEEA(driver,sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13);
		test.log(LogStatus.PASS, "EEA Loss Income added successfully");
