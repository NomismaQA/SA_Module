...
public class MTRTestScenario38 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase38";
	...
	public void funcTestCase38() throws Exception
	{	
		...
		sa.selectClientTest38(driver);
		s1.addTestCase38(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14,sData15,sData16,sData17,sData18,sData19,sData20,sData21,sData22,sData23,sData24,sData25,sData26);
		test.log(LogStatus.PASS, "Mtr test case38 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
/*@Test (priority=2)//,retryAnalyzer = RetryAnalyzer.class)
public void funcSubmitToHmrcCase38() throws Exception
{
	...
	test.log(LogStatus.PASS, "Mtr test case38 -> Tax Submission successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();		
	}*/
	@Test (priority=1)
	public void funcDelTestCase38() throws Exception
	{
	...
	s1.clickClientLst(driver);
	sa.selectClientTest38(driver);
	s1.funcDelMTRTest38(driver);
	test.log(LogStatus.PASS, "Mtr test case48 -> deleted successfully");
	Reporter.log("Test execution completed successfully", true);
	report.endTest(test);
	report.flush();	
	}
