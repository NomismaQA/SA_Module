...
public class DelSupplierBillInExpenses extends BaseLib {
	...
	public void funcDelSupplierBill() throws Exception
	{
	...
	test.log(LogStatus.PASS, "Supplier details deleted successfully");
