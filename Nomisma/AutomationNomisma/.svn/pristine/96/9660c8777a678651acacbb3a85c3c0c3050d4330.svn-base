...
public class MTRTestScenario169 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase169";
	...
	@Test (priority=2)
	public void funcTestCase169() throws Exception
	{
	...
	sa.selectClientTest169(driver);
	s1.addTestCase169(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14,sData15,sData16,sData17,sData18,sData19,sData20,sData21,sData22,sData23,sData24,sData25,sData26,sData27,sData28);
	test.log(LogStatus.PASS, "Test case 169 data added Successfully");
	Reporter.log("Test execution of tax verification done successfully", true);
	report.endTest(test);
	report.flush();
	}
	/*@Test(priority=3)
	public void funcSubmissionTestCase169() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Test case 169 Submission to HMRC completed Successfully");
		Reporter.log("Test execution of Submission to HMRC and XML file verification done successfully", true);
		report.endTest(test);
		report.flush();
		}*/
	@Test (priority=1)
	public void funcDelTestCase169() throws Exception
	{
		test = report.startTest("Login to self Assessment");
		HashMap<String, String> testDataMap = commUtils.getKeyValueFromJson(testDataFile, sTestCaseID);
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		...
		s1.clickClientLst(driver);
		sa.selectClientTest169(driver);
		s1.funcDelMTRTest169(driver);
		test.log(LogStatus.PASS, "Test case 169 Data deletion completed Successfully");
