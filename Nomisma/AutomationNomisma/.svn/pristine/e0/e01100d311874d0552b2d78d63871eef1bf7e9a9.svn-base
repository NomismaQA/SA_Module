...
public class CreateSoleTraderBusiness extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="addNewSoleTraderBusiness";
	String testDataFile = ".\\testData\\Json\\AddBusinessModule.json";
	String sData1, sData2, sData3, sData4, sData5, sData6, sData7;
	@Test (priority=1)
	public void funcCreateSoleTraderBusiness() throws Exception
	{
	...
	abp.addSoletraderBusiness(driver,sData4,sData5, sData6, sData7);
	test.log(LogStatus.PASS, "New Sole Trader Business Created Successfully");
