...
public class MTRTestScenario22 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase22";
	...
	public void funcAddTestCase22() throws Exception
	{		
		...
		sa.selectClientTest22(driver);
		s1.addTestCase22(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14);
		test.log(LogStatus.PASS, "Mtr test case22 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();			
	}
	/*@Test (priority=3)
	public void funcSubmitToHmrcTestCase22() throws Exception
	{		
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		test.log(LogStatus.PASS, "Mtr test case22 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
		}*/
	...
	@Test (priority=1)
	public void funcDelTestCase22() throws Exception
	{
		...
		s1.clickClientLst(driver);
		sa.selectClientTest22(driver);
		s1.funcDelMTRTest22(driver);
		test.log(LogStatus.PASS, "Mtr test case22 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}
