...
public class EmployeePayDetailsReportTest extends BaseLib {
		
		@Test //(retryAnalyzer = RetryAnalyzer.class) 
		public void empPayDetailsReport() throws InterruptedException, NoSuchElementException
		{
			
			test = report.startTest("empPayDetailsReport Test execution starts");

			/*
			 * Local Variables
			 */
			
			String testCaseId = "Employee_Pay Details";
			...
			pr.EmployeePayDetails(driver, sData5, sData6);
