...
public class TotalCompaniesCountCheck extends BaseLib {
	
	@Test //(retryAnalyzer = RetryAnalyzer.class)
	public void CountTest() throws InterruptedException
	{
		test = report.startTest("Total Companies Count Test execution starts");
		...
		pp2.CountCheckTotalCompanies(driver,curUrl);
		Reporter.log("Total Companies Count verified successfully", true);
