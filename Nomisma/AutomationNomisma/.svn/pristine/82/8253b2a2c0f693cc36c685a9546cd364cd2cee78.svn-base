...
public class ReadpdfreportSEFull extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="pdfVrfySelfEmpFull";
	...
	public void readDoc1() throws Exception
	{
		...
		pdf.readPDF1SEFull(driver,sData6,Filename);
		Thread.sleep(1000);
		pdf.savePdf2(driver);
		...
		pdf.readPDF2SEFull(driver,sData6,Filename);
		
		pdf.savePdf3(driver);
		Filename=pdf.GetFileName1(sData4,sData8);
		Reporter.log("File" + Filename, true);
		
		pdf.readPDF3SEFull(driver,sData6,Filename);
		Thread.sleep(10000);
		/*pdf.savePdf4(driver);
		Filename=pdf.GetFileName1(sData4,sData9);
		Reporter.log("File" + Filename, true);
		pdf.readPDF4SEFull(driver,sData6,Filename,sData10);*/
		test.log(LogStatus.PASS, "Test case for Pdf Verification for Self employment full Income added successfully");
