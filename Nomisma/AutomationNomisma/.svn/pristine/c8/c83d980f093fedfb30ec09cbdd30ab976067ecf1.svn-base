...
public class PdfVeriFyCapitalGain extends BaseLib {
	...
	public void funcVerifyPdf() throws Exception
	{
		...
		pdf.readPDFCapitalGain(driver,sData6,Filename);
		test.log(LogStatus.PASS, "Test case for Pdf Verification for 'Self Assessment Forms' of Capital Gain added successfully");
