...
public class AutoPayrollCountCheck extends BaseLib {

	@Test //(retryAnalyzer = RetryAnalyzer.class)
	public void CountTest() throws InterruptedException, NoSuchElementException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		test = report.startTest("Auto Payroll Count Test execution starts");
		...
		pp2.CountCheckAutoPayroll(driver,curUrl);
		Reporter.log("Auto Payroll Count verified successfully", true);
