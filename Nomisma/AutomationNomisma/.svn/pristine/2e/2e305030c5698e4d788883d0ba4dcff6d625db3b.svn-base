...
public class MTRTestScenario178 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase178";
	...
	public void funcAddTestCase178() throws Exception
	{		
		...
		sa.selectClientTest178(driver);
		s1.addTestCase178(driver, sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14,sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22);
		test.log(LogStatus.PASS, "Mtr test case 178 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();			
	}
	/*@Test (priority=2)
	public void funcSubmitToHmrcTestCase178() throws Exception
	{		
		test = report.startTest("Login to self Assessment");
		sData1 = testDataMap.get("sData1").replaceAll("\"", "");
		sData2 = testDataMap.get("sData2").replaceAll("\"", "");
		...
		test.log(LogStatus.PASS, "Mtr test case 178 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
		}*/
	@Test (priority=3)
	public void funcDelTestCase178() throws Exception
	{
		...
		s1.clickClientLst(driver);
		sa.selectClientTest178(driver);
		s1.funcDelMTRTest178(driver);
		test.log(LogStatus.PASS, "Mtr test case 178 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}
