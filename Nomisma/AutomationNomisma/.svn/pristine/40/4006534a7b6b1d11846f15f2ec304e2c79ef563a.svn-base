...
public class ImportClientCls extends BaseLib {
	...
	public void functToImportClient() throws Exception
	{
		...
		s1.uploadClient(driver);
		test.log(LogStatus.PASS, "Import client feature checked successfully");
