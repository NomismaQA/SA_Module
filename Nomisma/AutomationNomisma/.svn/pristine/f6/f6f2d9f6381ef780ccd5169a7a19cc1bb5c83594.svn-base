...
public class MTRTestScenario14 extends BaseLib {
	...
	@Test (priority=2)
	public void funcAddTestCase14() throws Exception
	{
		...
		s1.addTestCase14(driver, sData4, sData5, sData6, sData7, sData8, sData9,sData10);
		test.log(LogStatus.PASS, "Mtr test case14 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}
	/*@Test (priority=2)
	public void funcSubmitToHmrcCase14() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case14 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}*/
	@Test (priority=1)
	public void funcDelTestCase14() throws Exception
	{
		...
		s1.clickClientLst(driver);
		sa.selectClientTest14(driver);
		s1.funcDelMTRTest14(driver);
		test.log(LogStatus.PASS, "Mtr test case14 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}
