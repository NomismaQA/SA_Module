...
public class CheckingBoxesPTRshortAuto extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "DataPTRShortAuto";
	...
	@Test (priority=1)
	public void funcVerifyBoxesPTRShort() throws Exception
	{
	...
	abp.addTurnoverIncomeForPTRShort(driver,sData6, sData7,sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15);
