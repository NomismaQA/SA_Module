...
public class DelVATOnlyInvoice extends BaseLib {
	...
	@Test (priority=1)
	public void funcDelVATOnlyInvoice() throws Exception
	{
	...
	test.log(LogStatus.PASS, "VAT only Invoice Deleted Successfully");
