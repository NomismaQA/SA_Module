...
public class VerifyTaxCalculationPageTest extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VerifyTaxCalculation() throws InterruptedException {

		test = report.startTest("Test execution started to Verify Tax Calculation Page");
		sTestCaseID="VerifyTaxCalculationPageTest";
		...
		ct.VerifyTaxCalculation(driver,sData[5], sData[6], sData[7]);
