...
public class VerifyLossesfromPLReport extends BaseLib {
	...
	public void VerifyProfitsfromPL() throws InterruptedException {
		...
		test = report.startTest("Test execution started to Verify Losses from P/L Report");
		sTestCaseID="VerifyLossesfromPLReport";
		...
		ct.VerifyLossesfromPL(driver,sData[5],sData[6],sData[7]);
