...
public class AddSupplierThroughExpenseTabCls extends BaseLib {
	...
	String sData1, sData2, sData3, sData4, sData5;
	@Test (priority=1)
	...
	bp1.addSupplierThroughExpense(driver,sData5);
	test.log(LogStatus.PASS, "Through Expense tab Supplier added Successfully");
