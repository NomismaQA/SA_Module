...
public class Verify3_48TextBox extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID = "Data3.48Auto";
	...
	@Test (priority=1)
	public void funcVerify3_48BoxPTRFull() throws Exception
	{
	...
	abp.Verify3_48PTRFull(driver,sData6, sData7,sData8, sData9, sData10, sData11, sData12, sData13, sData14, sData15, sData16, sData17, sData18, sData19, sData20, sData21, sData22, sData23);
	abp.funcDelAutoPartnership(driver);
	test.log(LogStatus.PASS, "Box 3.48 of PTR Full verified Successfully");
