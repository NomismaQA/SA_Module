...
public class MTRTestScenario242 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase242";
	...
	@Test (priority=2)
	public void funcAddTestCase242() throws Exception
	{		
		...
		sa.selectClientTest242(driver);
		s1.addTestCase242(driver, sData4, sData5, sData6, sData7, sData8, sData9, sData10, sData11, sData12);
		test.log(LogStatus.PASS, "Mtr test case 242 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	@Test (priority=1)
		public void funcDelTestCase242() throws Exception
		{		
			test = report.startTest("Login to self Assessment");
			sData1 = testDataMap.get("sData1").replaceAll("\"", "");
			sData2 = testDataMap.get("sData2").replaceAll("\"", "");
