...
public class MTRTestScenario4 extends BaseLib {
	...
	public void funcTestCase4() throws Exception
	{
		...
		s1.addTestCase4(driver, sData4,sData5, sData6,sData7, sData8,sData9);
		test.log(LogStatus.PASS, "Mtr test case for 2017 -2018 -> 4 -> added successfully");
