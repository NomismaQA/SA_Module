...
//Verify Dashboard of SA
public class VerifySADashboard extends BaseLib {
	...
	public void verifyWorkStatus() throws Exception
	{
		...
		s1.findTextOnPage(driver);
		test.log(LogStatus.PASS, "Test Case for Sa dashboard Verified Successfully");
