...
public class AddOtherUKIncome extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="AddOtherUKIncome";
	...
	public void addOtherUkIncomeFunc() throws Exception
	{
		...
		s1.addUKInterest(driver, sData30, sData4, sData31,sData32);
		
		s1.dividentUKCompanies(driver, sData7, sData8, sData9);
		
		s1.stateBenefit(driver, sData22, sData23, sData24, sData25, sData26);
		
		s1.addOtherUKIncome(driver, sData17, sData18, sData19, sData20, sData21);
		
		s1.addOtherDivident(driver, sData27, sData28, sData29);
		
		s1.verifyOthertax(driver,sData14, sData15, sData16, sData32, sData28, sData9, sData27, sData22, sData24, sData25, sData26, sData19, sData23,sData17,sData18,sData20,sData29);
		test.log(LogStatus.PASS, "Test case for Other UK Income for 2017-2018 added successfully");
