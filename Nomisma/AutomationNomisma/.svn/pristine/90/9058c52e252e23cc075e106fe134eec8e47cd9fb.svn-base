...
public class DelSelfEmpShort extends BaseLib {
	...
	public void delSelfEmp() throws Exception
	{
		...
		s1.delSEshort(driver);
		test.log(LogStatus.PASS, "Self Employment Short Income deleted successfully");
