...
public class MTRTestScenario10 extends BaseLib {
	...
	@Test (priority=2)
	public void funcAddTestCase10() throws Exception
	{
		...
		s1.addTestCase10(driver, sData4, sData5, sData6, sData7, sData8, sData9, sData10, sData11);
		test.log(LogStatus.PASS, "Mtr test case10 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();			
	}
	/*@Test (priority=3)
	public void funcSubmissionTestCase10() throws Exception
	{
		test = report.startTest("Login to Self Assessment Module");
		...
		test.log(LogStatus.PASS, "Mtr test case10 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}*/
	@Test (priority=1)
	public void funcDelTestCase10() throws Exception
	{
		test = report.startTest("Login to Self Assessment Module");
		...
		s1.clickClientLst(driver);
		sa.selectClientTest10(driver);
		s1.funcDelMTRTest10(driver);
		test.log(LogStatus.PASS, "Mtr test case10 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();	
		}
