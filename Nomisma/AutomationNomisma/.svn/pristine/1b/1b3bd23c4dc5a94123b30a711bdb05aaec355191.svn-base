...
public class VerifyCustomerBalanceTest1 extends BaseLib {

	String sTestCaseID=null;
	String[] sData=null;
	
	@Test //(priority=1,retryAnalyzer = RetryAnalyzer.class)
	public void VerifyCustomerBalance() throws InterruptedException {

		test = report.startTest("Test execution started to Verify CustomerBalanceTest1 Report Test");
		sTestCaseID="VerifyCustomerBalanceTest1";
		...
		ct.VerifyCustomerBalance(driver, sData[5], sData[6], sData[7], sData[8], sData[9], sData[10]);
