...
public class PdfVeriFyStudentLoan extends BaseLib {
	...
	public void funcVerifyPdf() throws Exception
	{
		...
		pdf.checkPdfEntryStudentLoan(driver,sData6,Filename);
		test.log(LogStatus.PASS, "Test case for Pdf Verification for Student Loan amount added successfully");
