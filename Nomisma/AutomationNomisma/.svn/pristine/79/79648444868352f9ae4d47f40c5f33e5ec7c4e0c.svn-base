...
public class SendEmailTestCase extends BaseLib {
	...
	public void funcSendEmailCheck() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Send Email feature checked successfully");
