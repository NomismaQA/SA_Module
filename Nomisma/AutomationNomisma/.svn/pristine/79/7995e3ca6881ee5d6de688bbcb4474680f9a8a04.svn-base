...
public class DelQuotationCls extends BaseLib {
	...
	@Test (priority=1)
	public void FuncDelAddQuotation() throws Exception
	{
	...
	bp1.delQuotation(driver);
	bp1.delCustomer(driver);
	test.log(LogStatus.PASS, "Quotation Deleted successfully");
