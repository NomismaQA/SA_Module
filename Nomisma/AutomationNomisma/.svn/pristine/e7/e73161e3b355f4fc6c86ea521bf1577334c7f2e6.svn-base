...
public class MTRTestScenario28 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="TestCase28";
	...
	@Test(priority=2)
	public void funcAddTestCase28() throws Exception
	{		
		...
		sa.selectClientTest28(driver);
		s1.addTestCase28(driver, sData4,sData5, sData6,sData7, sData8,sData9,sData10,sData11,sData12,sData13, sData14,sData15, sData16,sData17,sData18,sData19);
		test.log(LogStatus.PASS, "Mtr test case28 -> added successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();		
	}
	/*@Test(priority=2)
	public void funcSubmissionTestCase28() throws Exception
	{
		...
		test.log(LogStatus.PASS, "Mtr test case28 -> Tax Submission successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();			
	}*/
	@Test(priority=1)
	public void funcDelTestCase28() throws Exception
	{
		...
		s1.clickClientLst(driver);
		sa.selectClientTest28(driver);
		s1.funcDelMTRTest28(driver);
		test.log(LogStatus.PASS, "Mtr test case28 -> deleted successfully");
		Reporter.log("Test execution completed successfully", true);
		report.endTest(test);
		report.flush();
		}
