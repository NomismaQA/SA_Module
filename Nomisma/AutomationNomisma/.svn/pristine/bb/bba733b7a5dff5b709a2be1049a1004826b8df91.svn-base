...
public class DelBatchInvoiceTestCase  extends BaseLib {
	...
	@Test (priority=1)
	public void funcDelBatchInvoice() throws Exception
	{
	...
	bp1.delBatchInvoice(driver);
	test.log(LogStatus.PASS, "Batch Invoice Deleted Successfully");
