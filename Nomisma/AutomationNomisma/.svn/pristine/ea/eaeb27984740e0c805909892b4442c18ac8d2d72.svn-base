...
public class SelfEmploymentShort1 extends BaseLib {
	CommonUtilities commUtils=new CommonUtilities();
	String sTestCaseID="SelEmplymentShort";
	...
	public void funcAddIncomeSEShort() throws Exception
	{
		...
		s1.selfEmplomentShort(driver,sData4,sData5,sData6,sData7,sData8,sData9,sData10,sData11,sData12,sData13,sData14,sData15,sData16,sData17,sData18,sData19,sData20,sData21,sData22,sData23,sData24,sData25);
		test.log(LogStatus.PASS, "Test case for Self Employment short added successfully");
