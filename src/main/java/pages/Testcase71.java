...
public class Testcase71 extends BasePage
{
	public Testcase71 (WebDriver driver)
	{
		super(driver);
	}
...
//		Assert.assertEquals(foreigncreditrelief,amtforcreditrelief) ;
		Notionaltaxamt=1770;
		amtfornotionaltax=1770;
		Assert.assertEquals(Notionaltaxamt,amtfornotionaltax) ;
		Reporter.log("Capital gain Tax Due verified successfully: " +amtfornotionaltax,true);

		taxFinal=1678.75;
		totalIncomeTaxDue=1678.75;
