...
public class Testcase201 extends BasePage
{
	public Testcase201 (WebDriver driver)
	{
		super(driver);
	}
...
private double Incometaxdue;
	...
	private double Notionaltaxamt;
	private double amtfornotionaltax;
...
//		amtReliefForFinanceCosts=190;
//dataReliefForFinanceCosts=190;
//Assert.assertEquals(dataReliefForFinanceCosts,amtReliefForFinanceCosts) ;//950.00
//		Reporter.log("Amount of Relief For Finance Costs is verified successfully"+dataReliefForFinanceCosts,true);
...
//		Notionaltaxamt=2000;
//		amtfornotionaltax=2000;
//		Assert.assertEquals(Notionaltaxamt,amtfornotionaltax) ;
//		Reporter.log("Notinal Tax verified successfully: " +amtfornotionaltax,true);

		taxFinal=42918.20;
		totalIncomeTaxDue=42918.20;
...
//		
//		 Reporter.log("SA105");
//		 Reporter.log("UKPropertyDetails");
//		Reporter.log("NumberOfProperties: 2");
//		Reporter.log("PropertyIncomeCeasedInYear: yes");
//		Reporter.log("IncomeFromPropertyLetJointly: yes");
//		Reporter.log("UKPropertyDetails");
//		Reporter.log("FurnishedHolidayLettings");
//		Reporter.log("FurnishedHolidayLettingsIncome: 10000.00");
//		Reporter.log("TraditionalAccounting: yes");
//		Reporter.log("FurnishedHolidayLettingsExpenses: 201.00");
//		Reporter.log("FurnishedHolidayLettingsInterestEtcCosts: 202.00");
//		Reporter.log("FurnishedHolidayLettingsManagementEtcFees: 203.00");
//		Reporter.log("FurnishedHolidayLettingsOtherExpenses: 204.00");
//		Reporter.log("PrivateUseAdjustment: 205.00");
//		Reporter.log("BalancingCharges: 206.00");
//		Reporter.log("ElectricChargePointAllowance: 207.00");
//		Reporter.log("CapitalAllowances: 208.00");
//		Reporter.log("AdjustedProfitForTheYear: 9186.00");
//		Reporter.log("LossesBroughtForward: 209.00");
//		Reporter.log("TaxableProfitForYear: 8977.00");
//		Reporter.log("LossToCarryForward: 210.00");
//		Reporter.log("PeriodOfGraceElection: yes");
//
//		Reporter.log("FurnishedHolidayLettings");
//		Reporter.log("FurnishedHolidayLettingsIncome: 15000.00");
//		Reporter.log("TraditionalAccounting: yes");
//		Reporter.log("FurnishedHolidayLettingsExpenses: 103.00");
//		Reporter.log("FurnishedHolidayLettingsInterestEtcCosts: 105.00");
//		Reporter.log("FurnishedHolidayLettingsManagementEtcFees: 105.00");
//		Reporter.log("FurnishedHolidayLettingsOtherExpenses: 106.00");
//		Reporter.log("PrivateUseAdjustment: 107.00");
//		Reporter.log("BalancingCharges: 108.00");
//		Reporter.log("ElectricChargePointAllowance: 109.00");
//		Reporter.log("CapitalAllowances: 110.00");
//		Reporter.log("AdjustedProfitForTheYear: 14577.00");
//		Reporter.log("LossesBroughtForward: 111.00");
//		Reporter.log("TaxableProfitForYear: 14466.00");
//
//		Reporter.log("LossToCarryForward: 112.00");
//		Reporter.log("PeriodOfGraceElection: yes");
//		Reporter.log("InEEA: yes");
//		Reporter.log("PropertyIncomeAndExpenses");
//		Reporter.log("TotalRentsAndOtherIncomeFromProperty: 20000.00");
//		Reporter.log("TraditionalAccounting: yes");
//		Reporter.log("TaxTakenOffAnyIncome: 301.00");
//		Reporter.log("PremiumsForGrantOfALease: 302.00");
//		Reporter.log("ReversePremiumsAndInducements: 303.00");
//		Reporter.log("RentRatesInsuranceAndGroundRents: 304.00");
//		Reporter.log("RepairsAndMaintenance: 305.00");
//		Reporter.log("AllowableInterestAndOtherFinancialCharges: 306.00");
//		Reporter.log("LegalManagementAndProfessionalFees: 307.00");
//		Reporter.log("CostsOfServicesProvided: 308.00");
//		Reporter.log("OtherPropertyExpenses: 309.00");
//		Reporter.log("TaxableProfitOrLoss");
//		Reporter.log("PrivateUseAdjustment: 310.00");
//		Reporter.log("BalancingCharges: 311.00");
//		Reporter.log("AnnualInvestmentAllowance: 312.00");
//		Reporter.log("TheStructuresAndBuildingsAllowance: 313.00");
//		Reporter.log("ElectricChargePointAllowance: 314.00");
//		Reporter.log("ZeroEmissionGoodsVehicleAllowance: 315.00");
//		Reporter.log("EnhancedCapitalAllowances: 316.00");
//		Reporter.log("CostsOfReplacingDomesticItems: 317.00");
//		Reporter.log("RentARoomExemptAmount: 318.00");
//		Reporter.log("AdjustedProfitForTheYear: 17182.00");
//		Reporter.log("LossBroughtForward: 319.00");
//		Reporter.log("TaxableProfitForTheYear: 16863.00");
//		Reporter.log("LossSetOffAgainstTotalIncomeOfTheYear: 320.00");
//		Reporter.log("ResidentialFinanceCosts: 322.00");
//		Reporter.log("UnusedResidentialFinanceCostsBroughtForward: 400.00");
//
//		Reporter.log("All XML tags checked of SA 105 profit case");
//          	
//
//		 Reporter.log("SA109");
//         Reporter.log("ResidenceStatus");
//         Reporter.log("NotResidentInUK:yes");
//         Reporter.log("HadAHomeOverseas:yes");
//        Reporter.log("ResidenceStatus");
//        Reporter.log("TimeSpentInUK");
//         Reporter.log("NumberOfDaysSpentInUK:120");
//        Reporter.log("NumberOfDaysDueToExceptionalCircumstances:5");
//        Reporter.log("NumberOfDaysWorkingOnCOVID19:12");
//        Reporter.log("PersonalAllowances");
//         Reporter.log("PersonalAllowancesClaimOnOtherBasis:yes");
//         Reporter.log("CodeForCountryOfNationalityOrResidence:IND");
//          Reporter.log("ResidenceInOtherCountries ");
//         Reporter.log("DomiciledOutsideTheUKForTax:yes");
//         Reporter.log("ConditionB:yes");
//         Reporter.log("YearsUKresident:12");
//         Reporter.log("FirstYearOrAlwaysDomiciledOutsideUK:yes");
//         Reporter.log("DateOfComingToLiveInUK:2009-04-10");
//     Reporter.log("AnyOtherInformationSpace:Moved to Switzerland for employment purpose");
