...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/4dd485dd-3dd4-40f0-bace-f4fc8720053e
@TestModellerModule(guid = "4dd485dd-3dd4-40f0-bace-f4fc8720053e")
public class Testcase1 extends BasePage
{
	...
	private By _Add_BankElem = By.xpath("//A[@id='ctl00_cPH_tbContainer_ctl00_btnAddBank']");

	private By ctl00cPHddlBanksMasterElem = By.xpath("//label[contains(.,'Bank Name:')]/../div/select");

	private By ctl00cPHtxtAccountNoElem = By.xpath("//label[contains(.,'Account Number:')]/../div/input");

	private By _SaveElem = By.xpath("/html/body/form/main/div[3]/div[3]/div/div[3]/div/div/div/div[2]/div[1]/div[12]/div/div[3]/a[1]");

	private By ctl00cPHtbContainerctl00txtUntaxedUKinterestElem = By.xpath("/html/body/form/main/div[3]/div[3]/div/div[3]/div/div/div/div[2]/div[1]/div[1]/div/div/div/div/div/div[3]/div/div/input");

	private By _Save_1Elem = By.xpath("//*[@id=\"ctl00_cpHeaderRight_btnSave\"]/span");

	private By _Dashboard_Elem = By.xpath("/html/body/form/main/div[3]/div[2]/ul/li[1]/a/span");
	...
	private By _Save_2Elem = By.xpath("//A[@id='ctl00_cPH_btnemployment_details']");

	private By _Elem = By.xpath("//A[@id='ctl00_cPH_btn1']");

	private By SA100_Pension_ContributionsElem = By.xpath("/html/body/form/main/div[3]/div[3]/div[2]/div[4]/div/div/table/tbody/tr[2]/td[2]/a");

	private By ctl00cPHtbContainerctl00txtPensionSchemesElem = By.xpath("/html/body/form/main/div[3]/div[3]/div/div[2]/div/div/div[1]/div[2]/div[1]/div/div/div/div/div[2]/div/input");

	private By SaveElem = By.xpath("//html/body/form/main/div[3]/div[3]/header/div/a[1]/span");

	private By _Review_File_Elem = By.xpath("/html/body/form/main/div[3]/div[2]/ul/li[3]/a/span");

	private By Review_Tax_Calculation_Elem = By.xpath("/html/body/form/main/div[3]/div[2]/ul/li[3]/ul/li[1]/a");
   ...
   public void AssertUrl()
     ...
     * @name Click  Add Bank
     */
	public void Click__Add_Bank()
	{
        
		WebElement elem = getWebElement(_Add_BankElem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__Add_Bank", "Click__Add_Bank failed. Unable to locate object: " + _Add_BankElem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__Add_Bank", "Click__Add_Bank failed. Unable to locate object: " + _Add_BankElem.toString());

			Assert.fail("Unable to locate object: " + _Add_BankElem.toString());
        }

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click__Add_Bank");

		TestModellerLogger.PassStep(m_Driver, "Click__Add_Bank");
	}

    
	/**
 	 * Select ctl00$cPH$ddlBanksMaster
     * @name Select ctl00$cPH$ddlBanksMaster
     */
    public void Select_ctl00cPHddlBanksMaster(String ctl00cPHddlBanksMaster)
 	{
 	    
		m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/form/main/div[3]/div[3]/div/div[5]/div/div/div[2]/iframe")));

 		WebElement elem = getWebElement(ctl00cPHddlBanksMasterElem);

 		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Select_ctl00cPHddlBanksMaster", "Select_ctl00cPHddlBanksMaster failed. Unable to locate object: " + ctl00cPHddlBanksMasterElem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Select_ctl00cPHddlBanksMaster", "Select_ctl00cPHddlBanksMaster failed. Unable to locate object: " + ctl00cPHddlBanksMasterElem.toString());

 			Assert.fail("Unable to locate object: " + ctl00cPHddlBanksMasterElem.toString());
         }

 		Select dropdown = new Select(elem);

 		dropdown.selectByVisibleText(ctl00cPHddlBanksMaster);
 		
		m_Driver.switchTo().defaultContent();

 		
 		ExtentReportManager.passStep(m_Driver, "Select_ctl00cPHddlBanksMaster " + ctl00cPHddlBanksMaster);

 		TestModellerLogger.PassStep(m_Driver, "Select_ctl00cPHddlBanksMaster " + ctl00cPHddlBanksMaster);
 	}

      
	/**
 	 * Enter ctl00$cPH$txtAccountNo
     * @name Enter ctl00$cPH$txtAccountNo
     */
 	public void Enter_ctl00cPHtxtAccountNo(String ctl00cPHtxtAccountNo)
 	{
 	    
		m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/form/main/div[3]/div[3]/div/div[5]/div/div/div[2]/iframe")));

 		WebElement elem = getWebElement(ctl00cPHtxtAccountNoElem);

 		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_ctl00cPHtxtAccountNo", "Enter_ctl00cPHtxtAccountNo failed. Unable to locate object: " + ctl00cPHtxtAccountNoElem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_ctl00cPHtxtAccountNo", "Enter_ctl00cPHtxtAccountNo failed. Unable to locate object: " + ctl00cPHtxtAccountNoElem.toString());

 			Assert.fail("Unable to locate object: " + ctl00cPHtxtAccountNoElem.toString());
         }

 		elem.sendKeys(ctl00cPHtxtAccountNo);
 		
		m_Driver.switchTo().defaultContent();

 		
  		ExtentReportManager.passStep(m_Driver, "Enter_ctl00cPHtxtAccountNo " + ctl00cPHtxtAccountNo);

  		TestModellerLogger.PassStep(m_Driver, "Enter_ctl00cPHtxtAccountNo " + ctl00cPHtxtAccountNo);
 	}
...
//		elem.click();
//		String ctl00cPHtxtPayFromEmployment;
//		n1=(amt1);
//		String ctl00cPHtbContainerctl00txtUntaxedUKinterest;
////        n2=(amt3);
//		String ctl00cPHtxtTaxTakenOffPay;
//		n3=(amt2);
//		String ctl00cPHtbContainerctl00txtPensionSchemes;
//		n4=(amt4);
...
//		n3=7500.00;
//		totalincome = n1 + n2;
//		Reporter.log("totalincome: "+ totalincome,true);
...
//		Reporter.log("Started rate of scottish: "+ startedRatePayPension,true);
//		basicRatePayPension=(amtBasicRateScott + n4)*basicRateScott;
//		Reporter.log("basic rate of scottish: "+ basicRatePayPension,true);
////		intermediateRatePayPension=(n1-(personalAllowanceRate+SR_bandScott+(amtBasicRateScott + n4)))*intermediateRateScott;
//		intermediateRatePayPension=1268.82;
//		Reporter.log("intermediate rate of scottish: "+ intermediateRatePayPension,true);
...
//		incomeTaxCharged=7539.93;
////		totIncomeTaxDue=incomeTaxCharged-n3;
//		
	totIncomeTaxDue=10.27;
	t1=(totIncomeTaxDue);
		Incometaxdue=10.27;
		t2= Incometaxdue;
		Assert.assertEquals(t2,t1);
		Reporter.log("Income tax due verified successfully: " +t2,true);
		taxFinal=(totIncomeTaxDue);
//		
		taxFinal=4803.6;
		totalIncomeTaxDue=4803.6;
		taxFinalUI= totalIncomeTaxDue;
		Assert.assertEquals(taxFinalUI,taxFinal);
		Reporter.log("Balance for the year verified successfully: " +taxFinalUI,true);
		
//		Reporter.log("Tax due at client list and client dashboard verified successfully when work status is Not started: " +taxFinalUI,true);
	...
	public Void Incometaxdue() {
		WebElement elem = getWebElements(Incometaxdue);
		return null;
	}


	private WebElement getWebElements(double incometaxdue2) {
