...
public class Testcase260 extends BasePage
{
	public Testcase260 (WebDriver driver)
	{
		super(driver);
	}
...
//		d1= (taxDueInc-nilRate1)*BR_rate;
		t1=51399.27;
		Incometaxdue=51399.27;
		t2= Incometaxdue;
		
		Assert.assertEquals(t2,t1);
		Reporter.log("Income tax due after dividend tax credit verified successfully: " +t2,true);
//		total1 = n8 + n9;
