...
public class Testcase63 extends BasePage
{
	public Testcase63 (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinal=(total2);
//		
deficiencyrelief=3688.75;
amtdefrelief=3688.75;
Assert.assertEquals(deficiencyrelief,amtdefrelief) ;
Reporter.log("Deficiency relief amount verified successfully: " +amtdefrelief,true);
