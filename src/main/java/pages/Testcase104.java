...
public class Testcase104 extends BasePage
{
	public Testcase104 (WebDriver driver)
	{
		super(driver);
	}
...
//          	
//		taxFinal=11803.6;
//		totalIncomeTaxDue=11803.6;
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at client list and client dashboard verified successfully when work status is filed: " +taxFinalUI,true);
