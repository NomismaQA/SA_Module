...
{
	public Testcase12 (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at work pool and client dashboard verified successfully when work status is Response Received: " +taxFinalUI,true);
