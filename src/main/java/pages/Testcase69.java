...
public class Testcase69 extends BasePage
{
	public Testcase69 (WebDriver driver)
	{
		super(driver);
	}
...
//		Assert.assertEquals(foreigncreditrelief,amtforcreditrelief) ;
		Notionaltaxamt=2770;
		amtfornotionaltax=2770;
		Assert.assertEquals(Notionaltaxamt,amtfornotionaltax) ;
		Reporter.log("Capital gain Tax due amount verified successfully: " +amtfornotionaltax,true);

		taxFinal=2810.95;
		totalIncomeTaxDue=2810.95;
