...
public class Testcase164 extends BasePage
{
	public Testcase164 (WebDriver driver)
	{
		super(driver);
	}
...
//		Notionaltaxamt=19006;
//		amtfornotionaltax=19006;
...
//		Reporter.log("Amount of Notional tax is verified successfully"+amtfornotionaltax,true);
		...
		Reporter.log(" IR Mark when 2nd input done : O2VEWZP7UUSU22ZEA6DVS25FT6ZRVU3M");
