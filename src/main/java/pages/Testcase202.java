...
public class Testcase202 extends BasePage
{
	public Testcase202 (WebDriver driver)
	{
		super(driver);
	}
...
//		amtReliefForFinanceCosts=97.40;
//dataReliefForFinanceCosts=97.40;
...
//          
//		Reporter.log("CapitalGainsSchedule: yes");
//
//		Reporter.log("ResidentialPropertyAndCarriedInterest");
//		Reporter.log("NumberOfDisposals: 2");
//		Reporter.log("DisposalProceeds: 1001.00");
//		Reporter.log("AllowableCosts: 1003.00");
//		Reporter.log("GainsInTheYear: 1004.00");
//		Reporter.log("LossesInTheYear: 1005.00");
//		Reporter.log("ClaimOrElectionMade: PRR");
//		Reporter.log("GainOrLossFromRTTreturn: 120.00");
//		Reporter.log("GainOrLossFromUKpropertyDisposal:10");
//		Reporter.log("UKpropertyDisposalTaxAlreadyCharged:50");
//		Reporter.log("RTTtaxAlreadyCharged: 1007.00");
//		Reporter.log("CarriedInterest: 1008.00");
//
//		Reporter.log("OtherPropertyAssetsAndGains");
//		Reporter.log("NumberOfDisposals: 2");
//		Reporter.log("DisposalProceeds: 2002.00");
//		Reporter.log("AllowableCosts: 2003.00");
//		Reporter.log("GainsInTheYear: 2004.00");
//		Reporter.log("AttributedGains: 2005.00");
//		Reporter.log("LossesInTheYear: 500.00");
//		Reporter.log("ClaimOrElectionMade: LET");
//		Reporter.log("GainFromRTTreturn: 501.00");
//		Reporter.log("RTTtaxAlreadyCharged: 100.00");
//
//		Reporter.log("ListedSharesAndSecurities");
//		Reporter.log("NumberOfDisposals: 3");
//		Reporter.log("DisposalProceeds: 3001.00");
//		Reporter.log("AllowableCosts: 3002.00");
//		Reporter.log("GainsInTheYear: 3003.00");
//		Reporter.log("LossesInTheYear: 600.00");
//		Reporter.log("ClaimOrElectionMade: ERL");
//		Reporter.log("GainFromRTTreturn: 650.00");
//		Reporter.log("RTTtaxAlreadyCharged: 105.00");
//		Reporter.log("UnlistedSharesAndSecurities");
//		Reporter.log("NumberOfDisposals: 4");
//		Reporter.log("DisposalProceeds: 4001.00");
//		Reporter.log("AllowableCosts: 4002.00");
//		Reporter.log("GainsInTheYear: 4003.00");
//		Reporter.log("LossesInTheYear: 700.00");
//		Reporter.log("ClaimOrElectionMade: NVC");
//		Reporter.log("GainFromRTTreturn: 750.00");
//		Reporter.log("RTTtaxAlreadyCharged: 200.00");
//		Reporter.log("GainsExceedingESSlimit: 4008.00");
//		Reporter.log("GainsInvestedUnderSeedEIS: 251.00");
//		Reporter.log("LossesUsedAgainstReturnYearIncome: 250.00");
//		Reporter.log("SEISandEISlossReliefInReturnYear: 228.00");
//		Reporter.log("LossesUsedAgainstPreviousReturnYearIncome: 109.00");
//		Reporter.log("SEISandEISlossReliefInPreviousReturnYear: 101.00");
//
//		Reporter.log("LossesAndAdjustments");
//		Reporter.log("LossesBroughtForwardAndUsedInTheReturnYear: 550.00");
//		Reporter.log("IncomeLossesOfTheReturnYearSetAgainstGains: 560.00");
//		Reporter.log("LossesToBeCarriedForward: 2010.00");
//		Reporter.log("LossesUsedAgainstEarlierReturnYearsGain: 2011.00");
//		Reporter.log("GainsQualifyingForInvestorsRelief: 2012.00");
//		Reporter.log("GainsQualifyingForEntrepreneursRelief: 2013.00");
//		Reporter.log("AdjustmentToCGT: 2014.00");
//		Reporter.log("NonResidentdualResidentTrustLiability: 2015.00");
//		Reporter.log("NRCGTonUKpropertyOrLandAndIndirectDisposals");
//		Reporter.log("TotalGainsChargeableForDirectDisposalsForUKresidentialProperty: 10000.00");
//		Reporter.log("TotalGainsChargeableForDirectDisposalsForUKNRproperty: 1000001.00");
//		Reporter.log("GainsFromIndirectDisposals: yes");
//		Reporter.log("TaxOnGainsInBoxes521and522alreadyPaid: 1000002.00");
//		Reporter.log("TotalLossesAvailableAgainstNRCGTgainsForTheYear: 1000003.00");
//
//		Reporter.log("SA108");
//		Reporter.log("AnyOtherInformationSpace: Testing");
//
//		Reporter.log("Tags checked of SA108 page");
		
//		 Reporter.log("SA104F");
//         Reporter.log(" PartnershipDetails");
//             Reporter.log("PartnershipReferenceNumber:1000050020");
//             Reporter.log("PartnershipDescription:abc");
//        
//           Reporter.log("ShareOfProfits");
//             Reporter.log("DateBasisPeriodBegan:2020-04-06");
//             Reporter.log("DateBasisPeriodEnded>2021-04-05");
//             Reporter.log("ShareOfPartnershipProfitOrLoss:15500.00");
//          Reporter.log("AdjustedProfitForYear:15500.00");
//             Reporter.log("TaxableProfitsAfterLosses:15500.00");
//             Reporter.log("TotalTaxableBusinessProfits:15500.00");
//          
//             Reporter.log("ShareOfTotalTaxedAndUntaxedIncome:15500.00");
