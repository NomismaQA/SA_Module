...
public class Testcaseselfemp_75 extends BasePage
{
	public Testcaseselfemp_75 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
        ...
        Reporter.log("Date of birth:06/04/1951");
       
        Reporter.log("Exempt from Class 4 NIC is checked at self employment,verified ");
