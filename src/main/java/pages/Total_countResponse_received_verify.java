...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/2f9c9a4c-ffa9-4bdf-bda3-711f74ba7f14
@TestModellerModule(guid = "2f9c9a4c-ffa9-4bdf-bda3-711f74ba7f14")
public class Total_countResponse_received_verify extends BasePage
{
	public Total_countResponse_received_verify (WebDriver driver)
	{
		super(driver);
	}
	...
	private By DashboardElem = By.xpath("//*[@id=\"selfAssessmentMenu\"]/a/span");

	private By _Self_Assessment_Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_SideMenu1_SAMenuChildren\"]/li[1]/a");
	...
	private By _0Elem = By.xpath("//A[@id='ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl00_lnkTCSubmitted']");
	...
	private By _2Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table/tfoot/tr/td[4]/b");
