...
public class Testcase38 extends BasePage
{
	public Testcase38 (WebDriver driver)
	{
		super(driver);
	}
...
//				taxFinalUI= totalIncomeTaxDue;
//				Assert.assertEquals(taxFinalUI,taxFinal);
//				Reporter.log("Tax due at work poolt and client dashboard verified successfully when work status is Response Received: " +taxFinalUI,true);
//		          	
