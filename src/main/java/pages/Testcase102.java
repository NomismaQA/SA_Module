...
public class Testcase102 extends BasePage
{
	public Testcase102 (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at client list and client dashboard verified successfully when work status is sent for approval: " +taxFinalUI,true);
