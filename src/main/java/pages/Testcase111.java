...
public class Testcase111 extends BasePage
{
	public Testcase111 (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at ork pool and client dashboard verified successfully when work status is In progress: " +taxFinalUI,true);
//          	
