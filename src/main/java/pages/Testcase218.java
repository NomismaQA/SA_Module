...
public class Testcase218 extends BasePage
{
	public Testcase218 (WebDriver driver)
	{
		super(driver);
	}
...
//         Reporter.log("GiftAidPaymentsMadeInYear:1540.00");
//         Reporter.log("OneOffGiftAidPayments:10.00");
//         Reporter.log("GiftAidPaymentsCarriedBackToPreviousYear:20.00");
//         Reporter.log("GiftAidPaymentsBroughtBackFromLaterYear:30.00");
//         Reporter.log("SharesGiftedToCharity:40.00");
//         Reporter.log("LandAndBuildingsGiftedToCharity:50.00");
//         Reporter.log("InvestmentsGiftedToNonUKCharities:60.00");
//         Reporter.log("DonationsToNonUKCharities:70.00");
