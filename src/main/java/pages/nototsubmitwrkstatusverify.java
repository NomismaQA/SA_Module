...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/0e1e2c74-9598-4a43-b945-a379482547bb
@TestModellerModule(guid = "0e1e2c74-9598-4a43-b945-a379482547bb")
public class nototsubmitwrkstatusverify extends BasePage
{
	public nototsubmitwrkstatusverify (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _Update_Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[1]/div/div/div/div/div[3]/div");

	private By _0Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl01_LinkButtonEx3\"]");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[3]/div/div/div/div/table"));
		...
		if(totalData==_acount)			
		{
			...
			System.out.println("work statusnot to submit count matched" +totalData+" "+_acount);
