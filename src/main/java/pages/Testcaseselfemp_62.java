...
public class Testcaseselfemp_62 extends BasePage
{
	public Testcaseselfemp_62 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
		...
		Reporter.log("Turnover at self emp UI:55000");
        Reporter.log("Date of birth:30/04/1954");
       
        Reporter.log("Exempt from Class 4 NIC is not checked at self employment,verified ");
