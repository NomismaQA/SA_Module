...
public class Testcase72 extends BasePage
{
	public Testcase72 (WebDriver driver)
	{
		super(driver);
	}
...
//		amtReliefForFinanceCosts=total1*reliefFinancerate;
		amtReliefForFinanceCosts=393;
dataReliefForFinanceCosts=393;
Assert.assertEquals(dataReliefForFinanceCosts,amtReliefForFinanceCosts) ;//487
