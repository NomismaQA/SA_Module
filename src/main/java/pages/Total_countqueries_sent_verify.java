...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/a733d7e6-ab7f-4b75-92eb-af59bbf8aa47
@TestModellerModule(guid = "a733d7e6-ab7f-4b75-92eb-af59bbf8aa47")
public class Total_countqueries_sent_verify extends BasePage
{
	public Total_countqueries_sent_verify (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _1Elem = By.xpath("//A[@id='ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl00_lnkRFI']");

	private By xPath_idctl00_ctl00_ParentContent_cPH_PageUC1_rptrPager_ctl03_lnkNextElem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_PageUC1_rptrPager_ctl03_lnkNext\"]");

	private By _2_Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table/tfoot/tr/td[7]/b");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table"));
		...
		List<WebElement> TotalRowCount = eles.findElements(By.xpath("//div[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]//div/table/tbody//tr/td[7]"));
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table"));
     ...
     * @name Click  2 
     */
	public void Click__2_()
	{
        
		WebElement elem = getWebElement(_2_Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__2_", "Click__2_ failed. Unable to locate object: " + _2_Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__2_", "Click__2_ failed. Unable to locate object: " + _2_Elem.toString());

			Assert.fail("Unable to locate object: " + _2_Elem.toString());
        }
		String txt= elem.getText();
		_acount=Integer.parseInt(txt);
		
		System.out.println("total count:queries sent matched" +_acount);

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click__2_");

		TestModellerLogger.PassStep(m_Driver, "Click__2_");
	}
}