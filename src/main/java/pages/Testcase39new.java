...
public class Testcase39new extends BasePage
{
	public Testcase39new (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinal=(total2);
//		
//		deficiencyrelief=3508;
//		amtdefrelief=3508;
//		Assert.assertEquals(deficiencyrelief,amtdefrelief) ;
//		foreigncreditrelief=42;
//		amtforcreditrelief=42;
//		Assert.assertEquals(foreigncreditrelief,amtforcreditrelief) ;
//		Reporter.log("Foreign tax credit relief amount verified successfully: " +amtforcreditrelief,true);
//
//		taxFinal=-5496.01;
//		totalIncomeTaxDue=-5496.01;
