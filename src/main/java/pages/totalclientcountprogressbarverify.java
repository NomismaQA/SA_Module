...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/f2261d05-5266-4bfc-b793-746998ac1976
@TestModellerModule(guid = "f2261d05-5266-4bfc-b793-746998ac1976")
public class totalclientcountprogressbarverify extends BasePage
{
	public totalclientcountprogressbarverify (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _6_Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[8]/div[2]/div/div/div[5]/div/div/a[1]/div/h3");

	private By more_Elem = By.xpath("//*//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[8]/div[2]/div/div/div[4]/div/div/a[2]/p/u");
   ...
   public void AssertUrl()
     ...
     * @name Click  6 
     */
	public void Click__6_()
	{
        
		WebElement elem = getWebElement(_6_Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__6_", "Click__6_ failed. Unable to locate object: " + _6_Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__6_", "Click__6_ failed. Unable to locate object: " + _6_Elem.toString());

			Assert.fail("Unable to locate object: " + _6_Elem.toString());
        }
		...
		ExtentReportManager.passStep(m_Driver, "Click__6_");

		TestModellerLogger.PassStep(m_Driver, "Click__6_");
	}
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[3]/div/div/div/div/table"));
		...
		{
			Reporter.log("work status:total client of progress bar count matched" +totalData+" "+_acount);
			System.out.println("work status:total client of progress bar count matched" +totalData+" "+_acount);
