...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/b32e2867-b32e-4ee0-8979-e635e7abff3e
@TestModellerModule(guid = "b32e2867-b32e-4ee0-8979-e635e7abff3e")
public class sentforapprovalworkstatusverify extends BasePage
{
	public sentforapprovalworkstatusverify (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _0Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl00_LinkButtonEx6\"]");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[3]/div/div/div/div/table"));
		...
		if(totalData==_acount)			
		{
			...
			System.out.println("work status:sent for approval count matched" +totalData+" "+_acount);
