...
public class Testcase205 extends BasePage
{
	public Testcase205 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("Income");
//		Reporter.log("UKInterestAndDividends");
//		Reporter.log("TaxedBankBuildingSocietyEtcInterest: 2001.00");
//		Reporter.log("UntaxedUKinterestEtc: 1260.00");
//		Reporter.log("UntaxedForeignInterest: 1999.00");
//		Reporter.log("CompanyDividends: 50001.00");
//		Reporter.log("UnitTrustEtcDividends: 201.00");
//		Reporter.log("ForeignDividends: 202.00");
//		Reporter.log("TaxTakenOffForeignDividends: 202.00");
//
//		Reporter.log("StateBenefits");
//		Reporter.log("AnnualStatePension: 1000.00");
//		Reporter.log("StatePensionLumpSum: 900.00");
//		Reporter.log("TaxTakenOffPensionLumpSum: 406.00");
//		Reporter.log("OtherPensionsAndRetirementAnnuities: 500.00");
//		Reporter.log("TaxTakenOffPensionsAndRetirementAnnuities: 400.00");
//		Reporter.log("IncapacityBenefit: 700.00");
//		Reporter.log("TaxTakenOffIncapacityBenefit: 600.00");
//		Reporter.log("JobseekersAllowance: 300.00");
//		Reporter.log("OtherStatePensionsAndBenefits: 100.00");
//
//		Reporter.log("OtherUKIncome");
//		Reporter.log("OtherTaxableIncome: 4567.00");
//		Reporter.log("AllowableExpenses: 1234.00");
//		Reporter.log("TaxTakenOffOtherTaxableIncome: 213.00");
//		Reporter.log("DeemedIncomeOrBenefits: 222.00");
//		Reporter.log("DescriptionOfOtherIncome: Testing");

//		Reporter.log("All XML tags checked INC page of SA 100");
...
//            Reporter.log("ShareOfPartnershipProfitOrLoss:1000.00");
//         Reporter.log("AdjustedProfitForYear:00");
//            Reporter.log("TaxableProfitsAfterLosses:00");
//            Reporter.log("LossesBroughtForward:1000.00");
