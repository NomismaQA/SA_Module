...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/6a4b6ee7-40bb-41d1-8a3c-3d2ca0eedd34
@TestModellerModule(guid = "6a4b6ee7-40bb-41d1-8a3c-3d2ca0eedd34")
public class Total_countAwaiting_review_verify extends BasePage
{
	public Total_countAwaiting_review_verify (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _1Elem = By.xpath("//A[@id='ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl00_lnkReview']");
	...
	private By _2Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table/tfoot/tr/td[8]/b");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table"));
		...
		List<WebElement> TotalRowCount = eles.findElements(By.xpath("//div[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]//div/table/tbody//tr/td[8]"));
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table"));
	...
	public void Click__2()
	{
		...
		System.out.println("total count:Awaiting review matched" +_acount);
