...
// https://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/a4234a6f-fd23-496a-a1e1-dac4e2a513b9
@TestModellerModule(guid = "a4234a6f-fd23-496a-a1e1-dac4e2a513b9")
public class Filedcclientscomaprison extends BasePage
{
	public Filedcclientscomaprison (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _12_Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[8]/div[2]/div/div/div[5]/div/div/a[1]/div/h3");
   ...
   public void AssertUrl()
     ...
     * @name Click  12 
     */
	public void Click__12_()
	{
        
		WebElement elem = getWebElement(_12_Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__12_", "Click__12_ failed. Unable to locate object: " + _12_Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__12_", "Click__12_ failed. Unable to locate object: " + _12_Elem.toString());

			Assert.fail("Unable to locate object: " + _12_Elem.toString());
        }
String txt= elem.getText();
		...
		_acount=Integer.parseInt(All[0]+All[1]);
			...
			System.out.print("Total filed  client in 2019-20:"+_acount);
			Reporter.log("Totalfiled  client in 2019-20:"+_acount);
		

//		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click__12_");

		TestModellerLogger.PassStep(m_Driver, "Click__12_");
	}
...
//		}
	...
	_acount1=Integer.parseInt(All[0]);
	
		System.out.print("Total client in 2018-19:"+_acount1);
		Reporter.log("Total filed client in 2018-19:"+_acount1);	
