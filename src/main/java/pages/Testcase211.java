...
public class Testcase211 extends BasePage
{
	public Testcase211 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("SpousesName: Jhon");
//		Reporter.log("SpousesDateOfBirth: 1935-04-05");
//		Reporter.log("AllMinimumAllowanceTransferToOther: yes");
//		Reporter.log("PreviousSpousesDateOfBirth: 1970-05-05");
//		Reporter.log("AgeRelatedMarriedCouplesAllowance");
//		Reporter.log("DateOfMarriageOrCivilPartnership: 2019-09-06");
//		Reporter.log("SurplusAllowanceToSpouse: yes");
//
//		Reporter.log("All XML tags checked 2nd scenario of MCA page of for high income SA 101");

//        Reporter.log("SigningYourForm");
//        
//        Reporter.log("OtherInformationSpace:TEST");
//        
//        Reporter.log("ProvisionalFigures:yes");
//        
//        Reporter.log("CoronavirusSupportPaymentsIncluded:yes");
//        
//        Reporter.log("CapacityOfPersonSigning:London");
//        
//        Reporter.log("NameOfPersonSignedFor:abc");
//        
//        Reporter.log("NameOfPersonSigning:Aliyena ");
//        
//        Reporter.log("AddressOfPersonSigning");
//          
