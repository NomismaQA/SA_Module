...
public class Testcaseselfemp_39 extends BasePage
{
	public Testcaseselfemp_39 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
		Reporter.log("Tax year : 2020-21");
		   Reporter.log("Turnover:91000");
           Reporter.log("OtherBusinessIncome:750");
             Reporter.log("CostOfGoods:-1550");
             Reporter.log("CarVanAndTravelExpenses:-1260");
             Reporter.log("Wages, salaries and other staff costs::-1200");
             Reporter.log("Rent, rates, power and insurance costss:-1260");
             ...
             Reporter.log("Repairs and maintenance of property and equipment:-460");
             Reporter.log("DepreciationAndLossProfitOnSale:-910");
             Reporter.log("OtherBusinessExpenses:-1260");
             Reporter.log("TotalExpenses:-10590");
             Reporter.log("TotalDisallowableExpenses:-2210");
         Reporter.log("NetProfitLoss:102340");
           Reporter.log("AdditionsToNetProfitDeductionsFromNetLoss:-2210");
           Reporter.log("NetBusinessProfitLossForTax:102340");
           Reporter.log("AdjustedProfitForTheYear:100130");
           Reporter.log("TotalTaxableBusinessProfits:100130");
           Reporter.log("EquipmentMachineryVehicles:-21500");
           Reporter.log("Stock and work in progress:-1000");
           Reporter.log("Cash in hand:82000");
           Reporter.log("Other current assets and prepayments:40840");
             Reporter.log("TotalBusinessAssets:100340");
           Reporter.log("NetBusinessAssets:49430");
             Reporter.log("NetProfitOrLoss:102340");
             Reporter.log("CapitalAccountBalanceAtEnd:113340");
Reporter.log("Error! Disallowable expenses can not greater than Total expenses");
