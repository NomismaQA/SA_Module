...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/96aa110a-f227-426b-af57-911706a90efa
@TestModellerModule(guid = "96aa110a-f227-426b-af57-911706a90efa")
public class Not_startedtotal_count_verify extends BasePage
{
	public Not_startedtotal_count_verify (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _1Elem = By.xpath("//A[@id='ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl00_lnkNotStarted']");
	...
	private By _3Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table/tfoot/tr/td[3]");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table"));
		...
		List<WebElement> TotalRowCount = eles.findElements(By.xpath("//div[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]//div/table/tbody//tr/td[3]"));
...
//	}
     ...
     * @name Click  3
     */
	public void Click__3()
	{
        
		WebElement elem = getWebElement(_3Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__3", "Click__3 failed. Unable to locate object: " + _3Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__3", "Click__3 failed. Unable to locate object: " + _3Elem.toString());

			Assert.fail("Unable to locate object: " + _3Elem.toString());
        }
		...
		ExtentReportManager.passStep(m_Driver, "Click__3");

		TestModellerLogger.PassStep(m_Driver, "Click__3");
	}
}