...
public class Testcase55 extends BasePage
{
	public Testcase55 (WebDriver driver)
	{
		super(driver);
	}
...
//		Notionaltaxamt=240;
//		amtfornotionaltax=240;
//		Assert.assertEquals(Notionaltaxamt,amtfornotionaltax) ;
//		Reporter.log("Notional tax amount verified successfully: " +amtfornotionaltax,true);
//
//		taxFinal=6343.95;
//		totalIncomeTaxDue=6343.95;
...
//		Reporter.log(" Amount in Payroll section for tax year 2016-17:60000");
//		Reporter.log(" Amount in Payroll section for tax year 2016-17:784.5");
//		
...
//		Reporter.log("	tag for tax year 2016-17 verified:PayFromEmployment:60000");
//		Reporter.log("	tag for tax year 2016-17 verified:TaxTakenOffPay:784.5");
...
//		Reporter.log(" Amount in Partnership tax return section for tax year 2016-17:32500");
...
//		Reporter.log(" Amount in Dividends from UK companies after linking :500");
//
//		Reporter.log(" Amount in Dividends section of book-keeping for tax year 2016-17:500");
//
//		Reporter.log("Amount of SA and book-keeping section verified:500");
//		
//Reporter.log(" Tax return failed:The time limit for submitting a return online is 4 years after the end of the year to which it relates. Please check");
//		
//		Reporter.log("tag for tax year 2020-21 verified:CompanyDividend:500");
