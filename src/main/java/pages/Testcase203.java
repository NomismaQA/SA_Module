...
public class Testcase203 extends BasePage
{
	public Testcase203 (WebDriver driver)
	{
		super(driver);
	}
...
//Reporter.log("SA100");
//Reporter.log("MarriageAllowanceTransferredIn: yes");
//Reporter.log("BlindPersonsAllowance");
//Reporter.log("RegisteredBlind: yes");
//Reporter.log("LocalAuthorityName: LiverPool");
//Reporter.log("SurplusBlindPersonsAllowanceToSpouse: yes");
//
//Reporter.log("SA110");
//Reporter.log("SelfAssessment");
//Reporter.log("TotalTaxEtcDue: 0.00");
//Reporter.log("PaymentsOnAccount");
//
//Reporter.log("All XML tags of MAT IN and Blind allowance checkedSA100");
