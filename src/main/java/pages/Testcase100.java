...
public class Testcase100 extends BasePage
{
	public Testcase100 (WebDriver driver)
	{
		super(driver);
	}
...
//		d1= (taxDueInc-nilRate1)*BR_rate;
			t1=105869.22;
Incometaxdue=105869.23;
		t2= Incometaxdue;
		
Assert.assertEquals(t2,t1);
//Reporter.log("Income tax due verified successfully: " +t2,true);
Reporter.log("Validation is failed:The total tax due in box [CAL1] does not agree with the calculated value of �92,341.11. The difference is -�165.37. Please check");
////		total1 = n8 + n9;
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at client list and client dashboard verified successfully when work status is Response Received: " +taxFinalUI,true);
