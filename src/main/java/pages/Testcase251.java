...
public class Testcase251 extends BasePage
{
	public Testcase251 (WebDriver driver)
	{
		super(driver);
	}
...
//		d1= (taxDueInc-nilRate1)*BR_rate;
		...
		Reporter.log("Income and capital tax due verified successfully: " +t2,true);
//		total1 = n8 + n9;
