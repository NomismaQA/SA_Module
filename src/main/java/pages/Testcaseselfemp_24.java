...
public class Testcaseselfemp_24 extends BasePage
{
	public Testcaseselfemp_24 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
		...
		Reporter.log("CostOfGoods:4875");
					

		Reporter.log("CarVanAndTravelExpenses:1720");
					

		Reporter.log("WagesSalariesAndStaffCosts50000");
		...
		Reporter.log("PhoneAndOtherOfficeCosts:40");
					 

		Reporter.log("OtherAllowableBusinessExpenses:48460.50");
					 

		Reporter.log("TotalAllowableExpenses:130096.25");
					 ...
					 Reporter.log("TotalLossToCarryForward:706.25");
		              ...
		              Reporter.log("OtherCurrentAssets:19160");
		               ...
		               Reporter.log("NetProfitOrLoss:-2216.25");
		                ...
		                Reporter.log("linking verified for short and full form");
