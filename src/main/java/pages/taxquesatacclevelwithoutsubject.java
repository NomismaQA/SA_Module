...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/8f9b29ea-9a3f-4b81-a388-4f3e6dc1fd61
@TestModellerModule(guid = "8f9b29ea-9a3f-4b81-a388-4f3e6dc1fd61")
public class taxquesatacclevelwithoutsubject extends BasePage
{
	public taxquesatacclevelwithoutsubject (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _Deepika_Automation_client_Elem = By.xpath("//*[@id=\"step-1\"]/div/div[2]/div/div/table/tbody[2]/tr/td[2]/button");
