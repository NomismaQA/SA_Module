...
public class Testcase168 extends BasePage
{
	public Testcase168 (WebDriver driver)
	{
		super(driver);
	}
...
//		d1= (taxDueInc-nilRate1)*BR_rate;
		t1=50141.18;
		Incometaxdue=50141.18;
		t2= Incometaxdue;
		
		Assert.assertEquals(t2,t1);
		Reporter.log("Income tax due verified successfully: " +t2,true);
		
//		Reporter.log(" IR Mark when Amended Submission done : 7QDFVYOEHIVKJJSSIMHT3OQA24ZANNM2");
//		Reporter.log("IR Mark when Tax return is unlocked:7QDFVYOEHIVKJJSSIMHT3OQA24ZANNM2");
//
//
//		Reporter.log(" IR Mark when 2nd Amended Submission done : 7QDFVYOEHIVKJJSSIMHT3OQA24ZANNM2");
