...
public class Testcase197 extends BasePage
{
	public Testcase197 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("Amount of Ve tax is verified successfully"+amtfornotionaltax,true);

		taxFinal=318257.38;
		totalIncomeTaxDue=318257.38;
