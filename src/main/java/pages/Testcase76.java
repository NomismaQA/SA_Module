...
public class Testcase76 extends BasePage
{
	public Testcase76 (WebDriver driver)
	{
		super(driver);
	}
...
//		amtReliefForFinanceCosts=100.40;
//dataReliefForFinanceCosts=100.40;
//Assert.assertEquals(dataReliefForFinanceCosts,amtReliefForFinanceCosts) ;//120.00
...
//		
//		Reporter.log(" IR Mark when 3rd input done : JQQZKC5Z2MQN6XBUBFQNGO3ZVZFSCMH7");
//
//
//
//		Reporter.log(" IR Mark when 2nd  validation done : JQQZKC5Z2MQN6XBUBFQNGO3ZVZFSCMH7");
//
//		Reporter.log(" IR Mark when Submission is  done : JQQZKC5Z2MQN6XBUBFQNGO3ZVZFSCMH7");
...
//		Reporter.log(" Amount in UK tax taken off pay after  linking :1584.5");
//		Reporter.log(" Amount in Payroll section for tax year 2019-20:60000");
//		Reporter.log(" Amount in Payroll section for tax year 2019-20:1584.5");
//		
//		Reporter.log("Amount of SA and payroll section verified:60000");
//		Reporter.log("Amount of SA and payroll section verified:1584.5");
//		
//		Reporter.log("Tax return validated:Success! Tax return is validated");
//		Reporter.log("	tag for tax year 2019-20 verified:PayFromEmployment:60000");
//		Reporter.log("	tag for tax year 2019-20 verified:TaxTakenOffPay:1584.5");
...
//		Reporter.log(" Amount in Partnership tax return section for tax year 2019-20:32500");
