...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/843b650c-a17c-4e4f-a5dc-2ae8f7a5d397
@TestModellerModule(guid = "843b650c-a17c-4e4f-a5dc-2ae8f7a5d397")
public class queriessentworkstatusverify extends BasePage
{
	public queriessentworkstatusverify (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _1Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl00_lnkRFI\"]");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[3]/div/div/div/div/table"));
		...
		if(totalData==_acount)			
		{
			...
			System.out.println("work status:queries sent count matched" +totalData+" "+_acount);
