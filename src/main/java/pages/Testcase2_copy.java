...
public class Testcase2_copy extends BasePage
{
	public Testcase2_copy (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("GovTalkMessage");
//		
//		Reporter.log("GovTalkMessage xmlns: http://www.govtalk.gov.uk/CM/envelope");
//		Reporter.log("EnvelopeVersion: 2.0");
//		
//		Reporter.log("MessageDetails");
//		Reporter.log("Class: HMRC-SA-SA100-TIL");
//		Reporter.log("Qualifier: request");
//		Reporter.log("Function: submit");
//		Reporter.log("Transformation: XML");
//		
//		Reporter.log("IDAuthentication");
//		Reporter.log("SenderID: SA0110");
//		
//		Reporter.log("Authentication");
//		Reporter.log("Method: clear");
//		Reporter.log("Value: testing1");
//		
//		Reporter.log("Keys");
//		Reporter.log("Key Type= UTR : 1000000110");
//		
//		Reporter.log("Channel");
//		Reporter.log("URI: 7246");
//		Reporter.log("Product: NOMISMA");
//		Reporter.log("Version: 2.0");
//		
//		Reporter.log("IRheader");
//		Reporter.log("PeriodEnd: 2020-04-05");
//		Reporter.log("DefaultCurrency: GBP");
//		Reporter.log("Sender: Individual");
//		
//		Reporter.log("SA100");
//		Reporter.log("YourPersonalDetails");
//		Reporter.log("DateOfBirth: 1990-01-01");
//		Reporter.log("NationalInsuranceNumber: SE913963D");
//		Reporter.log("TaxpayerStatus: U");
//		
//		Reporter.log("TaxAdviser");
//		Reporter.log("TaxAdviser: Nomisma Solution Limited");
//		Reporter.log("TaxAdviserPhoneNumber: 02089036330");
//		
//		Reporter.log("TaxAdviserAddress");
//		Reporter.log("Line: Pacific House");
//		Reporter.log("PostCode: HA3 8DP");
//	
//		Reporter.log("TrustsSchedule: yes");
//		
//		Reporter.log("SA107");
//		Reporter.log("ForeignTax: 1012.00");
//		Reporter.log("AnyOtherInformationSpace: Testing integer value");
//		
//		Reporter.log("DiscretionaryIncomePayment");
//		Reporter.log("DiscretionaryIncomePaymentNetAmount: 100.00");
//		Reporter.log("PaymentsFromSettlorInterestedTrusts: 200.00");
//		
//		Reporter.log("NondiscretionaryIncomeEntitlementFromTrusts");
//		Reporter.log("NonDiscretionaryIncomeTaxedAtBasicRate: 300.00");
//		Reporter.log("NonDiscretionaryIncomeTaxedAtLowerRate: 400.00");
//		Reporter.log("NonDiscretionaryIncomeTaxedAtDividendRate: 500.00");
//		Reporter.log("IncomeFromTrustsEtcNonResidentTrustees: yes");
//		
//		Reporter.log("IncomeChargeableOnSettlors");
//		Reporter.log("NetSettlorIncomeTaxedAtBasicRate: 700.00");
//		Reporter.log("NetSettlorIncomeTaxedAtLowerRate: 800.00");
//		Reporter.log("NetSettlorIncomeTaxedAtDividendRate: 800.00");
//		Reporter.log("NetSettlorIncomeTaxedAtTrustRate: 900.00");
//		Reporter.log("SavingsIncomeAtTrustRate: 1000.00");
//		Reporter.log("NetSettlorIncomeTaxedAtDividendTrustRate: 1001.00");
//		Reporter.log("GrossSettlorIncomeToBeTaxedAtBasicRate: 1002.00");
//		Reporter.log("GrossSettlorIncomeToBeTaxedAtLowerRate: 1003.00");
//		Reporter.log("AmountOfUKLifeInsurancePolicy: 1004.00");
//		
//		Reporter.log("UKEstates");
//		Reporter.log("EstateIncomeTaxedAtBasicRate: 1005.00");
//		Reporter.log("EstateIncomeTaxedAtLowerRate: 1006.00");
//		Reporter.log("EstateIncomeTaxedAtDividendRate: 1007.00");
//		Reporter.log("EstateIncomeTaxedAtNonrepayableBasicRate: 1008.00");
//		Reporter.log("IncomeTaxedAtNonrepayableLowerRate: 1009.00");
//		
//		Reporter.log("ForeignEstates");
//		Reporter.log("ForeignEstateIncome: 1010.00");
//		Reporter.log("ReliefForUKTaxAccountedFor: 1011.00");
//		
//		Reporter.log("IncomeFromResidentialProperty");
//		Reporter.log("ResidentialPropertyIncomeOrRestrictedFinanceCosts: 1013.00");
//		Reporter.log("UnusedResidentialFinanceCostsBroughtForward: 1014.00");
//		SA110
//		SelfAssessment
//		TotalTaxEtcDue: -4780.91
//		  Reporter.log("SA109");
...
//           Reporter.log("NumberOfDaysWorkingOnCOVID19:30<");
//           Reporter.log("AnyOtherInformationSpace:non-resident");	
//		Reporter.log("All XML tags checked of Non UK resident income page");
          	
		
//		Reporter.log("Tax year: 2013-14");
//
//		Reporter.log("Work status:Not started");
		
//		Reporter.log("Confirmation message after linking:Success! You have successfully linked dividend income with bookkeeping nomisma module.");
...
//		Reporter.log(" Amount in Partnership tax return section for tax year 2013-14:32500");
