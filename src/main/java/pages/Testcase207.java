...
public class Testcase207 extends BasePage
{
	public Testcase207 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("StudentLoanRepayments");
//		Reporter.log("IncomeContingentStudentLoanNotification: yes");
//		Reporter.log("StudentLoanRepaymentDeductedAmount: 2241.00");
//		Reporter.log("PlanType: 01");
//		Reporter.log("XML tags of Student Loan plan 1 checked of SA100");
...
//     
//            Reporter.log("NetBusinessProfitForTax:15514.36");
//         
//            Reporter.log("TotalTaxableBusinessProfits:15514.36");
