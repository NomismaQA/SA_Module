...
public class Testcase17 extends BasePage
{
	public Testcase17 (WebDriver driver)
	{
		super(driver);
	}
...
//		amtReliefForFinanceCosts=total1*reliefFinancerate;
		amtReliefForFinanceCosts=2920;
dataReliefForFinanceCosts=2920;
