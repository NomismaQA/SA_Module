...
public class Testcase120 extends BasePage
{
	public Testcase120 (WebDriver driver)
	{
		super(driver);
	}
...
//		foreigncreditrelief=200;
//		amtforcreditrelief=200;
//		Assert.assertEquals(foreigncreditrelief,amtforcreditrelief) ;
//		Reporter.log("Foreign tax cedit relief amount verified successfully: " +amtforcreditrelief,true);
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at work pool and client dashboard verified successfully when work status is Questionnaire Sent: " +taxFinalUI,true);
