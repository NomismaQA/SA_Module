...
public class Testcase20 extends BasePage
{
	public Testcase20 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("SA101");
//		Reporter.log("GiltEdgeSecuritiesInterest");
//		Reporter.log("NetGiltInterest: 10001.00");
//		Reporter.log("TaxTakenOffGiltInterest: 1002.00");
//		Reporter.log("GrossGiltInterest: 1003.00");
//		Reporter.log("LifeInsuranceGainsTaxTreatedAsPaid");
//		Reporter.log("AmountOfGain: 3001.00");
//		Reporter.log("NumberOfYears: 2");
//		Reporter.log("LifeInsuranceGainsNoTaxTreatedAsPaid");
//		Reporter.log("AmountOfGain: 3002.00");
//		Reporter.log("NumberOfYears: 3");
//		Reporter.log("LifeInsuranceGainsFromVoidedISAs");
//		Reporter.log("AmountOfGain: 3004.00");
//		Reporter.log("NumberOfYears: 4");
//		Reporter.log("LifeInsuranceGains");
//		Reporter.log("TaxTakenOffGainsFromVoidedISAs: 1001.00");
//		Reporter.log("DeficiencyRelief: 200.00");
//		Reporter.log("StockDistributionsAndLoansWrittenOff");
//		Reporter.log("StockDividends: 1004.00");
//		Reporter.log("BonusIssuesOfSecuritiesAndRedeemableShares: 1005.00");
//		Reporter.log("CloseCompanyLoansWrittenOffOrReleased: 1006.00");
//		Reporter.log("BusinessTaxedIncome");
//		Reporter.log("SA109");
...
//        Reporter.log("AnyOtherInformationSpace:test");
