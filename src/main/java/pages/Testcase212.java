...
public class Testcase212 extends BasePage
{
	public Testcase212 (WebDriver driver)
	{
		super(driver);
	}
...
//
//		Reporter.log("LowerEarner");
//		Reporter.log("HalfMinimumAllowanceTransferToYou: yes");
//		Reporter.log("SpousesName: John");
//
//		Reporter.log("All XML tags checked 1st scenario of MCA page of for Lower income SA 101");

//		 Reporter.log("FinishingYourTaxReturn");
//         
//         Reporter.log("TaxRefundedOrSetOff:1000.00");
//       
//         Reporter.log("NotPaidEnough");
//         
//         Reporter.log("TaxOwedNotToBeCodedOut:yes");
// 
//       
//         Reporter.log("PaidTooMuch");
//         
//         Reporter.log("PaymentDetails");
//           
//         Reporter.log("BankAccountDetails");
//             
//         Reporter.log("BankOrBuildingSocietyName:SBI");
//             
//         Reporter.log("AccountHolderOrNomineeName:Deepika");
//             
//         Reporter.log("BranchSortCode:123444");
//             
//         Reporter.log("AccountNumber:13980001");
//             
//         Reporter.log("BuildingSocietyReferenceNumber:1232");
//          
//           
//         Reporter.log("NomineeDetails");
//             
//         Reporter.log("NomineeNameGiven:yes");
//             
//         Reporter.log("NomineeIsTaxAdviser:yes");
//             
//         Reporter.log("NomineeAddress");
//               
//         Reporter.log("Line:EDGEWARE ROAD");
//               
//         Reporter.log("Line:LONDON");
//               
//         Reporter.log("PostCode:e14 9px");
//           
//       
