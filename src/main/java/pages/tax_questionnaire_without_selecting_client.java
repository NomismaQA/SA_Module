...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/c0077de2-f5e9-46b6-822f-02656061848d
@TestModellerModule(guid = "c0077de2-f5e9-46b6-822f-02656061848d")
public class tax_questionnaire_without_selecting_client extends BasePage
{
	public tax_questionnaire_without_selecting_client (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _Deepika_Automation_client_Elem = By.xpath("//BUTTON[@style='border: none; background: none;']");
