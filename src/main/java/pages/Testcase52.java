...
public class Testcase52 extends BasePage
{
	public Testcase52 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("Foreign credit relief amount verified successfully: " +amtforcreditrelief,true);
		taxFinal=100172.05;
		totalIncomeTaxDue=100172.05;
