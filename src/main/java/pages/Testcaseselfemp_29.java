...
public class Testcaseselfemp_29 extends BasePage
{
	public Testcaseselfemp_29 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
		...
		Reporter.log("Success ! Tax return is validated");
					...
					Reporter.log("DebtsWrittenOff:600");
					 ...
					 Reporter.log("DisallowableCarAndTravelExpenses:50");
					 Reporter.log("DisallowableAdvertisingAndEntertainmentCosts:20");
		                                                Reporter.log (" DisallowableDebtsWrittenOff:30");
					 Reporter.log("DisallowableDepreciationAndLossProfitOnSale:40");
		                                                   Reporter.log("DisallowableOtherBusinessExpenses:10");
		                                                    Reporter.log("DisallowableOtherBusinessExpenses:150");

					 Reporter.log("NetProfitOrLoss:6000");
					 Reporter.log("AdditionsToNetProfitDeductionsFromNetLoss:150");
					 Reporter.log("NetBusinessProfitLossForTax:6150");
		                                                   Reporter.log("AdjustedProfitForTheYear:6150");
