...
public class Testcaseselfemp_26 extends BasePage
{
	public Testcaseselfemp_26 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
		...
		Reporter.log("Success ! Tax return is validated");
					...
					Reporter.log("DebtsWrittenOff:600");
					 ...
					 Reporter.log("DisallowableCarAndTravelExpenses:10");
					 ...
					 Reporter.log("DisallowableDepreciationAndLossProfitOnSale:40");
		                                                   Reporter.log("DisallowableOtherBusinessExpenses:50");
