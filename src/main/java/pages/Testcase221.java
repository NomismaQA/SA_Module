...
public class Testcase221 extends BasePage
{
	public Testcase221 (WebDriver driver)
	{
		super(driver);
	}
...
//        Reporter.log("ClaimToReducePaymentsOnAccount:yes");
//        Reporter.log("FirstPaymentOnAccount:100.00");
