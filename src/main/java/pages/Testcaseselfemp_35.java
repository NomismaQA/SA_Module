...
public class Testcaseselfemp_35 extends BasePage
{
	public Testcaseselfemp_35 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
        Reporter.log("BusinessName:SA-1964 Case 1");
        Reporter.log("BusinessDescription:test123");
        Reporter.log("BusinessAddressFirstLine:ABC BAC ");
        Reporter.log("BusinessAddressPostcode:e14 9px");
        Reporter.log("DateAccountingPeriodStarts:2020-04-06");
        Reporter.log("DateAccountingPeriodEnds:2021-04-05");
        Reporter.log("Turnover:37837.34");
        Reporter.log("OtherBusinessIncome:1000");
          Reporter.log("CostOfGoods:23487.14");
          Reporter.log("CarVanAndTravelExpenses:3256.80");
          Reporter.log("RentAndOtherPropertyCosts:4967.15");
          Reporter.log("RepairsAndMaintenanceCosts:1296.88");
          Reporter.log("PhoneAndOtherOfficeCosts:245.32");
          Reporter.log("BankAndLoanInterest:324.44");
          Reporter.log("OtherFinanceCharges:453.34");
          Reporter.log("AccountancyAndLegalFees:4430.37");
          Reporter.log("DepreciationAndLossProfitOnSale:12107.89");
          Reporter.log("OtherBusinessExpenses:752.51");
          Reporter.log("TotalExpenses:51321.84");
          Reporter.log("DisallowableRepairsAndMaintenanceCosts:10.00");
          Reporter.log("DisallowablePhoneAndOtherOfficeCosts:20.00");
          Reporter.log("DisallowableBankAndLoanInterest:40.00");
          Reporter.log("DisallowableOtherFinanceCharges:50.00");
          Reporter.log("DisallowableAccountancyAndLegalFees:70.00");
          Reporter.log("DisallowableDepreciationAndLossProfitOnSale:12107.89");
          Reporter.log("TotalDisallowableExpenses:12297.89");
      Reporter.log("NetProfitLoss:-12484.50");
        Reporter.log("AdditionsToNetProfitDeductionsFromNetLoss:12297.89");
        Reporter.log("NetBusinessProfitLossForTax:-186.61");
        Reporter.log("ChangeOfAccountingPracticeAdjustment:100.00");
        Reporter.log("AveragingAdjustment:200.00");
        Reporter.log("AdjustedProfitForTheYear:300.00");
        Reporter.log("TotalTaxableBusinessProfits:300.00");
        Reporter.log("AdjustedLossForTheYear:186.61");
        Reporter.log("TotalLossToCarryForward:186.61");
          Reporter.log("EquipmentMachineryVehicles:55483");
          Reporter.log("OtherFixedAssets:24063.00");
          Reporter.log("StockAndWorkInProgress:36200.00");
          Reporter.log("OtherCurrentAssets:5543.45");
          Reporter.log("TotalBusinessAssets:121289.45");
          Reporter.log("LoansAndOverdrafts:22854.50");
          Reporter.log("OtherLiabilities:7180.00");
        Reporter.log("NetBusinessAssets:91254.95");
          Reporter.log("CapitalAccountBalanceAtStart:82143.74");
          Reporter.log("NetProfitOrLoss:-12484.50");
          Reporter.log("CapitalIntroduced:22595.71");
          Reporter.log("CapitalAccountBalanceAtEnd:92254.95");
