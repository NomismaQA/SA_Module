...
public class Testcase84 extends BasePage
{
	public Testcase84 (WebDriver driver)
	{
		super(driver);
	}
...
//		amtReliefForFinanceCosts=total1*reliefFinancerate;
		amtReliefForFinanceCosts=180;
dataReliefForFinanceCosts=180;
...
//		Assert.assertEquals(foreigncreditrelief,amtforcreditrelief) ;
		Notionaltaxamt=842.60;
		amtfornotionaltax=842.60;
