...
public class Testcase166 extends BasePage
{
	public Testcase166 (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinal=(total2);
//		
	deficiencyrelief=3340;
amtdefrelief=3340;
Assert.assertEquals(deficiencyrelief,amtdefrelief) ;
Reporter.log("Amount of Relief For deficiency relief is verified successfully"+amtdefrelief,true);
