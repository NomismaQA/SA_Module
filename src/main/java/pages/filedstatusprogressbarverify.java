...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/5fe36f66-3c9d-4671-b85d-1983b0a4a957
@TestModellerModule(guid = "5fe36f66-3c9d-4671-b85d-1983b0a4a957")
public class filedstatusprogressbarverify extends BasePage
{
	public class java {
	...
	public filedstatusprogressbarverify (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _1_Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[8]/div[2]/div/div/div[5]/div/div/a[1]/div/h3");

	private By more_Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[8]/div[2]/div/div/div[4]/div/div/a[2]/p/u");

	private By InterestElem = By.xpath("/html/body/form/main/div[3]/div[3]/div/div[3]/div/div/table/tbody/tr[1]/th[2]/small");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[3]/div/div/table/tbody"));
		
		List<WebElement> TotalRowCount=eles.findElements(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[3]/div/div/table/tbody/tr[3]"));


		int totalData = TotalRowCount.size();
		
		if(totalData==_acount)			
		{
			Reporter.log("count matched");
			System.out.println("work status:filed count of progress bar matched" +totalData+" "+_acount);
