...
public class Testcase56 extends BasePage
{
	public Testcase56 (WebDriver driver)
	{
		super(driver);
	}
...
//		Notionaltaxamt=8650;
//		amtfornotionaltax=8650;
//		Assert.assertEquals(Notionaltaxamt,amtfornotionaltax) ;
//		Reporter.log("Notional Tax for the year verified successfully: " +amtfornotionaltax,true);
//
//		taxFinal=0;
//		totalIncomeTaxDue=0;
