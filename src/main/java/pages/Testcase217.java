...
public class Testcase217 extends BasePage
{
	public Testcase217 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("CompanyDividends:1000.00");
//        Reporter.log("UnitTrustEtcDividends:100.00");
//        Reporter.log("ForeignDividends;50.00");
//        Reporter.log("TaxTakenOffForeignDividends:20.00");
//        
//        Reporter.log("All XML tags checked INC page - dividend of SA 100");
