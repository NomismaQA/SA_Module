...
public class Testcase204 extends BasePage
{
	public Testcase204 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("SurplusBlindPersonsAllowance: 1000.00");
//		Reporter.log("BlindPersonsAllowance");
//		Reporter.log("RegisteredBlind: yes");
//		Reporter.log("LocalAuthorityName: Liverpool");
//		Reporter.log("SurplusBlindPersonsAllowanceFromSpouse: yes");
//		Reporter.log("All XML tags of MAT OUT and Blind allowance checked");
