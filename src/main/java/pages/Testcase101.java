...
{
	public Testcase101 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("Notional Tax verified successfully: " +amtfornotionaltax,true);
//
		taxFinal=97621.83;
		totalIncomeTaxDue=97621.82;
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at client list and client dashboard verified successfully when work status is Internal Review: " +taxFinalUI,true);
