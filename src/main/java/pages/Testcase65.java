...
public class Testcase65 extends BasePage
{
	public Testcase65 (WebDriver driver)
	{
		super(driver);
	}
...
//		Assert.assertEquals(foreigncreditrelief,amtforcreditrelief) ;
		Notionaltaxamt=1700;
		amtfornotionaltax=1700;
		Assert.assertEquals(Notionaltaxamt,amtfornotionaltax) ;
		Reporter.log("Coronavirus support payments charge verified successfully: " +amtfornotionaltax,true);

		taxFinal=11545.35;
		totalIncomeTaxDue=11545.35;
