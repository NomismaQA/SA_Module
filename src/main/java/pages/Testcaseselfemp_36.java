...
public class Testcaseselfemp_36 extends BasePage
{
	public Testcaseselfemp_36 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
        ...
        Reporter.log("BusinessName:SA-1964 Case 2");
        Reporter.log("BusinessDescription:test");
        ...
        Reporter.log("Turnover:84363.59");
        ...
        Reporter.log("WagesSalariesAndStaffCosts:29668.09");
          ...
          Reporter.log("AccountancyAndLegalFees:1388");
          ...
          Reporter.log("DisallowableCostOfGoods:10.00");
          Reporter.log("DisallowableStaffCosts:30.00");
          Reporter.log("DisallowableCarAndTravelExpenses:40.00");
          Reporter.log("DisallowableRentAndOtherPropertyCosts:50.00");
          Reporter.log("DisallowableRepairsAndMaintenanceCosts:60.00");
          Reporter.log("DisallowablePhoneAndOtherOfficeCosts:70.00");
          Reporter.log("DisallowableAdvertisingAndEntertainmentCosts:80.00");
          Reporter.log("DisallowableBankAndLoanInterest:90.00");
          Reporter.log("DisallowableOtherFinanceCharges:100.00<");
          Reporter.log("DisallowableDebtsWrittenOff:110.00");
          Reporter.log("DisallowableAccountancyAndLegalFees:120.00");
          Reporter.log("DisallowableDepreciationAndLossProfitOnSale:909.45");
          Reporter.log("DisallowableOtherBusinessExpenses:25.00");
          Reporter.log("TotalDisallowableExpenses:1694.45");
      Reporter.log("NetProfitLoss:18908.98");
        Reporter.log("AdditionsToNetProfitDeductionsFromNetLoss:1694.45");
        Reporter.log("NetBusinessProfitLossForTax:20603.43");
        Reporter.log("AdjustedProfitForTheYear:20603.43");
        Reporter.log("TotalTaxableBusinessProfits:20603.43");

          Reporter.log("BankEtcBalances:1290.41");
          Reporter.log("CashInHand:2950.69");

          Reporter.log("EquipmentMachineryVehicles:2735.33");

          Reporter.log("StockAndWorkInProgress:7500");
          Reporter.log("OtherCurrentAssets:51.34");
          Reporter.log("TotalBusinessAssets:14527.77");

          Reporter.log("OtherLiabilities:3630.61");
        Reporter.log("NetBusinessAssets:10897.16");
          Reporter.log("CapitalAccountBalanceAtStart:86760.46");
          Reporter.log("NetProfitOrLoss:-18908.98");
          Reporter.log("Drawings:13772.28");
          Reporter.log("CapitalAccountBalanceAtEnd:11897.16");
