...
public class Testcaseselfemp_17 extends BasePage
{
	public Testcaseselfemp_17 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("Tax year : 2020-21");
//		Reporter.log("Turnover after linking:77880");
//		Reporter.log("Other income:20000");
//		Reporter.log("Success ! Tax return is validated");
//					Reporter.log("AllowableBusinessExpenses");
//					Reporter.log("CostOfGoods:8175");
//					Reporter.log("CarVanAndTravelExpenses:-1530");
//					Reporter.log("WagesSalariesAndStaffCosts:50000");
//					Reporter.log("RentAndOtherPropertyCosts:23600");
//					Reporter.log("RepairsAndMaintenanceCosts:240");
//					Reporter.log("AccountancyAndLegalFees:200");
//		            Reporter.log("AdvertisingAndEntertainmentCosts:150");
//		            Reporter.log("BankAndLoanInterest:295");
//		            Reporter.log("OtherFinanceCharges:65.75");
//					 Reporter.log("InterestAndFinanceCharges:360.75");
//					 Reporter.log("PhoneAndOtherOfficeCosts:640");
//		          Reporter.log("OtherBusinessExpenses:18310");
//					 Reporter.log("TotalExpenses:100096.25");
//					 Reporter.log("OtherAllowableBusinessExpenses:1510");
//					 Reporter.log("TotalAllowableExpenses:1510");
//		            Reporter.log (" AdditionsToNetProfitDeductionsFromNetLoss:1510");
//					 Reporter.log("AllowableBusinessExpenses");
//					 Reporter.log("NetProfitOrLoss:706.25");
//					 Reporter.log("AnyOtherBusinessIncome:706.25");
//					 Reporter.log("TotalLossToCarryForward:706.25");
//		               Reporter.log("CashInHand:16407.50");
//		              Reporter.log("OtherCurrentAssets:19160");
//		               Reporter.log("TotalBusinessAssets:35567.50");
//		               Reporter.log("OtherLiabilities:40000");
//		                Reporter.log("NetBusinessAssets:-4432.50");
//		               Reporter.log("NetProfitOrLoss:-2216.25");
//		                Reporter.log("CapitalAccountBalanceAtEnd:-2216.25");
//		                Reporter.log("linking verified with new ledger codes and manual scenario for full form");
					
		Reporter.log("Turnover:16800");
		Reporter.log("Success ! Tax return is validated");
					Reporter.log("AllowableBusinessExpenses");
					
					Reporter.log("CarVanAndTravelExpenses:-650");
					
					Reporter.log("DebtsWrittenOff:600");
					
		                                                 Reporter.log("AdvertisingAndEntertainmentCosts:550");
		                                                 Reporter.log("BankAndLoanInterest:295");
		                                                    Reporter.log("DepreciationAndLossProfitOnSale:2350");
					
		                                                Reporter.log("OtherBusinessExpenses:6650");
					 Reporter.log("TotalExpenses:10800");
					 Reporter.log("DisallowableCarAndTravelExpenses:100");
					 Reporter.log("DisallowableAdvertisingAndEntertainmentCosts:200");
		                                                Reporter.log (" DisallowableDebtsWrittenOff:300");
					 Reporter.log("DisallowableDepreciationAndLossProfitOnSale:400");
		                                                   Reporter.log("DisallowableOtherBusinessExpenses:500");
		                                                    Reporter.log("DisallowableOtherBusinessExpenses:1500");

					 Reporter.log("NetProfitOrLoss:6000");
					 Reporter.log("AdditionsToNetProfitDeductionsFromNetLoss:1500");
					 Reporter.log("NetBusinessProfitLossForTax:7500");
		                                                   Reporter.log("AdjustedProfitForTheYear:7500");
		 Reporter.log("TotalTaxableBusinessProfits:7500");
		                                                Reporter.log("OtherCurrentAssets:6000");
		                                              Reporter.log("TotalBusinessAssets:6000");
		                                               
		                                                Reporter.log("NetBusinessAssets:-6000");
		                                                   Reporter.log("NetProfitOrLoss:-6000");
		                                                       Reporter.log("CapitalAccountBalanceAtEnd:-6000");
		                                                       Reporter.log("Disallowable expenses amount verified");
