...
public class Testcase175 extends BasePage
{
	public Testcase175 (WebDriver driver)
	{
		super(driver);
	}
...
//		Assert.assertEquals(foreigncreditrelief,amtforcreditrelief) ;
		Notionaltaxamt=27000;
		amtfornotionaltax=27000;
