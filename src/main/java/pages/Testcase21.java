...
public class Testcase21 extends BasePage
{
	public Testcase21 (WebDriver driver)
	{
		super(driver);
	}
...
//Reporter.log("SA101");
//Reporter.log("SharesEmploymentCompensationsAndDeductions");
//Reporter.log("ShareSchemesTaxableAmount: 2001.00");
//Reporter.log("LumpSums");
//Reporter.log("LumpSumSalariesAndOtherPayments: 2002.00");
//Reporter.log("LumpSumsOrBenefitsFromRetirementSchemes: 2003.00");
//Reporter.log("RedundancyAndOtherCompensationPayments: 2004.00");
//Reporter.log("TaxTakenOff: 2005.00");
//
//Reporter.log("CompensationAndLumpSumExemption: 2007.00");
//Reporter.log("DisabilityAndForeignServiceDeduction: 2008.00");
//Reporter.log("SeafarersEarningsDeduction: 2009.00");
//Reporter.log("NonUKTaxableForeignEarnings: 2010.00");
//Reporter.log("ForeignTaxNoForeignTaxCreditReliefClaim: 2011.00");
//Reporter.log("OverseasPensionExemptEmployerContributions: 2012.00");
//Reporter.log("UKpatentRoyaltyPaymentsMade: 2013.00");
//
//Reporter.log("All XML tags checked ASE page of SA 101");
...
//Reporter.log("TradingIncomeAllowance:100.00");
//Reporter.log("NetProfitOrLoss:33296");
//   
//          Reporter.log("NetBusinessProfitForTax:33296");
//       
//          Reporter.log("TotalTaxableBusinessProfits:33296");
