...
public class Testcase22 extends BasePage
{
	public Testcase22 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log(" COVIDincorrectlyClaimed");
//        Reporter.log("CJRScharge:1000.00");
//        Reporter.log("SEISScharge:2000.00");
