...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/b9830cb8-1b5a-4ef4-85b0-d670debf7bbb
@TestModellerModule(guid = "b9830cb8-1b5a-4ef4-85b0-d670debf7bbb")
public class Total_countto_be_filed_verification extends BasePage
{
	public Total_countto_be_filed_verification (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _0Elem = By.xpath("//A[@id='ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl00_btnTobeFiled']");

	private By xPath_idctl00_ctl00_ParentContent_cPH_PageUC1_rptrPager_ctl03_lnkNextElem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[2]/ul/li[3]/a");

	private By _0_1Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table/tfoot/tr/td[10]/b");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table"));
		...
		List<WebElement> TotalRowCount = eles.findElements(By.xpath("//div[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]//div/table/tbody//tr/td[10]"));
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table"));
     ...
     * @name Click  0
     */
	public void Click__0_1()
	{
        
		WebElement elem = getWebElement(_0_1Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__0_1", "Click__0_1 failed. Unable to locate object: " + _0_1Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__0_1", "Click__0_1 failed. Unable to locate object: " + _0_1Elem.toString());

			Assert.fail("Unable to locate object: " + _0_1Elem.toString());
        }
		String txt= elem.getText();
		_acount=Integer.parseInt(txt);
		
		System.out.println("total count:To be filed matched" +_acount);

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click__0_1");

		TestModellerLogger.PassStep(m_Driver, "Click__0_1");
	}
}