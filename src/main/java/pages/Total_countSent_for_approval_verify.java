...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/fd63af83-2b92-4832-8b81-4c266c509cc6
@TestModellerModule(guid = "fd63af83-2b92-4832-8b81-4c266c509cc6")
public class Total_countSent_for_approval_verify extends BasePage
{
	public Total_countSent_for_approval_verify (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _0Elem = By.xpath("//A[@id='ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl00_LinkButtonEx6']");
	...
	private By _1_Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table/tfoot/tr/td[9]/b");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table"));
		...
		List<WebElement> TotalRowCount = eles.findElements(By.xpath("//div[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]//div/table/tbody//tr/td[9]"));
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table"));
	...
	public void Click__1_()
	{
		...
		System.out.println("total count:Sent for approval matched" +_acount);
