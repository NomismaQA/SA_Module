...
public class Testcaseselfemp_55 extends BasePage
{
	public Testcaseselfemp_55 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
		...
		Reporter.log("Turnover:8242.80");
        Reporter.log("PhoneAndOtherOfficeCosts:1226.36");
        Reporter.log("OtherFinanceCharges:2099.71");
        Reporter.log("AccountancyAndLegalFees:107.10");
        Reporter.log("TotalExpenses:3433.17");
    Reporter.log("NetProfitLoss:4809.63");
      Reporter.log("NetBusinessProfitLossForTax:4809.63");
      Reporter.log("SEISSgrant:3254.00");
      Reporter.log("AdjustedProfitForTheYear:8063.63");
      Reporter.log("TotalTaxableBusinessProfits:8063.63");
        Reporter.log("NetProfitOrLoss:4809.63");
        Reporter.log("CapitalAccountBalanceAtEnd:4809.63");
        Reporter.log("Expenditure at self emp UI:3433.17");
        Reporter.log("Amount of Bank, credit card and other financial charges verified at UI:3433.17");
