...
public class Testcase110 extends BasePage
{
	public Testcase110 (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinal=-1196.4;
//		totalIncomeTaxDue=-1196.4;
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at work pool and client dashboard verified successfully when work status is failed: " +taxFinalUI,true);
