...
public class Testcase25 extends BasePage
{
	public Testcase25 (WebDriver driver)
	{
		super(driver);
	}
...
//		amtReliefForFinanceCosts=total1*reliefFinancerate;
		amtReliefForFinanceCosts=720;
dataReliefForFinanceCosts=720;
