...
public class Testcase210 extends BasePage
{
	public Testcase210 (WebDriver driver)
	{
		super(driver);
	}
...
//
//		Reporter.log("SA101");
//		Reporter.log("HigherEarner");
//		Reporter.log("SpousesName: Jenny");
//		Reporter.log("SpousesDateOfBirth: 1935-04-05");
//		Reporter.log("HalfMinimumAllowanceTransferToOther: yes");
//		Reporter.log("PreviousSpousesDateOfBirth: 1965-05-05");
//		Reporter.log("AgeRelatedMarriedCouplesAllowance");
//		Reporter.log("DateOfMarriageOrCivilPartnership: 2019-06-06");
//		Reporter.log("SurplusAllowanceFromSpouse: yes");
//
//		Reporter.log("SurplusAllowances");
//		Reporter.log("SurplusMarriedCouplesAllowance: 1000.00");
//
//		Reporter.log("All XML tags checked 1st scenario of MCA page of SA 101");
		
//		 Reporter.log("SA103F");
//         Reporter.log("BusinessDetails");
//           Reporter.log("BusinessDescription:test");
//          
//           Reporter.log("DateBusinessBooksAreMadeUpTo:2021-04-05");
//        
//           Reporter.log("Turnover:33396.00");
//        
//           Reporter.log("CostOfGoods:4752.89");
//           Reporter.log("CarVanAndTravelExpenses:2516.86");
//           Reporter.log("RentAndOtherPropertyCosts:2703.45");
//           Reporter.log("RepairsAndMaintenanceCosts:4561.20");
//           Reporter.log("AccountancyAndLegalFees:322.00");
//           Reporter.log("PhoneAndOtherOfficeCosts:1726.21");
//           Reporter.log("OtherAllowableBusinessExpenses:1299.03");
//           Reporter.log("TotalAllowableExpenses:17881.64");
//        
//         Reporter.log("NetProfitOrLoss:15514.36");
//    
//           Reporter.log("NetBusinessLossForTax:15514.36");
//        
//           Reporter.log(" TotalLossToCarryForward:2000.00");
