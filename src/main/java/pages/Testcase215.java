...
public class Testcase215 extends BasePage
{
	public Testcase215 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log(" Employment");
//        Reporter.log("PayFromEmployment:10000.00");
//        Reporter.log("TaxTakenOffPay:1500.00");
//        Reporter.log("TipsAndOtherPayments:100.00");
//         Reporter.log("EmployerPAYEReference:456/456");
//         Reporter.log("EmployersName-BFD TECH LTD");
//         Reporter.log("CompanyDirector:no");
//      
//       Reporter.log("Benefits");
//         Reporter.log("CompanyCarsAndVansBenefit:10.00");
//         Reporter.log("FuelForCarsAndVans-20.00");
//         Reporter.log("PrivateMedicalDentalInsurance:30.00");
//         Reporter.log("VouchersCreditCardsExcessMileageAllowance:40.00");
//         Reporter.log("GoodsEtcProvidedByEmployer:50.00");
//         Reporter.log("AccommodationProvidedByEmployer:60.00");
//         Reporter.log("OtherBenefits:70.00");
//         Reporter.log("ExpensesPaymentsReceived:80.00");
//      
//       Reporter.log("Expenses");
//         Reporter.log("BusinessTravelAndSubsistence:10.00");
//         Reporter.log("FixedExpensesDeductions:20.00");
//         Reporter.log("ProfessionalFeesAndSubscriptions:30.00");
//         Reporter.log("OtherExpensesAndCapitalAllowances:40.00");
...
//          Reporter.log("FurnishedHolidayLettingsIncome:1000.00");
//          Reporter.log("FurnishedHolidayLettingsExpenses:2000.00");
//          Reporter.log("LossForYear:1000.00");
