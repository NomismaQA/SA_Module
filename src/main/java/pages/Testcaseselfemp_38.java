...
public class Testcaseselfemp_38 extends BasePage
{
	public Testcaseselfemp_38 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
		Reporter.log("Tax year : 2020-21");
		   Reporter.log("Turnover:89880");
           Reporter.log("OtherBusinessIncome:20000");
             Reporter.log("CostOfGoods:6500");
             Reporter.log("CarVanAndTravelExpenses:95");
             Reporter.log("RentAndOtherPropertyCosts:23600");
             Reporter.log("PhoneAndOtherOfficeCosts:640");
             Reporter.log("AdvertisingAndEntertainmentCosts:120.00");
             Reporter.log("AccountancyAndLegalFees:150.50");
             Reporter.log("Bank, credit card and other financial charges:65.75");
             Reporter.log("Repairs and maintenance of property and equipment:240");
             Reporter.log("DepreciationAndLossProfitOnSale:30000");
             Reporter.log("OtherBusinessExpenses:18310");
             Reporter.log("TotalExpenses:130096.25");
             Reporter.log("TotalDisallowableExpenses:31510");
         Reporter.log("NetProfitLoss:20216.25");
           Reporter.log("AdditionsToNetProfitDeductionsFromNetLoss:31510");
           Reporter.log("NetBusinessProfitLossForTax:11293.75");
           Reporter.log("AdjustedProfitForTheYear:11293.75");
           Reporter.log("TotalTaxableBusinessProfits:11293.75");
           Reporter.log("EquipmentMachineryVehicles:-30000");
             Reporter.log("TotalBusinessAssets:66580");
             Reporter.log("OtherLiabilities:86796.25");
           Reporter.log("NetBusinessAssets:-20216.25");
           
             Reporter.log("CapitalAccountBalanceAtEnd:20216.25");
Reporter.log("Message at self emp UI:Error! Value in box 83 can not be negative, please check the input in bookkeeping module.");
Reporter.log("Message at validate:Error! Value in box 83 can not be negative, please check the input in bookkeeping module.");
Reporter.log("Message at submit to hmrc:Error! Value in box 83 can not be negative, please check the input in bookkeeping module.");
