...
public class Testcase108 extends BasePage
{
	public Testcase108 (WebDriver driver)
	{
		super(driver);
	}
...
//		Notionaltaxamt=19000;
//		amtfornotionaltax=19000;
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at client list and client dashboard verified successfully when work status is submitted: " +taxFinalUI,true);
