...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/0da9d70a-746e-4b3d-af60-3ddc8bd4e9e1
@TestModellerModule(guid = "0da9d70a-746e-4b3d-af60-3ddc8bd4e9e1")
public class inprogressworkstatusverification extends BasePage
{
	public inprogressworkstatusverification (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _0Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl00_lnkInProgress\"]");
