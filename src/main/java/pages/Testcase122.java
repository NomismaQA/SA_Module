...
public class Testcase122 extends BasePage
{
	public Testcase122 (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at work pool and client dashboard verified successfully when work status is To be filed: " +taxFinalUI,true);
