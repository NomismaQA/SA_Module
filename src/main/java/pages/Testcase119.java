...
public class Testcase119 extends BasePage
{
	public Testcase119 (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at work pool and client dashboard verified successfully when work status is Internal Review: " +taxFinalUI,true);
// 
