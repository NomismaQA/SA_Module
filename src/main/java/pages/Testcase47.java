...
public class Testcase47 extends BasePage
{
	public Testcase47 (WebDriver driver)
	{
		super(driver);
	}
...
//		amtReliefForFinanceCosts=total1*reliefFinancerate;
		amtReliefForFinanceCosts=208;
dataReliefForFinanceCosts=208;
