...
public class Testcase117 extends BasePage
{
	public Testcase117 (WebDriver driver)
	{
		super(driver);
	}
...
//		Notionaltaxamt=26400;
//		amtfornotionaltax=26400;
...
////		
//		Notionaltaxamt=18250;
//		amtfornotionaltax=18250;
//		Assert.assertEquals(Notionaltaxamt,amtfornotionaltax) ;
//		Reporter.log("Top slicing relief verified successfully: " +amtfornotionaltax,true);
//
//
		taxFinal=5410;
		totalIncomeTaxDue=5410;
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at work ppol and client dashboard verified successfully when work status is filed: " +taxFinalUI,true);
