...
public class Testcase213 extends BasePage
{
	public Testcase213 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("AllMinimumAllowanceTransferToYou: yes");
//		Reporter.log("SpousesName: Jonny");
//
//		Reporter.log("All XML tags checked 2nd scenario of MCA page of for Lower income SA 101");
//		 Reporter.log("SA105");
//         Reporter.log("UKPropertyDetails");
//           Reporter.log("NumberOfProperties:1");
//         
//         Reporter.log("FurnishedHolidayLettings");
//           Reporter.log("FurnishedHolidayLettingsIncome:5400.00");
//           Reporter.log("FurnishedHolidayLettingsExpenses:6400.00");
