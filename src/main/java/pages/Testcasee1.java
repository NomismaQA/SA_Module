...
public class Testcasee1 extends BasePage
{
	public Testcasee1 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("Notinal Tax verified succiessfully: " +amtfornotionaltax,true);

		taxFinal=10.27;
		totalIncomeTaxDue=10.27;
