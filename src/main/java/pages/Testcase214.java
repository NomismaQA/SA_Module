...
public class Testcase214 extends BasePage
{
	public Testcase214 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("AdditionalInformationSchedule: yes");
//
//		Reporter.log("OtherInformation");
//		Reporter.log("IncomeTaxLosses");
//		Reporter.log("EarlierYearsIncomeTaxLosses: 1000.00");
//		Reporter.log("UnusedIncomeTaxLossesCarriedForward: 450.00");
//		Reporter.log("NextYearsTradingAndCapitalLossesRelief: 452.00");
//		Reporter.log("NextYearsUncappedLossRelief: 451.00");
//		Reporter.log("YearForWhichReliefClaimed: 2019-20");
//
//		Reporter.log("AmountOfPayrollGiving: 200.00");
//
//		Reporter.log("PensionTaxAndLumpSums");
//		Reporter.log("LumpSumPensionBenefitsInExcessOfALA: 400.00");
//		Reporter.log("NonlumpSumPensionBenefitsExceedingALA: 401.00");
//		Reporter.log("LifetimeAllowanceTaxPaid: 402.00");
//		Reporter.log("AmountSavedExceedingAnnualAllowance: 404.00");
//		Reporter.log("AnnualAllowanceTaxPaidByPensionScheme: 403.00");
//		Reporter.log("PensionBenefitTransferredSubjectToOTC: 406.00");
//		Reporter.log("TaxPaidByPensionSchemeOnOTC: 405.00");
//		Reporter.log("PensionSchemeTaxRef: 12345678AB");
//		Reporter.log("UnauthorisedPaymentNotSubjectToSurcharge: 407.00");
//		Reporter.log("UnauthorisedPaymentSubjectToSurcharge: 408.00");
//		Reporter.log("ForeignTaxPaidOnUnauthorisedPayment: 409.00");
//		Reporter.log("OverseasPensionContributionShortServiceRefund: 410.00");
//		Reporter.log("ForeignTaxPaid: 411.00");
//
//		Reporter.log("TaxAvoidanceSchemes");
//		Reporter.log("TaxAvoidanceSchemeReferenceNumber: 12345678");
//		Reporter.log("ExpectedAdvantageTaxYear: 2019-20");
//
//		Reporter.log("DisguisedRemuneration");
//		Reporter.log("NonPAYEDRemploymentIncome: 201.00");
//		Reporter.log("DRceasedSelfempAndPshipIncome: 202.00");
//		Reporter.log("DRceasedSelfempAndPshipIncomeCarriedBack: 203.00");
//		Reporter.log("TaxYearIncomeToBeTaxed: 2019-20");
//
//		Reporter.log("All XML tags checked of AIL Page");
