...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/d13e69e6-b615-4d69-b17c-929a8fdc806b
@TestModellerModule(guid = "d13e69e6-b615-4d69-b17c-929a8fdc806b")
public class responsereceviedstatusverification extends BasePage
{
	public responsereceviedstatusverification (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _1Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl00_lnkTCSubmitted\"]");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[3]/div/div/div/div/table"));
		...
		if(totalData==_acount)			
		{
			...
			System.out.println("work status:Response received count matched" +totalData+" "+_acount);
