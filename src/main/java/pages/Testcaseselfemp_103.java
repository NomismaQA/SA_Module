...
public class Testcaseselfemp_103 extends BasePage
{
	public Testcaseselfemp_103 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
		...
		Reporter.log("Input 1 for  partnership UI:55000");
        Reporter.log("Date of birth:06/04/1954");
        
        Reporter.log("Input 2 for partnership UI:55000");
       
        Reporter.log("Exempt from Class 4 NIC is checked at partnership,verified ");
