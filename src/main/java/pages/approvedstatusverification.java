...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/c1770038-def6-444f-b39c-3c1952d1e535
@TestModellerModule(guid = "c1770038-def6-444f-b39c-3c1952d1e535")
public class approvedstatusverification extends BasePage
{
	public approvedstatusverification (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _1Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_rptrAccountantSummary_ctl00_lnkApproved\"]");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[3]/div/div/div/div/table"));
		...
		if(totalData==_acount)			
		{
			...
			System.out.println("work status:approved  count matched" +totalData+" "+_acount);
