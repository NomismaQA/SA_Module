...
public class Testcase109 extends BasePage
{
	public Testcase109 (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at client list and client dashboard verified successfully when work status is In progress: " +taxFinalUI,true);
