...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/6abc24c7-c4b6-4d11-a5b1-8904cfe7e916
@TestModellerModule(guid = "6abc24c7-c4b6-4d11-a5b1-8904cfe7e916")
public class reminderatacclevelwithoutmessagebody extends BasePage
{
	public reminderatacclevelwithoutmessagebody (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _Dummy_1_Elem = By.xpath("//*[@id=\"step-1\"]/div/div[2]/div/div/table/tbody[2]/tr[1]/td[2]/button");

	private By Next_Elem = By.xpath("//*[@id=\"NextLink\"]");

	private By _Elem = By.xpath("BODY[marginwidth='\\30 ']");
