...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/a8e6c697-71a3-4b6e-8bfe-73071b046092
@TestModellerModule(guid = "a8e6c697-71a3-4b6e-8bfe-73071b046092")
public class total_countquestionnaire_sent_verify extends BasePage
{
	public total_countquestionnaire_sent_verify (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _18Elem = By.xpath("//A[contains(text(),'18')]");

	private By xPath_idctl00_ctl00_ParentContent_cPH_PageUC1_rptrPager_ctl03_lnkNextElem = By.xpath("//A[@id='ctl00_ctl00_ParentContent_cPH_PageUC1_rptrPager_ctl03_lnkNext']");

	private By _42_Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table/tfoot/tr/td[4]/b");
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table"));
		...
		List<WebElement> TotalRowCount = eles.findElements(By.xpath("//div[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]//div/table/tbody//tr/td[4]"));
...
WebElement eles= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_divSubContent\"]/div[9]/div[2]/div/div[1]/div/table"));
     ...
     * @name Click  42 
     */
	public void Click__42_()
	{
        
		WebElement elem = getWebElement(_42_Elem);

		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Click__42_", "Click__42_ failed. Unable to locate object: " + _42_Elem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Click__42_", "Click__42_ failed. Unable to locate object: " + _42_Elem.toString());

			Assert.fail("Unable to locate object: " + _42_Elem.toString());
        }
		
		String txt= elem.getText();
		_acount=Integer.parseInt(txt);
		
		System.out.println("total count:not started matched" +_acount);

		elem.click();
          	

		ExtentReportManager.passStep(m_Driver, "Click__42_");

		TestModellerLogger.PassStep(m_Driver, "Click__42_");
	}
}