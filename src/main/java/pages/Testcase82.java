...
public class Testcase82 extends BasePage
{
	public Testcase82 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log(" IR Mark when tax return is blank: ULHIMG2ELPBT4ZEN5JGSSW3SDBZRVNWY");
//
//		Reporter.log(" IR Mark when 1st validation done : ULHIMG2ELPBT4ZEN5JGSSW3SDBZRVNWY");
		
//		Reporter.log("Tax year :2020-21");
//
//		Reporter.log("Work status:Not started");

//		Reporter.log(" Amount in Pay from this employment after  linking :3000");
//		Reporter.log(" Amount in UK tax taken off pay after  linking :100.6");
//		Reporter.log(" Amount in Payroll section of employment for tax year 2020-21:3000");
//		Reporter.log(" Amount in Payroll section of tax for tax year 2020-21:100.6");
//		
//		Reporter.log("Amount of SA and payroll section verified:3000");
//		Reporter.log("Amount of SA and payroll section verified:100.6");
//		Reporter.log("Tax return validated:Success! Tax return is validated");
//		Reporter.log("	tag for tax year 2020-21 verified:PayFromEmployment:3000");
//		Reporter.log("	tag for tax year 2020-21 verified:TaxTakenOffPay:100.6");
//		Reporter.log("Tax return is unlocked");
//		Reporter.log(" Refreshed Amount in Payroll section of employment for tax year 2020-21:6000");
//		Reporter.log(" Refreshed Amount in Payroll section of tax for tax year 2020-21:200.6");
//		Reporter.log("Amount of SA and payroll section verified:6000");
//		Reporter.log("Amount of SA and payroll section verified:200.6");
//		Reporter.log("Tax return validated:Success! Tax return is validated");
//		Reporter.log("	tag for tax year 2020-21 verified:PayFromEmployment:6000");
//		Reporter.log("	tag for tax year 2020-21 verified:TaxTakenOffPay:200.6");
...
//		Reporter.log(" Amount in Partnership tax return section for tax year 2020-21:32500");
...
//		
		...
		Reporter.log("Turnover:83363.59");
