...
public class Testcase206 extends BasePage
{
	public Testcase206 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("Pensions");
//		Reporter.log("PaymentsToRegisteredPensionSchemes: 1000.00");
//		Reporter.log("RetirementAnnuityContractPayments: 1001.00");
//		Reporter.log("EmployerPensionSchemePayments: 1002.00");
//		Reporter.log("NonUKOverseasPensionSchemePayments: 1003.00");
//
//		Reporter.log("CharitableGiving");
//		Reporter.log("GiftAidPaymentsMadeInYear: 500.00");
//		Reporter.log("OneOffGiftAidPayments: 100.00");
//		Reporter.log("GiftAidPaymentsCarriedBackToPreviousYear: 105.00");
//		Reporter.log("GiftAidPaymentsBroughtBackFromLaterYear: 106.00");
//		Reporter.log("SharesGiftedToCharity: 2000.00");
//		Reporter.log("LandAndBuildingsGiftedToCharity: 1999.00");
//		Reporter.log("InvestmentsGiftedToNonUKCharities: 1998.00");
//		Reporter.log("DonationsToNonUKCharities: 50.00");
//
//		Reporter.log("HighIncomeChildBenefitCharge");
//		Reporter.log("AmountReceived: 500000.00");
//		Reporter.log("NumberOfChildren: 2");
//		Reporter.log("DateStoppedReceivingAllChildBenefitPayments: 2020-01-01");
//		Reporter.log("REL and CBC XML tags checked of SA100");
//		
//		 Reporter.log("SA103F");
//         Reporter.log("BusinessDetails");
//           Reporter.log("BusinessName:Sole trader new case 1");
//           Reporter.log("BusinessDescription:new");
//     
//         Reporter.log("DateAccountingPeriodStarts:2019-11-06");
//           Reporter.log("DateAccountingPeriodEnds:2020-10-31");
//       
//         Reporter.log("BusinessIncome");
//           Reporter.log("Turnover:4363.59");
//        
//         Reporter.log("BusinessExpenses");
//           Reporter.log("TotalExpenses");
//             Reporter.log("CostOfGoods>11663.71");
...
//             Reporter.log("AdvertisingAndEntertainmentCosts:278.40");
//             Reporter.log("OtherFinanceCharges:654.01");
//             Reporter.log("AccountancyAndLegalFees:1388.00");
//             Reporter.log("DepreciationAndLossProfitOnSale:911.45");
//             Reporter.log("OtherBusinessExpenses:5867.97");
//             Reporter.log("TotalExpenses>66454.61");
//       
//           Reporter.log("DisallowableExpenses");
//             Reporter.log("DisallowableDepreciationAndLossProfitOnSale:911.45");
//             Reporter.log("DisallowableOtherBusinessExpenses:22.00");
//             Reporter.log("TotalDisallowableExpenses:933.45");
//          
//         Reporter.log("NetProfitLoss:17908.98");
//         Reporter.log("CapitalAllowances ");
//         Reporter.log("TaxableProfitOrLoss");
//           Reporter.log("AdditionsToNetProfitDeductionsFromNetLoss:933.45");
//           Reporter.log("NetBusinessProfitLossForTax:18842.43");
//           Reporter.log("AdjustedProfitForTheYear:18842.43");
//           Reporter.log("TotalTaxableBusinessProfits:18842.43");
//   
//           Reporter.log("Assets");
//             Reporter.log("EquipmentMachineryVehicles:2735.33");
//             Reporter.log("StockAndWorkInProgress:7500.00");
//             Reporter.log("BankEtcBalances:790.41");
//            Reporter.log(");CashInHand>:2950.69");
//             Reporter.log("OtherCurrentAssets:11.34");
//             Reporter.log("TotalBusinessAssets:13987.77");
//          
//           Reporter.log("Liabilities");
//             Reporter.log("OtherLiabilities:3090.61");
//         
//           Reporter.log("NetBusinessAssets:10897.16");
//          
//             Reporter.log("CapitalAccountBalanceAtStart:6760.46");
//             Reporter.log("NetProfitOrLoss:17908.98");
//             Reporter.log("Drawings:13772.28");
//             Reporter.log("CapitalAccountBalanceAtEnd:10897.16");
