...
public class Testcase116 extends BasePage
{
	public Testcase116 (WebDriver driver)
	{
		super(driver);
	}
...
//		Notionaltaxamt=24000;
//		amtfornotionaltax=24000;
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at work pool and client dashboard verified successfully when work status is filed: " +taxFinalUI,true);
