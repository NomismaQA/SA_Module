...
public class Testcase40new extends BasePage
{
	public Testcase40new (WebDriver driver)
	{
		super(driver);
	}
...
//		amtReliefForFinanceCosts=53.40;
//		dataReliefForFinanceCosts=53.40;
...
////		foreigncreditrelief=2261.67;
////		amtforcreditrelief=2261.67;
//		taxFinal=8374.56;
//		totalIncomeTaxDue=8374.56;
...
//		taxFinal=3803.6;
//		totalIncomeTaxDue=3803.6;
//				taxFinalUI= totalIncomeTaxDue;
//				Assert.assertEquals(taxFinalUI,taxFinal);
//				Reporter.log("Tax due at client list and client dashboard verified successfully when work status is failed: " +taxFinalUI,true);
