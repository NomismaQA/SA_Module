...
public class Testcase134 extends BasePage
{
	public Testcase134 (WebDriver driver)
	{
		super(driver);
	}
...
//		d1= (taxDueInc-nilRate1)*BR_rate;
		t1=21759.60;
		Incometaxdue=21759.60;
		t2= Incometaxdue;
		
		Assert.assertEquals(t2,t1);
		Reporter.log("Income tax due verified successfully: " +t2,true);
//		Reporter.log(" IR Mark when 1st input done : Z6OXWVE4PT6UIB63DBKSNIJX6S4S4DD4");
//		total1 = n8 + n9;
