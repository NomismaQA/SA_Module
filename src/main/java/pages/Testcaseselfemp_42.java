...
public class Testcaseselfemp_42 extends BasePage
{
	public Testcaseselfemp_42 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
		...
		Reporter.log("Other income:2000");
		Reporter.log("Success ! Tax return is validated");
		          ...
		          Reporter.log("OtherBusinessExpenses:18310");
		            ...
		            Reporter.log (" AdditionsToNetProfitDeductionsFromNetLoss:1510");
					 Reporter.log("AllowableBusinessExpenses");
					 Reporter.log("NetProfitOrLoss:7306.25");
					 Reporter.log("AnyOtherBusinessIncome:7306.25");
					 Reporter.log("TotalLossToCarryForward:7306.25");
