...
public class Testcase216 extends BasePage
{
	public Testcase216 (WebDriver driver)
	{
		super(driver);
	}
...
//		amtReliefForFinanceCosts=1944.60;
//dataReliefForFinanceCosts=1944.60;
...
//		Reporter.log("SA106");
//		Reporter.log("UnremittableIncome: yes");
//		Reporter.log("ForeignTaxCreditRelief: 222.00");
//		Reporter.log("ResidentialPropertyIncomeOrRestrictedFinanceCosts: 1.00");
//		Reporter.log("UnusedTOAAresidentialFinanceCostsBroughtForward: 2.00");
//		Reporter.log("TotalAdjustedProfitOrLoss: 100.00");
//		Reporter.log("LossBroughtForward: 50.00");
//		Reporter.log("TotalTaxableProfit: 50.00");
//		Reporter.log("TotalForeignTaxTakenOff: 2.00");
//		Reporter.log("TotalSpecialWithholdingTax: 1.00");
//		Reporter.log("TotalTaxableAmount: 50.00");
//		Reporter.log("LossToCarryForward: 9.00");
//
//		Reporter.log("OverseasSavings");
//		Reporter.log("IncomeSource");
//		Reporter.log("CountryCode: AFG");
//		Reporter.log("IncomeBeforeTax: 10.00");
//		Reporter.log("ForeignTax: 2.00");
//		Reporter.log("SpecialWithholdingTax: 4.00");
//		Reporter.log("ClaimToFTCR: yes");
//		Reporter.log("TaxableAmountOnInterestAndOtherSavings: 10.00");
//
//		Reporter.log("Totals");
//		Reporter.log("SWTOrUKTax: 4.00");
//		Reporter.log("TaxableAmount: 10.00");
//
//		Reporter.log("OverseasLandAndPropertyIncomeDetails");
//		Reporter.log("TotalRentsAndOtherPropertyReceipts: 3555.00");
//		Reporter.log("NumberOfProperties: 2");
//		Reporter.log("PremiumsPaidForLease: 12.00");
//		Reporter.log("AllowablePropertyExpenses: 123.00");
//		Reporter.log("NetProfitOrLoss: 3444.00");
//		Reporter.log("PrivateUseAdjustment: 11.00");
//		Reporter.log("BalancingCharges: 2.00");
//		Reporter.log("CapitalAllowances: 3.00");
//		Reporter.log("ZeroEmissionGoodsVehicleAllowance: 4.00");
//		Reporter.log("TheStructuresAndBuildingsAllowance: 6.00");
//		Reporter.log("ElectricChargePointAllowance: 10.00");
//		Reporter.log("CostsOfReplacingDomesticItems: 11.00");
//		Reporter.log("AdjustedProfitOrLossForTheYear: 3423.00");
//		Reporter.log("ResidentialFinanceCosts: 12.00");
//
//		Reporter.log("ChargeableGainsUKRules");
//		Reporter.log("ChargeableGains: 22.00");
//		Reporter.log("NumberOfDaysOverWhichGainAccrued: 4");
//
//		Reporter.log("ChargeableGainsForeignRules");
//		Reporter.log("ChargeableGains: 1.00");
//		Reporter.log("NumberOfDaysOverWhichGainAccrued: 2");
//
//		Reporter.log("CapitalGains");
//		Reporter.log("ForeignTaxPaid: 44.00");
//		Reporter.log("TotalForeignTaxCreditReliefOnGains: 3.00");
//		Reporter.log("SpecialWithholdingTax: 4.00");
//
//		Reporter.log("OtherOverseasIncomeAndGains");
//		Reporter.log("OffshoreFundGainsAndNonResidentTrustIncome: 100.00");
//		Reporter.log("BenefitsFromOverseasTrustsEtc: 22.00");
//		Reporter.log("ForeignLifeInsuranceGains: 500.00");
//		Reporter.log("NumberOfYearsSincePolicyMade: 2");
//		Reporter.log("TaxTreatedAsPaid: 400.00");
//		Reporter.log("OmittedAmountTransferOfAssetsExemption: 231.00");
//
//		Reporter.log("ForeignTaxPaid");
//		Reporter.log("ClaimToFTCRCountryCode: AFG");
//		Reporter.log("ClaimToFTCRForeignTax: 123.00");
//		Reporter.log("ClaimToFTCRClaimForFTCR: yes");
//		Reporter.log("ClaimToFTCRAmountChargable: 124.00");
//
//		Reporter.log("UnderpaidTax");
//		Reporter.log("UnderpaidTaxForEarlierYearsIncludedInCode: 0.00");
//		Reporter.log("UnderpaidTaxForYearIncludedInFutureCode: 0.00");
//
//		Reporter.log("All XML tags checked for SA106");
		
//		 Reporter.log("SA105");
//         Reporter.log("UKPropertyDetails");
//           Reporter.log("NumberOfProperties:1");
//           Reporter.log("PropertyIncomeAndExpenses");
//             Reporter.log("TotalRentsAndOtherIncomeFromProperty:1000.00");
//             Reporter.log("RentRatesInsuranceAndGroundRents:2000.00");
//           Reporter.log("PropertyIncomeAndExpenses");
//           Reporter.log("TaxableProfitOrLoss");
//             Reporter.log("AdjustedLossForTheYear:1000.00");
