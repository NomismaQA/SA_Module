...
public class Testcase225 extends BasePage
{
	public Testcase225 (WebDriver driver)
	{
		super(driver);
	}
...
private double Incometaxdue;
	...
	private By TotalIncomeReceived =By.xpath("/html/body/form/main/div[3]/div[3]/div/div[3]/div/div/div/div/div/table/tbody/tr[9]/td[2]/b");
...
//		Assert.assertEquals(calculateDividentFrmUKCompany(m_Driver).replace(",", ""),String.format("%.2f",dividendsFromUKCompaniesAmt));
//		WebElement amountDividendsfromUKCompanies = null;
//		Reporter.log("Dividends from UK Companies verified: "+amountDividendsfromUKCompanies.getText(),true);
//
//		Assert.assertEquals(((WebElement) TotalIncomeReceived).getText().substring(1).replace(",", ""),String.format("%.2f",totalincome));
//		Reporter.log("Total Income Received verified: "+((WebElement) TotalIncomeReceived).getText(),true);
//
//		WebElement totalIncomeOnWhichTaxIsDue;
...
//		WebElement amtTaxCreditsDividendsFromUKCompanies;
...
//		WebElement class4NationalInsurancecontributions1;
...
//		WebElement taxForThisYear = null;
...
//		TestModellerLogger.PassStep(m_Driver, "Click_Review_Tax_Calculation_");
	...
	private String calculateDividentFrmUKCompany(WebDriver m_Driver) {
