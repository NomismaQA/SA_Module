...
public class Testcaseselfemp_37 extends BasePage
{
	public Testcaseselfemp_37 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
		Reporter.log("Tax year : 2020-21");
		   Reporter.log("Turnover:23319.00");
           Reporter.log("CarVanAndTravelExpenses:6603.00");
           Reporter.log("RentAndOtherPropertyCosts:1530.00");
           Reporter.log("PhoneAndOtherOfficeCosts:852.00");
           Reporter.log("AdvertisingAndEntertainmentCosts:120.00");
           Reporter.log("AccountancyAndLegalFees:330.00");
           Reporter.log("DepreciationAndLossProfitOnSale:2308.25");
           Reporter.log("OtherBusinessExpenses:530.00");
           Reporter.log("TotalExpenses:12273.25");
           Reporter.log("DisallowableDepreciationAndLossProfitOnSale:2308.25");
           Reporter.log("TotalDisallowableExpenses:2308.25");
       Reporter.log("NetProfitLoss:11045.75");
         Reporter.log("AdditionsToNetProfitDeductionsFromNetLoss:2308.25");
         Reporter.log("NetBusinessProfitLossForTax:13354.00");
         Reporter.log("AdjustedProfitForTheYear:13354.00");
         Reporter.log("TotalTaxableBusinessProfits:13354.00");
         Reporter.log("EquipmentMachineryVehicles:5974.75");
           Reporter.log("TotalBusinessAssets:5974.75");
           Reporter.log("OtherLiabilities:180.00");
         Reporter.log("NetBusinessAssets:5794.75");
           Reporter.log("CapitalAccountBalanceAtStart:2250.00");
          
           Reporter.log("Drawings:7501.00");
           Reporter.log("CapitalAccountBalanceAtEnd:5794.75");
