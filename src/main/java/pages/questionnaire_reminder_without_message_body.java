...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/d740a3b3-dce8-40af-87b8-58077f9f560b
@TestModellerModule(guid = "d740a3b3-dce8-40af-87b8-58077f9f560b")
public class questionnaire_reminder_without_message_body extends BasePage
{
	public questionnaire_reminder_without_message_body (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _David_Smith_Elem = By.xpath("//*[@id=\"step-1\"]/div/div[2]/div/div/table/tbody[2]/tr[1]/td[2]/button");

	private By Next_Elem = By.xpath("//*[@id=\"NextLink\"]");

	private By _Elem = By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_txtMessage_ctl02_ctl00\"]");
     ...
     */
 	public void Enter_ctl00ctl00ParentContentcPHtxtName(String ctl00ctl00ParentContentcPHtxtName)
 	{
		...
		m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/form/main/div[5]/div[3]/div/div[3]/div/div/div[2]/iframe")));
 		...
 		List<WebElement> Name = elem.findElements(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_cPH_txtName\"]"));
...
//		TestModellerLogger.PassStep(m_Driver, "Click__");
	...
	public void Click__Error_Please_enter_message_to_send_email()
	{
		...
		m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/form/main/div[3]/div[3]/div/div[4]/div/div/div[2]/iframe")));
