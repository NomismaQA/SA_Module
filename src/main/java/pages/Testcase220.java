...
public class Testcase220 extends BasePage
{
	public Testcase220 (WebDriver driver)
	{
		super(driver);
	}
...
//		d1= (taxDueInc-nilRate1)*BR_rate;
		...
		Reporter.log("Income tax overpaid verified successfully: " +t2,true);
//		total1 = n8 + n9;
...
//		 Reporter.log("UnderpaidTaxForEarlierYearsIncludedInCode:100.00");
//         Reporter.log("UnderpaidTaxForYearIncludedInFutureCode:200.00");
//         Reporter.log("OutstandingDebtCodedOutAmount:300.00");
