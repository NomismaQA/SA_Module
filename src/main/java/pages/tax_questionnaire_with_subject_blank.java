...
// http://nomisma.cloud.testinsights.io/app/#!/module-collection/guid/de45637a-0118-4d5d-914a-80abeb47153d
@TestModellerModule(guid = "de45637a-0118-4d5d-914a-80abeb47153d")
public class tax_questionnaire_with_subject_blank extends BasePage
{
	public tax_questionnaire_with_subject_blank (WebDriver driver)
	{
		super(driver);
	}
	...
	private By _Deepika_Automation_client_Elem = By.xpath("//*[@id=\"step-1\"]/div/div[2]/div/div/table/tbody[2]/tr[2]/td[2]/button");

	private By Next_Elem = By.xpath("//*[@id=\"NextLink\"]");

	private By ctl00ctl00ParentContentcPHtxtSubjectElem = By.xpath("/html/body/");
