...
public class Testcase107 extends BasePage
{
	public Testcase107 (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at client list and client dashboard verified successfully when work status is Approved: " +taxFinalUI,true);
//          	
