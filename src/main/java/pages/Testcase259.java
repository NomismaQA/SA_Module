...
public class Testcase259 extends BasePage
{
	public Testcase259 (WebDriver driver)
	{
		super(driver);
	}
...
//		d1= (taxDueInc-nilRate1)*BR_rate;
		...
		Reporter.log("Income tax due after dividends tax credit verified successfully: " +t2,true);
//		total1 = n8 + n9;
