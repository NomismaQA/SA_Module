...
public class Testcase209 extends BasePage
{
	public Testcase209 (WebDriver driver)
	{
		super(driver);
	}
...
//		Reporter.log("PostgraduateLoanRepaymentDeductedAmount: 3214.00");
//		Reporter.log("PostgraduateLoanPlanType: 03");
//
//		Reporter.log("XML tags of Student Loan plan 3 checked of SA100");
