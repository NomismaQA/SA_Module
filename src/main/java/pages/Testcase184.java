...
public class Testcase184 extends BasePage
{
	public Testcase184 (WebDriver driver)
	{
		super(driver);
	}
...
//		amtReliefForFinanceCosts=total1*reliefFinancerate;
		amtReliefForFinanceCosts=24;
dataReliefForFinanceCosts=24;
...
//Assert.assertEquals(deficiencyrelief,amtdefrelief) ;
		...
		Reporter.log("Amount of Foreign tax credit relief is verified successfully"+amtforcreditrelief,true);
