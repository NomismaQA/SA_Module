...
public class Testcase118 extends BasePage
{
	public Testcase118 (WebDriver driver)
	{
		super(driver);
	}
...
//Assert.assertEquals(dataReliefForFinanceCosts,amtReliefForFinanceCosts) ;//500.00
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at work pool and client dashboard verified successfully when work status is sent for approval: " +taxFinalUI,true);
