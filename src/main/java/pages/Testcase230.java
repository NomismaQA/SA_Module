...
public class Testcase230 extends BasePage
{
	public Testcase230 (WebDriver driver)
	{
		super(driver);
	}
...
//		d1= (taxDueInc-nilRate1)*BR_rate;
		...
		Reporter.log("Income tax due after gift aid verified successfully: " +t2,true);
//		total1 = n8 + n9;
...
//		WebElement amountDividendsfromUKCompanies;
