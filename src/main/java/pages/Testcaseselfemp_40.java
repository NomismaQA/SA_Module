...
public class Testcaseselfemp_40 extends BasePage
{
	public Testcaseselfemp_40 (WebDriver driver)
	{
		super(driver);
	}
...
//			 Reporter.log("TotalTaxableBusinessProfits:15270");
		Reporter.log("Tax year : 2020-21");
		   Reporter.log("Turnover:89000");
           Reporter.log("OtherBusinessIncome:20000");
             Reporter.log("CarVanAndTravelExpenses:480");
             Reporter.log("AdvertisingAndEntertainmentCosts:150.00");
             Reporter.log("Irrecoverable debts written off:65.50");
             Reporter.log("DepreciationAndLossProfitOnSale:1000");
             Reporter.log("OtherBusinessExpenses:1406");
             Reporter.log("TotalExpenses:3101.25");
             Reporter.log("TotalDisallowableExpenses:-2871.25");
         Reporter.log("NetProfitLoss:106778.25");
           Reporter.log("AdditionsToNetProfitDeductionsFromNetLoss:2871.25");
           Reporter.log("NetBusinessProfitLossForTax:109650");
           Reporter.log("AdjustedProfitForTheYear:109650");
           Reporter.log("TotalTaxableBusinessProfits:109650");
           Reporter.log("EquipmentMachineryVehicles:-21500");
           Reporter.log("other fixed assets:-250");
           Reporter.log("Cash in hand:107844");
           Reporter.log("Other current assets and prepayments:215.25");
             Reporter.log("TotalBusinessAssets:106778.25");
           Reporter.log("NetBusinessAssets:106778.25");
             Reporter.log("NetProfitOrLoss:106778.25");
Reporter.log("Error! Value in box 83, box 84 can not be negative, please check the input in bookkeeping module.");
