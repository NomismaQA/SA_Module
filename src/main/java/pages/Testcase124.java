...
public class Testcase124 extends BasePage
{
	public Testcase124 (WebDriver driver)
	{
		super(driver);
	}
...
//		taxFinalUI= totalIncomeTaxDue;
//		Assert.assertEquals(taxFinalUI,taxFinal);
//		Reporter.log("Tax due at client list and client dashboard verified successfully when work status is Questionnaire Sent: " +taxFinalUI,true);
