...
public class Testcase200 extends BasePage
{
	public Testcase200 (WebDriver driver)
	{
		super(driver);
	}
...
//
//		Reporter.log("SA101");
//		Reporter.log("OtherTaxReliefs");
//		Reporter.log("VentureCapitalTrustShareSubscriptions: 201.00");
//		Reporter.log("EnterpriseInvestmentSchemeShareSubscriptions: 202.00");
//		Reporter.log("CommunityInvestmentTrustRelief: 203.00");
//		Reporter.log("AnnuitiesAndAnnualPayments: 204.00");
//		Reporter.log("QualifyingLoanInterest: 205.00");
//		Reporter.log("PostCessationAndOtherLosses: 206.00");
//		Reporter.log("MaintenanceOrAlimonyPayments: 207.00");
//		Reporter.log("TradeUnionEtcDeathBenefitPayments: 100.00");
//		Reporter.log("BonusSecurityRedemptionDistributionRelief: 209.00");
//		Reporter.log("SeedEnterpriseInvestmentSchemeAmount: 210.00");
//		Reporter.log("SocialInvestmentTaxRelief: 211.00");
//		Reporter.log("NondeductibleLoanInterest: 212.00");
//
//		Reporter.log("SA110");
//		Reporter.log("SelfAssessment");
//		Reporter.log("TotalTaxEtcDue: 51.00");
//		Reporter.log("PaymentsOnAccount");
//
//		Reporter.log("All XML tags checked AOR page of SA 101"); 	
////		
//		   Reporter.log("SA109");
...
//           Reporter.log("AnyOtherInformationSpace:Mr Akshay Thakkar was not resident to UK during the tax year 2020-21. He had spent only 13 days in UK");
//           Reporter.log("All XML tags checked of Non Uk resident page");
