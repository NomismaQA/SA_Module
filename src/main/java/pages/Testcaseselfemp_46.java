...
public class Testcaseselfemp_46 extends BasePage
{
	public Testcaseselfemp_46 (WebDriver driver)
	{
		super(driver);
	}
...
Reporter.log("Error! Value in box 83 can not be negative, please check the input in bookkeeping module.");
