...
public class Testcase167 extends BasePage
{
	public Testcase167 (WebDriver driver)
	{
		super(driver);
	}
...
//		d1= (taxDueInc-nilRate1)*BR_rate;
		t1=15888.57;
		Incometaxdue=15888.57;
		t2= Incometaxdue;
		
		Assert.assertEquals(t2,t1);
		Reporter.log("Income tax due verified successfully: " +t2,true);
//		Reporter.log("IR Mark when new input done after unlocking TR:YHO34P6NAZRQ5RJYZHO76JQHPZCMTWJI");
//
//		Reporter.log(" IR Mark when 3rd validation done : YHO34P6NAZRQ5RJYZHO76JQHPZCMTWJI");
...
//		taxFinal=(total2);
////		
//		deficiencyrelief=4886.70;
//		amtdefrelief=4886.70;
//		Assert.assertEquals(deficiencyrelief,amtdefrelief) ;
//		Reporter.log("Amount of Relief For deficiency relief is verified successfully"+amtdefrelief,true);//		foreigncreditrelief=2442;
...
//		Reporter.log("Amount of Notional tax is verified successfully"+amtfornotionaltax,true);

		taxFinal=13071.87;
		totalIncomeTaxDue=13071.87;
