...
public class Testcaseselfemp_21 extends BasePage
{
	public Testcaseselfemp_21 (WebDriver driver)
	{
		super(driver);
	}
					 ...
					 Reporter.log("TotalLossToCarryForward:706.25");
		              ...
		              Reporter.log("OtherCurrentAssets:19160");
		               ...
		               Reporter.log("NetProfitOrLoss:-2216.25");
		                ...
		                Reporter.log("linking verifiedfor short and full form");
