...
public class testcase10_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase10 SA");
...
//
    ...
    _pagesemployment.Enter_ctl00cPHtxtPayFromEmployment("3354");
//    
//
...
pages.Testcase10 _pagesTestcase2 = new pages.Testcase10(driver);
