...
public class testcase8_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase8 SA");
...
pages.Testcase8 _pagesTestcase2 = new pages.Testcase8(driver);
