...
public class testcase108_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
   ...
   _pagesSA_Left_menu.Click__Self_Assessment_();
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase108 SA");
...
pages.Testcase108 _pagesTestcase2 = new pages.Testcase108(driver);
