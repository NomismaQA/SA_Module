...
public class testcase64_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase64 SA");
...
pages.Testcase64 _pagesTestcase2 = new pages.Testcase64(driver);
