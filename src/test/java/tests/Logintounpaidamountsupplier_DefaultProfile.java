...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/c36309a3-69e1-4b76-b505-47ae462286b0
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 274, profileId = 100227)
public class Logintounpaidamountsupplier_DefaultProfile extends TestBase
{
    

    
    @Test  (groups= {"810f04dc-66ff-42f3-a4b0-58ceb8c6b568","Login to unpaid amount supplier","Login to unpaid amount supplier - Default Profile"})
    @TestModellerPath(guid = "810f04dc-66ff-42f3-a4b0-58ceb8c6b568")
...
pages.unpaid_amount_supplier _pagesunpaid_amount_supplier = new pages.unpaid_amount_supplier(driver);
    TestModellerLogger.SetLastNodeGuid("6c224635-5624-4354-94d7-9e897cc29296");
   _pagesunpaid_amount_supplier.GoToUrl();
    

    TestModellerLogger.SetLastNodeGuid("93b47baf-cf48-4b5a-a15b-44fe0dc75bc3");
    _pagesunpaid_amount_supplier.Click_300000();
    

    TestModellerLogger.SetLastNodeGuid("08d546fd-25d1-4270-8245-c318af43c38f");
    _pagesunpaid_amount_supplier.Click__300000_();
