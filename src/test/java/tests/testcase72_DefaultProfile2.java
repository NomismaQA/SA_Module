...
public class testcase72_DefaultProfile2 extends TestBase
{
    ...
    public void GoToUrlusernamepositiveinputPositiveEnterctl00cPHpassClickLoginPositiveEnterctl00cPHFiltertxtAg() throws InterruptedException
    {
...
////
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase72 SA");
...
pages.employment _pagesemployment = new pages.employment(driver);
    ...
    _pagesemployment.Select_ctl00ddlTaxYear("6 April 2019 to 5 April 2020");
...
pages.Testcase72 _pagesTestcase2 = new pages.Testcase72(driver);
