...
public class testcase54_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase54 SA");
...
pages.employment _pagesemployment = new pages.employment(driver);
    ...
    _pagesemployment.Enter_ctl00cPHtxtPayFromEmployment("25500");
    

    TestModellerLogger.SetLastNodeGuid("7c68db6e-3567-4338-a723-bfcb4da583ff");
    _pagesemployment.Enter_ctl00cPHtxtTaxTakenOffPay("3195");
//    
//
...
//    _pagesemployment.Enter_ctl00cPHtxtCompanyCarsAndVansBenefit("2975");
//    
//
...
pages.Testcase54 _pagesTestcase2 = new pages.Testcase54(driver);
...
//    _pagesTestcase2.Enter_ctl00cPHtbContainerctl00txtUntaxedUKinterest("367811998");
//    
//
