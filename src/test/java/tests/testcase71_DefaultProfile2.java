...
public class testcase71_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase71 SA");
...
pages.Testcase71 _pagesTestcase2 = new pages.Testcase71(driver);
