...
public class testcasecapitalgaintag_DefaultProfile2 extends TestBase
{
...
pages.Agentpage _pagesAgentpage = new pages.Agentpage(driver);
    ...
    _pagesAgentpage.Enter_ctl00cPHFiltertxtAgentName("test2020");
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase202 SA");
...
pages.Testcase202 _pagesTestcase2 = new pages.Testcase202(driver);
