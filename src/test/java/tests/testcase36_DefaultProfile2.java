...
public class testcase36_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase36 SA");
...
pages.Testcase36 _pagesTestcase2 = new pages.Testcase36(driver);
