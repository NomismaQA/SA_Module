...
public class testcase105_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase105 SA");
...
pages.Testcase105 _pagesTestcase2 = new pages.Testcase105(driver);
