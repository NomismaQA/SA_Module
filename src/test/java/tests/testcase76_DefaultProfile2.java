...
public class testcase76_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase76 SA");
...
pages.Testcase76 _pagesTestcase2 = new pages.Testcase76(driver);
