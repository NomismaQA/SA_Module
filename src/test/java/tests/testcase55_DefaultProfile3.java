...
public class testcase55_DefaultProfile3 extends TestBase
{
    ...
    _pageslogin_page.Enter_ctl00cPHpass("support@1");
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase55 SA");
...
pages.Testcase55 _pagesTestcase2 = new pages.Testcase55(driver);
