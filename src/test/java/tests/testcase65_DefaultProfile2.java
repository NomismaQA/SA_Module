...
public class testcase65_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase65 SA");
...
pages.Testcase65 _pagesTestcase2 = new pages.Testcase65(driver);
