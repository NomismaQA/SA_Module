...
public class testcase18_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase18 SA");
...
pages.Testcase18_copy _pagesTestcase2 = new pages.Testcase18_copy(driver);
