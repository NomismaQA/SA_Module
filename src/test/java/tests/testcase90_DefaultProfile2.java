...
public class testcase90_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase90 SA");
...
pages.Testcase90 _pagesTestcase2 = new pages.Testcase90(driver);
