...
public class testcase106_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase106 SA");
...
pages.Testcase106 _pagesTestcase2 = new pages.Testcase106(driver);
