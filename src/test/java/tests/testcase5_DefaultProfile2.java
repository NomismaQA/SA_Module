...
public class testcase5_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase5 SA");
...
//    _pagesemployment.Enter_ctl00cPHtxtPayFromEmployment("40511");
//    
//
//    TestModellerLogger.SetLastNodeGuid("7c68db6e-3567-4338-a723-bfcb4da583ff");
//    _pagesemployment.Enter_ctl00cPHtxtTaxTakenOffPay("5602.20");
...
pages.Testcase5 _pagesTestcase2 = new pages.Testcase5(driver);
