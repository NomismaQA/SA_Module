...
public class testcase171_DefaultProfile2 extends TestBase
{
...
pages.SA_Left_menu _pagesSA_Left_menu = new pages.SA_Left_menu(driver);
    ...
    _pagesSA_Left_menu.Enter_ctl00ctl00ParentContentcPHFiltertxtFirstName("MTRTestCase171 SA");
...
//    _pagesemployment.GoToUrl();
    ...
    _pagesemployment.Enter_ctl00cPHtxtPayFromEmployment("3254");
...
pages.Testcase171 _pagesTestcase2 = new pages.Testcase171(driver);
