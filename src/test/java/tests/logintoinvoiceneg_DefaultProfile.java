...
//http://nomisma.cloud.testinsights.io/app/#!/model-engine/guid/d9abc700-c598-4c98-8b09-ced8c15a19fe
@Listeners(TestNGListener.class)
@TestModellerSuite(id = 212, profileId = 100165)
public class logintoinvoiceneg_DefaultProfile extends TestBase
{
    

    
    @Test  (groups= {"4e74c9dd-b23d-4b2a-baea-4b7580f05898","login to invoice neg","login to invoice neg - Default Profile"}, enabled=false)
    @TestModellerPath(guid = "4e74c9dd-b23d-4b2a-baea-4b7580f05898")
...
pages.new_invoice _pagesnew_invoice = new pages.new_invoice(driver);
    ...
    @Test  (groups= {"d943d3f2-6f40-490a-a86c-22fa4a784fb3","login to invoice neg","login to invoice neg - Default Profile"})
    @TestModellerPath(guid = "d943d3f2-6f40-490a-a86c-22fa4a784fb3")
...
pages.new_invoice _pagesnew_invoice = new pages.new_invoice(driver);
    ...
    _pagesnew_invoice.Enter_ctl00cPHrptrProductctl00txtUnitPrice("");
